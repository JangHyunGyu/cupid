...
- 캐릭터: `없음`
**{name}**: *대화를 마치고 가방을 챙겨 교문 쪽으로 향한다.*
...
- 캐릭터: `없음`
**담임선생님과 동행**: *수업이 끝난 공개 교실. 담임이 행사 원고 한 부를 펼치자, 함께 들어온 인물이 반대편 의자를 당겨 앉는다.*
...
- 캐릭터: `없음`
**보건선생님과 동행**: *건강 점검표와 운동부 물품 상자가 나란히 놓인다. 보건선생님이 빈 칸 하나를 짚자, 함께 온 인물도 상자 안을 다시 들여다본다.*

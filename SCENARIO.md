...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 {name}의 이름을 한 번 더 확인하고, 클립보드 위 명단에 짧게 표시한다. 안경 너머 시선이 바로 떨어지지 않는다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연의 걸음이 멈춘다. 고개만 {name} 쪽으로 돌린다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 정말로 몸을 돌린다. 손짓도 없이 교문 안쪽으로 걸어간다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 걸음을 멈추고 돌아본다. 안경 너머 눈매가 아주 조금 휜다.*
...
- 캐릭터: `seyoun_laugh.png`
**서연**: *서연은 앞서 걷는다. 한 번 뒤돌아보고, {name}의 발소리가 가까워지자 속도를 늦추지 않는다.*
...
- 캐릭터: `seyoun_back.png`
**서연**: *서연이 복도를 앞서 걷는다. 마주치는 학생들이 먼저 인사하고, 서연은 짧게 고개만 끄덕인다.*
...
- 캐릭터: `seyoun_back.png`
**서연**: *서연이 돌아서며 가볍게 손을 흔든다. 뒤돌아보지 않는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 한숨을 살짝 쉰다. 출석부 모서리를 톡톡 치고, 다인 쪽을 보지도 않은 채 다음 이름을 찾는다.*
...
**담임선생님**: *담임은 건조하게 말하고도 입꼬리만 조금 올렸다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 옥상 문을 열쇠로 연다. 바람이 확 불어온다.*
...
- 캐릭터: `seyoun_laugh.png`
**서연**: *서연이 의자를 발끝으로 밀어 {name} 쪽에 맞춘다.* 의심 많네. 위가 조용하니까.
...
- 캐릭터: `seyoun_laugh.png`
**서연**: *서연이 가방에서 도시락을 꺼낸다. 깔끔하게 포장된 2인분.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 대답 대신 밥을 먹는다. 난간 너머로 운동장과 별관 지붕이 한눈에 들어온다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 물병을 들어 입가를 가린다. 라벨이 손끝에서 천천히 구겨진다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 계란말이를 자기 입에 넣는다. 천천히 씹으며.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 도시락 뚜껑을 천천히 닫는다. 새끼손가락이 뚜껑 모서리를 한 번 더 눌렀다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 도시락을 접었다. 대답을 고치지도 않고, 머리카락 끝만 새끼손가락으로 넘긴다.*
...
- 캐릭터: `dain_pout.png`
**다인**: *다인이 투덜거리며 빵을 산다. 하지만 입꼬리가 올라가 있다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인이 웃자 눈꼬리가 접힌다. 거절할 타이밍을 놓쳤다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 주먹으로 {name}의 어깨를 가볍게 친다. 장난스러운 동작 뒤로 뿌듯한 표정이 남는다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 열람실 구석 자리에 앉는다. 책을 펼친다. 맞은편 의자 다리가 바닥을 살짝 끌자, 유나의 손가락이 책장 위에서 멈춘다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *말없이 책장 넘기는 소리만 이어진다. 이상하게 자리를 뜨고 싶지 않았다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 다시 책으로 시선을 내린다. 빌려준 책의 첫 문장에 한동안 눈이 붙잡혔다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 먼저 일어나 걸어간다. 뒤돌아보지 않는다. '괜찮았어.' 짧은 말이 책상 위에 남는다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 책갈피 모서리를 엄지로 펴고, 빛에 비춰 본다. 접힌 자국은 없다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임은 클립보드를 내리고 {name}의 얼굴을 본다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 책상 위 서류를 한쪽으로 밀어둔다. 의자 등받이에 손을 얹고 말을 고른다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임은 서류를 내려다보는데, 클립보드 끝이 더는 움직이지 않는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 다시 책상 쪽으로 몸을 돌린다. 짧게 인사하고 교무실 문을 닫았다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임이 출석부를 덮는다. 문턱까지 갔다가 다시 {name}을 부른다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 복도 끝으로 사라진다. 긴 머리카락이 흔들리고, 출석부 모서리가 품 안에서 삐져나와 있다.*
...
- 캐릭터: `없음`
**{name}**: *아침부터 계속 사람들 틈에 있었다. 잠깐 쉬었다 가도 될 것 같았다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 일어나 다가온다. 손등에 체온계 끝이 닿자 손가락이 살짝 굳는다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 서랍을 닫는다. 안쪽의 연두색 노트가 잠깐 보였다 사라진다. 10분이 지났다.*
...
- 캐릭터: `nurse_angry.png`
**보건선생님**: *보건선생님이 물컵을 책상에 내려놓는다. 컵 바닥이 낮게 울린다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 물컵을 내려놓다 말고 웃음을 놓친다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 커튼 끝을 손가락으로 한 번 접는다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *다인의 목소리가 아침 조회 전 교실을 먼저 채운다.*
...
- 캐릭터: `seyoun_laugh.png`
**서연**: *서연은 복도를 돌아가기 직전 발끝을 늦춘다. 클립보드가 팔 안으로 더 붙는다.*
...
- 캐릭터: `없음`
**{name}**: *서연의 클립보드 끝이 책상에 톡, 닿는다. 싫다고 말할 타이밍을 놓쳤다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임의 시선이 서랍 쪽을 스치고 바로 돌아온다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임은 커피잔으로 입을 가린 채, 컵받침을 같은 자리에서 두 번 돌린다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연의 손이 {name}의 어깨에 닿는다. 묻은 먼지를 털어내는 손길에 망설임이 없다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 밥풀을 떼어낸다. 손끝이 잠깐 멈췄다가 곧바로 물러난다.*
...
- 캐릭터: `seyoun_pout.png`
**서연**: *서연은 웃은 얼굴 그대로 도시락 뚜껑을 맞춘다. 딸깍 소리가 조금 크게 난다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 소보로를 크게 한 입 베어 문다. 빵가루가 교복 소매 위로 떨어진다.*
...
- 캐릭터: `dain_pout.png`
**다인**: *다인의 표정이 굳는다. 소보로를 한 입 베어 물고, 씹지 않은 채 고개를 돌린다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 고개를 끄덕이며 소보로를 한 입 베어 문다. 별 관심 없다는 듯.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 소보로 포장지를 쓸데없이 오래 접는다. 조금 전보다 말수가 줄었다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 다가와 팔꿈치를 잡는다. 손이 차갑다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님의 손이 잠깐 멈췄다가, 아무 일 없다는 듯 다시 움직인다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *별것 아닌 비밀인데, 다인은 말하고 나서 컵라면 뚜껑을 손톱으로 톡톡 친다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 서랍을 닫는다. 손잡이가 한 번 더 눌린다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 밴드 포장지를 접다 말고 {name}을 본다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 책장을 넘긴다. 종이 넘어가는 소리가 전보다 가볍다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 앞장서 걷는다. 별관 깊숙이. 아무도 안 올 것 같은 곳. 작은 방이 나온다. 창문으로 햇살이 들어오고, 낡은 소파와 책장이 있다.*
...
- 캐릭터: `yuna_sad.png`
**유나**: *유나가 책갈피를 책 안쪽 깊숙이 밀어 넣는다. '있었는데' 뒤로 페이지가 접힌다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나의 손이 책갈피 위에 멈춘다. 책장 넘기는 소리만 크게 울린다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 책장으로 시선을 돌린다. 열린 페이지 위로 햇빛이 조금 더 길어진다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인은 컵을 {name} 쪽으로 밀어놓고, 일부러 큰 소리로 물을 찾는다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연은 '부탁' 대신 클립보드를 {name} 쪽으로 돌린다. 할 일 목록 맨 위가 비어 있다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 바로 돌아서지 않는다. 클립보드 끝이 문 쪽을 가리킨 채, {name}의 발소리를 기다린다.*
...
- 캐릭터: `seyoun_shy.png`
**서연**: *서연은 칭찬이라고 말해놓고 바로 서류를 정리한다. 목을 돌리는 순간, 어깨가 아주 작게 굳는다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 서류 끝으로 입가를 가린 채 한동안 창밖을 본다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 일어나 {name}의 뒤로 온다. 양손을 어깨 위에 올린다.*
...
- 캐릭터: `seyoun_shy.png`
**서연**: *서연이 서류를 내려놓고 창밖을 본다. 노을빛이 얼굴에 닿는다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 손을 뻗는다. 옷깃에 묻은 먼지를 떼어준다. 손이 목에 스친다.*
...
- 캐릭터: `seyoun_shy.png`
**서연**: *서연의 손가락이 멈춘다. 아무 말도 안 하고 고개를 돌린다. 복도 소음만 갑자기 크게 들린다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나는 시선을 피하지 않는다. 이어폰 줄이 손가락 사이에 감긴 채 멈춰 있다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 아주 작게 웃는다. 다음 페이지가 조용히 넘어간다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 먼저 빼지 않는다. 3초. 유나가 시선을 내린다.*
...
- 캐릭터: `teacher_normal.png` @ 0.35
**{name}**: *메시지 끝의 마침표가 한참 늦게 찍힌 것처럼 보인다.*
...
- 캐릭터: `없음`
**{name}**: *스크롤을 한참 내렸다. 3개월 전 소풍 사진. 소정이가 내 옆에서 웃고 있다. 다음 사진부터는 소정이 책상이 조금씩 뒤로 밀려 있다. 낙서가 보이지 않게, 누가 일부러 크롭한 것처럼.*
...
- 캐릭터: `seyoun_laugh.png`
**서연**: *서연이 아무 말 없이 나란히 걷기 시작한다. — 교문에서 교실까지, 이 거리가 이렇게 짧았나.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 걸어간다. 당당하게. 늦었는데도 서두르지 않는다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *쪽지: 아침 안 먹었을 것 같아서. 빵 봉지 아래에 연보라색 잉크가 조금 묻어 있다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 가방에서 작은 빵을 꺼낸다. 둘이 나눠 먹으며 천천히 교문을 통과한다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 먼저 지나간다. 눈이 마주쳤지만, 고개를 돌린다.*
...
- 캐릭터: `yuna_bored.png`
**유나**: *유나가 창밖에서 시선을 돌려 잠깐 {name} 쪽을 본다. 곧 다시 창밖을 향한다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 고개를 들지 않은 채 종이 귀퉁이에 짧은 선을 긋는다.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *담임의 손이 원고지 위에서 멈춘다. 곧 종이가 뒤집힌다.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *담임의 표정이 평소의 무심함으로 돌아온다. 원고지만 아직 뒤집힌 채다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 원고지를 한 장 들어올린다. 글씨가 빼곡하다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 잠깐 입을 다문다. 그리고 — 한숨을 쉰다. 짧게.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 잠깐 멈춘다. 원고지를 만지작거린다. — 그리고 의자에 기대앉는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임은 그렇게 말하고도 원고지에서 손을 떼지 못한다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임이 웃는다. 손은 여전히 원고지 위에 있다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *그 어색한 웃음 때문에, 빈 교실의 초침 소리가 더 크게 들린다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임은 원고지 귀퉁이를 엄지로 누른다. 종이가 조금 구겨진다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임이 머리카락을 넘기며 교실을 나선다. 닫힌 문 안쪽에서 펜 뚜껑 소리가 난다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 컵을 내려놓는다. 조금 전까지 가볍던 손놀림이 멈춘다. 침대에 앉는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: 셋 다 마음이 가는데, 결국 한 명은 정해야 할 것 같아서요.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 잠깐 멈춘다. 시선이 창밖으로 간다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 물컵을 내려놓는다. 컵 바닥의 물기가 둥글게 번진다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 '도망'에서 잠깐 멈춘다. 청진기를 만지는 손끝이 노트 서랍 쪽으로 가려다 멈춘다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 {name}을 본다. 표정이 진지하다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 다시 웃음을 붙인다.* 뭘. 이 정도는 서비스지. 다음엔 안 아파도 들러.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님은 '한 명'에서 말을 멈췄다. 종이컵 가장자리가 손끝에 눌려 찌그러진다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님은 웃고 있지 않다. 청진기를 만지작거리며 창밖만 본다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인의 손가락이 책상 모서리를 두드리고 있다. 평소보다 빠르다. 의자 다리도 바닥을 짧게 긁는다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *다인이 밝게 웃으며 돌아간다. 종이 치기 직전, 손가락으로 주머니 안쪽을 한 번 두드린다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 말없이 젓가락을 뻗어 제일 맛있어 보이는 소시지를 집어간다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연의 젓가락이 잠깐 멈춘다. 곧 학생회장의 얼굴로 돌아오지만, 계란말이는 그대로 남아 있다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *다인이 "다 같이?" 하고 웃는다. 평소 같으면 의자를 끌고 왔을 텐데, 오늘은 앉은 자리에서 움직이지 않는다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 고개만 끄덕인다. 쪽지를 쓰다 접어서 주머니에 넣는다. 안 건넨다. 종이 끝에 연보라색 점 하나만 번져 있다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *점심 내기에서 이겨서 흥분한 다인이 양팔을 벌린다. 안긴다. 1초. 다인이 튕기듯 떨어져 한 걸음 물러나 물병을 집어 든다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 고개를 돌린다. 소보로를 한 입도 안 먹었다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 인기척에 고개를 든다. 눈이 피곤해 보인다. 화장이 살짝 번져 있다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 자세를 바로잡는다. 하지만 — 웃음은 돌아오지 않았다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 천천히 고개를 든다. 손등의 화장 자국을 보지도 않고 문지른다. 눈빛이 비어 있다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 화장이 번진 자국을 손등으로 닦는다. 천천히. 동작 하나하나가 너무 반듯하다.*
...
- 캐릭터: `seyoun_worried.png`
**서연**: *서연이 안경을 고쳐 쓴다. 번진 자국은 아직 손등에 남아 있는데, 목소리부터 먼저 반듯해진다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 멈춘다. 말이 끊긴 사이, 클립보드 가장자리를 쥔 손에 힘이 들어간다.*
...
- 캐릭터: `없음`
**{name}**: *못 본 걸로 하겠다는 말은 끝내 안 했다. 서연은 새끼손가락을 내밀지 않고, 다음 주 학생회 일정표를 접어 내 쪽으로 밀었다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 노트로 얼굴 옆을 가린다. 드러난 귀 끝만 붉다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 노트를 더 세게 끌어안는다. 손가락 마디가 하얗게 변한다.*
...
- 캐릭터: `yuna_sad.png`
**유나**: *유나가 노트를 가방에 쑤셔 넣는다. 평소의 천천한 동작이 아니다. 도망치는 손이다.*
...
- 캐릭터: `yuna_sad.png`
**유나**: *유나가 가방을 메고 사다리 쪽으로 간다. 발끝이 한 번 멈췄다가, 그대로 내려간다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 노트를 끌어안은 손가락이 — 아주 조금 풀린다. 1초쯤.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 노트를 책상에 다시 놓는다. 품에 끌어안고 있던 손이 천천히 풀린다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 노트를 두 손으로 내민다. 책 빌려줄 때보다 팔꿈치가 조금 굳어 있다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 클립보드를 정리하고 있다. 웃고 있는데, 정리하는 손끝이 너무 반듯하다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 크게 웃는다. 웃음이 대사보다 한 박자 늦게 따라온다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 벤치에 앉는다. 무릎을 문지른 손이 같은 자리를 오래 맴돈다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 무릎을 문지르던 손이 멈춘다. 천천히 고개를 든다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 체육관 문 쪽으로 걸어간다. 평소처럼 뛰지 않는다. 운동화 끄는 소리가 길게 남는다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 일어선다. 무릎을 한 번 살짝 굴려본다. 무의식적으로. 그리고 — 토스 자세를 잡는다. 평소와 똑같이.*
...
- 캐릭터: `없음`
**{name}**: *서브가 날아온다. 못 받는다. 공이 손목에 맞고 천장으로 튄다. 다인이 박수를 치며 웃는다. 숨을 참듯 올라가 있던 어깨가 내려간다.*
...
- 캐릭터: `dain_sweat.png`
**다인**: *다인이 착지하면서 오른쪽 무릎이 살짝 꺾인다. 손이 무릎 위에 남는다.*
...
- 캐릭터: `dain_angry.png`
**다인**: *다인이 일어선다. 무릎이 삐걱거린다. 신발끈을 묶으려다 손이 멈춘다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인의 눈가가 젖어 있다. 문장 끝에는 아무것도 붙지 않는다.*
...
- 캐릭터: `dain_angry.png`
**다인**: *다인이 가방을 들고 나간다. 뒤돌아보지 않는다. 체육관 문이 쾅 닫힌다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 안도의 한숨을 쉰다. 체육관 바닥에 공 굴러가는 소리만 남는다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 멈춘다. 그리고 작게 웃는다. 손등으로 눈가를 한 번 문지른다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 주먹으로 어깨를 가볍게 친다. — 어제보다 약하다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 주먹으로 어깨를 가볍게 친다. — 쑥스러운가 보다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 고개를 숙인다. 운동화 앞코가 복도 바닥을 짧게 문지른다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 {name}을 똑바로 본다. 학생회장의 눈이 아니다. 한 사람의 눈이다.*
...
- 캐릭터: `seyoun_angry.png`
**서연**: *서연의 눈이 차갑다. 손등의 화장 자국이 아직 지워지지 않았다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 돌아선다. 믿고 싶어 하던 눈이 먼저 멀어진다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 사라진 복도에 혼자 서 있다. 곧은 등 뒤로 하얗게 쥔 주먹만 보인다.*
...
- 캐릭터: `없음`
**민수**: 어제 내가 뭐랬냐. 나중에 셋 다 울면 네 탓이라고 했지. 그 '나중'이 벌써 온 것 같은데.
...
- 캐릭터: `없음`
**민수**: *민수가 한숨을 쉰다. 비꼬는 게 아니라, 진짜 걱정하는 한숨이다.*
...
- 캐릭터: `없음`
**민수**: *민수는 더 말하지 않았다. 테이블 위의 빨대 포장지가 끝까지 접혀 있다.*
...
**하은**: *하은이 벽에 기대어 서 있다. 학생회 팔찌를 만지작거리고 있다.*
...
- 캐릭터: `haeun_worried.png`
**하은**: *하은이 돌아서서 간다. 복도 끝에 서연의 빈 학생회 완장이 걸려 있다.*
...
- 캐릭터: `없음`
**{name}**: *갤러리가 비어 있다. 소정이 사진이 있던 자리. 빈 화면이 오히려 선명하다. 보이면 말하겠다. 알면 나서겠다.*
...
- 캐릭터: `seyoun_normal.png` @ 0.35
**서연**: *서연이 '부탁'이라는 말을 쓴다. 커서는 그 단어 뒤에서 한참 멈춰 있다.*
...
- 캐릭터: `dain_normal.png` @ 0.35
**유나**: *유나가 세 줄을 보냈다. 평소 한 줄도 안 쓰는 사람이.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *담임은 말을 끝내고도 컵홀더 모서리만 접는다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임은 농담처럼 말하고 커피잔을 만진다. 컵받침 위에 원형 물자국이 두 개 겹쳐 있다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 커피잔을 내려놓는다. 창가 쪽으로 몸이 조금 기운다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임이 잠깐 웃는다. 컵홀더를 접던 손이 멈춘다.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *담임이 주머니에서 손을 뺀다. 손끝이 잠깐 허공에서 맴돈다. 습관 같은 제스처.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 {name}을 본다. 건조하지 않은 눈이다.* *카페 문이 뒤에서 천천히 닫힌다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 돌아선다. 어깨가 살짝 내려간다. 카페 유리문에 담임의 뒷모습이 작게 비친다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님은 '어, 왔어' 하고 청진기를 들었다가, 다시 책상 위에 내려놓는다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 책상 위 서류를 정리하는 척하지만 — 같은 종이를 세 번째 넘기고 있다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 안경을 만진다. 안경 너머 눈이 평소보다 또렷하다. 장난기 뒤에 숨어 있던 눈.*
...
- 캐릭터: `nurse_shy.png`
**보건선생님**: *보건선생님이 안경을 고쳐 쓴다. 손끝이 렌즈 아래에서 잠깐 멈춘다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 잠깐 {name} 쪽을 보며* ...별거야.
...
- 캐릭터: `nurse_shy.png`
**보건선생님**: *보건선생님이 컵라면 뚜껑을 누른다. 젓가락 한 짝이 조금 비뚤어진다.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: *서연은 대답 대신 머리카락을 귀 뒤로 넘겼다. 같은 손이 곧바로 다시 올라갔다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 빵 부스러기가 가라앉는 물가를 보고 있었다. 꽃집 앞에서 걸음이 느려졌다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 꽃집 문을 밀었다. 종소리가 울린다. 서연이 작은 화분을 하나 고른다. 다육이.*
...
- 캐릭터: `seyoun_worried.png`
**서연**: *서연이 화분을 내민다. 흙이 든 작은 무게가 손바닥에 내려앉았다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 {name}을 본다. 넘기던 페이지가 손끝에서 멈춘다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 멈춘다. 캡모자를 푹 눌러쓰는 바람에 얼굴이 반쯤 가려졌다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인은 캡모자 챙을 붙잡은 채 한동안 손을 내리지 못했다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *옥상. 석양이 학교를 물들이고 있다. 첫날 서연이 학교를 내려다보던 난간이 보인다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 난간에 기대서 있다. 바람에 머리카락이 날린다. — 새끼손가락으로 넘기는 그 습관.*
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *손바닥 안에서 고백 연습 메모가 접혔다 펴진다. 접힌 선이 세 겹이 됐다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *전 학교에서 쓰다 지운 문장들이 떠오른다. 핸드폰은 주머니 안에서 잠잠하다.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: *서연이 아무 말도 안 한다. 입술이 떨린다. 클립보드도, 학생회장 완장도 없다.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: *서연이 새끼손가락을 건넨다. 첫날에 봤던 그 새끼손가락. — 그때는 습관인 줄 알았는데, 이게 서연의 약속 방식이었다.*
...
- 캐릭터: `seyoun_worried.png`
**{name}**: *첫날에도 같은 말을 했다. 서연의 손가락이 클립보드 모서리에서 멈춘다.*
...
- 캐릭터: `seyoun_worried.png`
**서연**: *서연이 웃는다. 연습된 웃음으로. — 돌아서서 걷는다. 세 걸음째, 서연이 멈춘다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 소파에 앉아 {name}을 본다. 기다리고 있었다는 듯한 시선이다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나 앞에서는 말을 줄이게 된다. 빈칸까지 들키는 기분이다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 {name} 쪽을 보지 못한 채 옷소매를 꽉 쥔다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 고개를 끄덕인다. 책갈피를 책 사이에 넣고, 더 깊이 밀어 넣는다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 책을 집어든다. 표지를 보고 있지만 읽고 있지 않다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 공을 하나 들고 있다. 아무렇지 않게. — 근데 손가락이 하얗다. 꽉 쥐고 있다.*
...
- 캐릭터: `dain_sweat.png`
**다인**: *다인의 공이 바닥에 한 번 튄다. 평소라면 바로 받아냈을 손이 허공에서 늦게 멈춘다.*
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 그대로 멈춘다. 웃음이 빠진 얼굴 위로 눈빛만 천천히 젖는다. 두 손으로 얼굴을 덮어버린다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *다인이 공을 다시 끌어안는다. 손등에 힘이 들어간다.*
...
- 캐릭터: `dain_sweat.png`
**다인**: *다인이 배구공을 튀긴다. 한 번. 두 번. — 세 번째에 멈춘다.*
...
- 캐릭터: `seyoun_cry.png`
**서연**: *서연이 말을 멈췄다. 무릎 위의 손이 꽉 쥐어진다. 안경 끝에 맺힌 물기가 떨어지기 전, 서연이 고개를 숙인다.*
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *첫날 허공을 가르던 새끼손가락이 지금은 내 손가락에 걸려 있다. 서연의 손끝이 차갑다.*
...
- 배경톤: `cold`
- 선택지:
  1. "지금 얼굴도 좋아. 연습한 얼굴 말고." → `wall_seo_line_react_1` | Seoyeon +7
  2. "오늘은 아무 역할 안 해도 돼." → `wall_seo_line_react_2` | Seoyeon +7
  3. "보여줘서 고마워. 숨긴 쪽까지." → `wall_seo_line_react_3` | Seoyeon +4

- 캐릭터: `seyoun_cry.png`
**서연**: *서연이 눈물을 닦으며 떨리는 눈으로 올려다보고 있다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *서연이 웃는다. 번진 화장 아래로 젖은 자국이 남아 있다.*
...
- 캐릭터: `seyoun_shy.png`
**서연**: *서연이 새끼손가락을 먼저 건넨다. 거기서 멈추지 않는다. 손을 잡는다. 이마에 입술을 댄다.*
...
**다인**: *다인이 평소와 다르게 조용하다. 목소리 끝이 바닥에 닿는다.*
...
- 캐릭터: `dain_sweat.png` @ 0.35
**다인**: *다인이 웃는다. 손은 무릎 보호대를 꽉 누르고 있다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 배구공을 꼭 안고 고개를 숙였다. 어깨가 떨리고 있다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 무릎 위의 손을 본다. 주먹을 쥐었다 폈다 한다.*
...
- 캐릭터: `없음`
**다인**: *다인이 코트 위에 주저앉았다. 배구공을 껴안고 울기 시작했다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 고개를 숙인다. 빈 체육관 바닥에 물방울이 하나, 둘 떨어진다. 공은 라인 밖에서 멈춰 있다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 휴대폰을 꺼 버린다. '오늘도 웃어'가 검은 화면 속으로 사라진다. 울음이 잦아들 때까지 체육관 조명만 하얗게 흔들렸다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 이를 악물고 뛰어올라 — 최고의 스파이크. 공이 코트에 꽂힌다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인은 배구공을 내려놓고 먼저 걷는다. 뒤돌아보지 않았다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인의 걸음이 한 번 끊겼다. 다시 걷기 시작했을 때는 조금 가벼워져 있었다.*
...
- 캐릭터: `yuna_normal.png` @ 0.35
**유나**: *유나가 쪽지 대신 직접 말한다. 손에는 아무 종이도 없다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 도서관 별관으로 향한다. 비밀 독서 공간을 지나 — 더 안쪽. 지하 자료실. 먼지가 쌓인 서가 사이. 유나가 오래된 봉투를 꺼낸다.*
...
- 캐릭터: `yuna_sad.png`
**유나**: 선배가 처음이었어. '네 글 좋더라'— 그 말 하나 때문에, 그날은 내가 반에 있었던 것 같았어.
...
- 캐릭터: `yuna_sad.png`
**유나**: 내가 거기 있다는 걸 봐준 사람이 사라진 거야. 또 아무도 모를 것 같았어.
...
- 캐릭터: `yuna_sad.png`
**유나**: *유나가 옷소매를 꽉 쥐고 있다. 숨을 고르는 사이, 책등이 손바닥에 눌린다.*
...
- 선택지:
  ...
  2. "지금은 네가 한 말을 듣고 있어. 도망가지 않을게." → `wall_yuna_sub_1` | Yuna +3
  3. "...그래서 나한테 접근한 거야? 선배 대신?" → `wall_yuna_reject_1` | Yuna -10

- 캐릭터: `yuna_sad.png`
**유나**: *유나는 책을 쥔 손에 힘을 주고 있다. 대답을 기다리는 동안 편지 모서리가 조금 구겨졌다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 숨을 천천히 내쉰다. 편지 모서리가 손끝에서 조금 구겨진다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 숨을 천천히 내쉰다. 옷소매를 쥔 손끝이 조금 떨린다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 작게 웃었다. 손끝이 편지 모서리를 한 번 더 누른다.*
...
- 캐릭터: `yuna_sad.png`
**유나**: *유나가 돌아선다. 걸음이 빠르다. 책갈피 하나가 주머니에서 떨어졌지만, 유나는 줍지 않는다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 핸드폰을 주머니에 넣고 돌아선다. 등이 곧다. 가로등 아래 그림자만 잠깐 흔들린다.*
...
- 캐릭터: `없음`
**{name}**: *다섯째 날. 일요일이지만 학교 행사가 있다. 교복이 편해졌다. 소매 끝이 더는 손목을 긁지 않는다.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *담임이 교탁에 앉아 있다. — 원고가 아니라, 봉투를 들고 있다. 갈색 봉투.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 멈춘다. 표정은 금방 돌아왔지만, 봉투가 손 안에서 조금 구겨졌다.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *담임이 손을 뻗는다. 원고를 가져간다. 천천히. 다시 봉투에 넣는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 멈춘다. 종이 끝이 손 안에서 조금 휘어진다.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *담임은 말끝을 삼킨다. 비어 있는 마지막 줄만큼 교실이 조용해진다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임이 웃는다. 클립보드가 책상 위로 내려간다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임은 이번엔 출석부로 얼굴을 가리지 않는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임은 문 앞에서 한 번 멈춘다. 클립보드 끝을 손가락으로 두 번 눌렀다가 놓는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 멈춘다. 클립보드를 꽉 잡는다. — 그리고 천천히 고개를 돌린다.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *담임은 같은 말을 다시 삼킨다. 클립보드 끝이 문틀에 가볍게 닿는다.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *담임이 돌아선다. 긴 머리카락이 흔들리고, 클립보드 끝이 팔꿈치에 눌린다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 문을 열고 나온다. 물러설 틈도 없이 마주쳤다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님은 밴드 상자 뚜껑을 닫았다가 다시 연다.*
...
- 캐릭터: `nurse_angry.png`
**보건선생님**: *보건선생님이 보건실 안으로 들어가려다 — 멈춘다.*
...
- 캐릭터: `nurse_shy.png`
**보건선생님**: *보건선생님이 웃다가 멈춘다. 안경을 고쳐 쓰는 손이 조금 늦다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 밴드를 꺼내 {name}의 손등에 붙인다. 움직임은 천천히 이어지고, 밴드 끝에 작은 글씨가 적혀 있다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *열쇠를 건네는 손. 새끼손가락이 살짝 닿는다. 서연은 '줄게' 대신 손을 놓는다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 소파에 앉는다. 옆자리를 비워둔다. 먼지가 쌓이지 않은 자리다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 가방에서 노트를 꺼낸다. 다락방에서 급히 덮었던 그 노트다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 코트 한가운데 서 있다. 배구공을 하나 들고.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 돌아서며 손을 흔든다. 뒤돌아보지 않는다. 손목의 리본만 복도 끝에서 흔들린다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *다인은 배구공을 한 번 더 높이 던지고 받는다. 받는 손끝이 조금 늦다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *새끼손가락을 내민다. 그날 난간 앞에서 못 잡았던 손가락이다.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: *서연이 내민 손끝이 {name} 앞에 멈춘다. 대답을 기다리는 손이다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 그대로 굳는다. 손에 든 공이 천천히 내려간다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인의 입술이 떨린다. 대답하기 전에 숨부터 삼킨다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *다인이 눈가를 문지른다. 웃음은 그대로인데, 손등에 물기가 묻는다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 멈춘다. 책을 품 쪽으로 끌어안는다. 돌아보는 데 2초쯤 걸린다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나는 책을 안고 기다린다. 답장창에는 아직 첫 글자도 없다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *유나가 책을 내려놓는다. 표정이 변하지 않는다. — 근데 손이 떨리고 있다.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *담임이 멈춘다. 서류 봉투 끝이 접힌다.* ...잘 지내.
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임이 흰 봉투를 꺼낸다. 지난번의 갈색 봉투보다 얇다.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *담임이 웃는다. 창가 빛이 원고 봉투 위로 비친다.*
...
- 캐릭터: `없음`
**보건선생님**: *보건선생님이 눈을 뜨고 웃는다.* ...어디 아파? 내가 봐줄까? *농담처럼 말하지만 손끝은 조심스럽다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 커피잔을 내려놓는다. 웃음이 조금 늦게 번진다.*
...
- 캐릭터: `없음`
**보건선생님**: *보건선생님이 손을 뻗어 {name}의 손등에 붙은 밴드를 만진다. 아침에 붙여 둔 밴드다.*
...
- 캐릭터: `없음`
**보건선생님**: *보건선생님은 밴드 끝을 손톱으로 한 번 눌렀다가 손을 뗀다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건선생님이 병 라벨을 엄지로 문지른다. 웃음이 조금 늦게 따라온다.*
...
- 캐릭터: `seyoun_cry.png`
**서연**: *서연의 눈가가 젖어 있다. 이번엔 손등으로 숨기지 않는다.*
...
- 캐릭터: `없음`
**서연**: *서연이 손을 뻗는다. 새끼손가락이 아니다. 손 전체를.*
...
- 캐릭터: `없음`
**{name}**: *매일 아침 같은 길을 걸었다. 서연 옆에서는 같은 길도 매번 다른 표정이었다.*
...
- 캐릭터: `없음`
**서연**: *서연은 아이라인이 조금 번진 얼굴로도 사진을 지우지 않는다. 거울 앞에 놓인 화장솜은 오늘 하나도 쓰이지 않았다.*
...
- 캐릭터: `없음`
**{name}**: *고백은 했다. 서연도 해보자고 했다. 한 달쯤 지나, 학교 앞 카페에서 만나자는 연락이 왔다. 메시지 끝에는 마침표만 있었다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: ...우리 잘 될 줄 알았는데. 나도 너도, 한 발짝씩 늦었나 봐.
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *카페에서 만난 서연. 안경 너머 시선이 컵받침 위에 머문다. 주문한 커피는 반도 줄지 않았다.*
...
- 캐릭터: `없음`
**{name}**: *서연의 방. 부모는 외출 중이다. 책상 위 물건들은 자로 잰 듯 맞춰져 있고, 액자 속 가족사진은 조금 기울어 있다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *새끼손가락을 걸었다. 첫날 허공을 가르던 손가락이, 지금은 내 손가락에 걸려 있다.*
...
- 캐릭터: `없음`
**{name}**: *5일이었다. 서연이 클립보드 뒤에 숨겨 둔 얼굴을 보게 되기까지.*
...
- 캐릭터: `없음`
**유나**: *유나가 자리에서 일어나 안겼다. 아무 말 없이. 깨진 창문 사이로 들어온 빛이 바닥에 길게 놓인다. 유나의 손이 등 뒤에서 천천히 멈춘다.*
...
- 캐릭터: `없음`
**유나**: *유나는 여전히 말이 적다. 하지만 {name}에게만 문장의 길이가 달라졌다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 다락방의 작은 사다리를 올라간다. 위로 향하는 해치가 있다. — 열리자 바람이 불어온다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인은 배구공을 내려놓고 {name}의 대답을 기다린다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 배구공을 코트에 내려놓는다. 돌아서서 웃는다. 조용한 웃음이다.*
...
- 캐릭터: `없음`
**다인**: *다인이 자리에서 뛰어올랐다. 준비가 안 됐다. 배구공이 바닥을 굴러갔고 — 노을 진 체육관에 두 사람의 그림자만 남았다.*
...
- 캐릭터: `없음`
**다인**: *다인은 스포츠 해설가가 됐다. 카메라 앞에서도 웃고 있다. 이번엔 말끝에 힘을 주지 않는다.*
...
- 캐릭터: `dain_normal.png`
**다인**: 재밌었어! ...근데, 재밌기만 했던 것 같아. 그게 좀 아쉬워.
...
- 캐릭터: `dain_shy.png`
**다인**: *다인이 {name}의 손을 잡아 자기 손목 안쪽에 올린다. 아무 말 없이.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *다인의 목소리 끝이 가볍게 올라간다. 이번엔 억지로 밀어 올린 소리가 아니다.*
...
- 캐릭터: `없음`
**{name}**: *어머니의 전화는 여전히 짧고, 거울 앞 연습도 끝나지 않았다. 그래도 서연은 가끔 연습 안 한 얼굴로 내 쪽을 본다.*
...
- 캐릭터: `없음`
**{name}**: *좋아한다는 말은 입 밖으로 나왔다. 돌아오는 대답은 오래 걸렸고, 짧았다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연이 벚꽃잎을 떼어내듯 {name}의 소매 끝을 한 번 정리해 준다. 퉁명스러운 손길이지만, 밀어내는 손은 아니다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *서연은 아무 말 없이 반 걸음 늦춘다. {name}의 어깨가 나란해질 때까지 기다린다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연과 나란히 걷는다. 발걸음은 자주 엇갈리지만, 어느 쪽도 먼저 손을 놓지 않는다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *나는 웃었고, 서연은 못 본 척하다가 발걸음을 조금 늦춘다.*
...
- 캐릭터: `없음`
**{name}**: *벚꽃길 끝을 지나 천천히 걸어 나왔다. 다음 약속을 잡고 싶다는 말을, 이번엔 삼키지 않았다.*
...
- 캐릭터: `없음`
**서연**: *서연은 마지막까지 '초대'라는 말을 쓰지 않는다. 대신 복사한 옥상 열쇠를 사진으로 찍어 보냈다.*
...
- 캐릭터: `없음`
**{name}**: *열쇠를 주머니에 넣었다. 내일 옥상에는 내가 도시락을 들고 갈 차례다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나가 접힌 쪽지를 건넨다. 펼치면 한 줄이다. '다음에는 사라지지 마.'*
...
- 캐릭터: `yuna_smile.png`
**유나**: *유나는 책갈피를 새 페이지에 끼운다. 접힌 자국이 없는 쪽이다.*
...
- 캐릭터: `없음`
**유나**: *유나는 말 대신 다음을 준비한다. 1권 다음에 2권. 오늘 다음에 내일. 다음 약속을 그렇게 남긴다.*
...
- 캐릭터: `없음`
**서연**: *서연이 복도에서 {name}을 스쳐 지나간다. 고개를 돌리지 않는다.*
...
- 캐릭터: `없음`
**다인**: *다인은 평소처럼 웃었다. "잘 지내." 말끝이 바닥에 작게 떨어졌다.*
...
- 캐릭터: `없음`
**서연**: *서연이 먼저 웃었다. ...그래. 솔직하네. 웃음 끝이 금방 내려앉았다.*
...
- 캐릭터: `없음`
**유나**: *유나가 고개를 숙였다. 한참 뒤 올려다봤을 때, 손끝이 책등을 세게 누르고 있다.*
...
- 캐릭터: `없음`
**다인**: *다인이 주먹으로 {name}의 어깨를 친다. 제법 세게 닿는다. "야, 최악이다." 말끝에 웃음이 없다.*
...
- 캐릭터: `없음`
**서연**: *서연이 "수요일 뭐 해?"라고 물었을 때, 답장창에 손가락이 멈췄다.*

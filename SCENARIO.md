...
> 이 파일은 `node generate-scenario.js`로 자동 생성되었습니다.
...
**{name}**: *피식 웃는다. 입꼬리만 올라가는 웃음. 계산된 건지 원래 그런 건지 — 아직 모르겠다.*
...
**{name}**: *웃고 있다. 진짜 재밌어하는 것 같다. 첫날부터 이런 텐션의 학생회장이라니.*
...
**{name}**: *볼륨 조절이 안 되는 타입이다. 근데 표정이 진짜 반가워하는 거라 미워할 수가 없다.*
...
**{name}**: *글씨가 깔끔하다. 그리고 — 내용이 묘하게 위로가 된다.*
...
**{name}**: *관심 없는 척인지 진짜 관심 없는 건지. — 재밌다.*
...
**{name}**: *등이 곧다. 완벽하게 곧다. — 연습한 것처럼. 스치는 학생에게 인사할 때마다 같은 각도의 미소가 반복된다. 자동화된 친절. — 기계처럼 정확한 건 좀 이상한데.*
...
**{name}**: *처음부터 같이 먹을 생각이었다는 뜻이다. — 근데 절대 그렇게 말하지는 않겠지.*
...
**{name}**: *질문을 씹는 방식이 능숙하다. 연습이 돼 있다는 건지, 원래 이런 건지.*
...
**{name}**: *새끼손가락. — 별거 아닌 디테일인데 왠지 눈에 남는다.*
...
**{name}**: *눈이 반달 모양이 된다. 웃을 때 이렇게 되는구나. — 못 봤으면 몰랐을 디테일이다.*
...
**{name}**: *이상한 시간이다. 점심시간에 도서관에서 말 한마디 없이 앉아 있는 건데 — 불편하지가 않다. 왜지?*
...
**{name}**: *문장이 짧다. 근데 차가운 게 아니라, 말을 아끼는 느낌이다. 최소한의 단어로 최대한의 의미를 담는 사람.*
...
**{name}**: *'좋았어.' — 유나의 문장은 짧다. 근데 그 한마디가 왠지 오래 남는다.*
...
**{name}**: *웃고 있다. 하지만 눈이 안 웃는다. 손가락이 클립보드를 두드리고 있다.*
...
**{name}**: *손을 흔들며 뛰어간다. 폭풍 같은 여자다. 이름도 모르는데 벌써 반말이다.*
...
**{name}**: *교무실 앞에서 노크한다. 담임선생님이 문을 연다.*
...
**{name}**: *담임선생님이다. 가디건이 아까보다 더 흐트러져 있다. 하루 동안 전투를 치른 것 같다.*
...
**담임선생님**: 그래? 다행이다. — 뭐 힘든 거 있으면 교무실로 와. 선생님 일이니까.
...
**{name}**: *무심한 사람인 줄 알았는데, 의외로 챙기는 타입인 건가. — 아니, 그냥 담임이니까 하는 거겠지.*
...
**담임선생님**: 정신없는 게 정상이야. 새 학교에 첫날인데 여유로우면 그게 더 이상한 거고.
...
**담임선생님**: ...비슷한 거. 갑자기 새로운 곳에 던져진 적은 있지.
...
**담임선생님**: 적응 못 하겠으면 교무실로 와. 커피 정도는 — 아, 학생이니까 주스 정도는 줄 수 있어.
...
**{name}**: *담임이 복도 끝으로 사라진다. 긴 머리카락이 흔들린다. — 교육적 관심이라면서, 눈은 그게 아니었다.*
...
- 타입: `free_talk`
- 다음: `night_start`
- 컨텍스트: "Day 1 방과후. 전학 첫날 방과후에 담임선생님이 적응 확인을 위해 불러세웠다. 주인공이 솔직하게 정신없다고 대답한 뒤의 대화. 톤: 밝고 가벼운 대화. 첫날의 설렘과 호기심. 무거운 이야기는 절대 하지 않는다. 장난과 티키타카 위주."
- 성격: "담임선생님은 건조한 유머와 무뚝뚝함 뒤에 세심함을 숨기는 30대 초반 여자 교사. 갈색 웨이브 긴 머리에 베이지 가디건 차림. 자기 마음을 '업무'나 '교육적 관심'으로 포장하는 습관. 소설가 지망생이었던 과거가 있다."

**담임선생님**: *담임선생님과 복도에서 대화 중.*

---

### `after_hidden_nurse_intro`
- 배경: `school_hallway.png`
- 다음: `after_hidden_nurse_intro_ins`
...
**{name}**: *복도 한쪽에 '보건실' 표지판이 보인다. — 들어갈까 말까.*
...
- 배경: `school_hallway.png`
- 선택지:
  1. "보건실에 들어간다" → `after_nurse_enter_1` | Nurse +7
  2. "그냥 집에 간다" → `after_nurse_skip` | Nurse +0

**{name}**: *아침부터 쉴 틈 없이 사람을 만났으니까.*
...
- 성격: "보건선생님은 장난기 넘치고 유혹적이지만 진심을 장난 뒤에 숨기는 여성. 대학병원 간호사 출신으로 번아웃을 겪고 학교로 왔다. '선생님이니까' 뒤에 항상 숨겨진 감정이 있다."
...
**담임선생님**: 구경하다 교무실까지 왔어? 특이하네. — 잠깐 들어와.
...
**{name}**: *보건실 문을 연다. 소독약 냄새가 은은하게 난다. 흰 커튼, 하얀 침대, 작은 책상.*
...
**{name}**: *관찰력이 예리한 건지, 그냥 장난인 건지. — 아마 둘 다.*
...
**{name}**: *보건선생님이 일어나 다가온다. 동작이 매끄럽다. — 일반적인 학교 보건선생님 수준이 아니다. 몸에 배어 있는 움직임. 수백 번 반복한 사람의 손.*
...
**{name}**: *가끔 까먹는다. — 농담인 것 같은데, 살짝 진심이 묻어 있다.*
...
**{name}**: *'가벼운 상처만'. — 그 말에 안도가 묻어 있다. 가벼운 게 아닌 상처를 많이 봤다는 뜻이기도 하다.*
...
**{name}**: *'선생님이니까'. — 이 말이 방패인 것 같다. '선생님'이라는 직함 뒤에 뭔가를 숨기는 사람.*
...
**{name}**: *보건선생님이 잠깐 멈춘다. 웃음이 0.3초 늦게 돌아온다.*
...
**{name}**: *환자한테 걱정을 들은 게 의외인 표정이다. — 이 사람은 늘 챙기는 쪽이었지, 챙김을 받는 쪽은 아니었구나.*
...
**{name}**: *가볍게 웃는데, 눈은 안 웃는다. — 이 사람은 농담과 진심의 경계가 모호하다.*
...
**{name}**: *'서비스야'를 일부러 한 줄 띄어서 보냈다. — 이것도 계산인 건지, 진심인 건지.*
...
**{name}**: *짧다. 근데 '자리 비워 놓을게'가 이 사람한테는 최대한의 환영 아닌가.*
...
**{name}**: *'찾으러 갈 거야'가 농담인지 진담인지. — 이 사람은 경계가 없다.*
...
**{name}**: *읽씹당한 건지 자기가 읽씹한 건지. — 이 사람은 모든 게 모호하다.*
...
**{name}**: *공지사항에 개인 메시지를? — 이 사람, 공사 구분이 안 되는 건가. 아니면 일부러 이런 건가.*
...
**{name}**: *둘째 날. 어제보다 교복이 조금 편하다. 적응이 빠른 건지, 포기가 빠른 건지.*
...
**{name}**: *웃고 있다. 하지만 시선이 쪽지 위에 0.5초 머문다.*
...
**{name}**: *쪽지를 주머니에 넣었다. 두 사람의 반응이 미묘하게 다르다.*
...
**{name}**: *사람이 선점의 대상인가. — 근데 반박하기가 묘하게 귀찮다.*
...
**{name}**: *교무실을 나서는데 — 서랍에서 봤던 종이뭉치가 자꾸 신경 쓰인다.*
...
**{name}**: *담임이 잠깐 멈칫한다. 시선이 서랍 쪽으로 갔다가 — 바로 돌아온다.*
...
**{name}**: *유나가 아주 살짝 — 입꼬리가 올라간다. 거의 안 보인다.*
...
**{name}**: *'있었는데' 뒤에 말이 없다. 과거형. — 물어봐도 될까.*
...
**{name}**: *서연의 손이 지나간 자리가 아직 신경 쓰인다. — 그리고 다인의 놀란 눈도.*
...
**{name}**: *빵을 사서 복도 벤치에 앉는다. — 그때 서연이 지나간다. 도시락 가방을 들고.*
...
**{name}**: *서연이 이쪽을 본다. 다인 옆에 앉아 빵을 먹고 있는 나를 — 0.5초 응시하고 지나간다.*
...
**{name}**: *다인의 표정이 미묘하게 굳는다. 소보로를 한 입 베어 물며 고개를 돌린다.*
...
**{name}**: *보건선생님의 손이 멈춘다. — 0.5초. 그리고 다시 움직인다.*
...
**{name}**: *장난기가 사라졌다. — 0.5초. 그리고 다시 돌아온다.*
...
**{name}**: *그런데 — 체육 시간에 까진 팔꿈치가 아까부터 계속 신경 쓰인다. 보건실에 들러야겠다.*
...
**{name}**: *화제가 바뀌었다. — 일부러 바꾼 건지, 진짜 매운 건지. 아마 둘 다.*
...
- 캐릭터: `seyoun_normal.png`
- 선택지:
  1. "석양 예쁘다. — 아, 너 말고 밖에." → `after2_seo_sunset_joke` | Seoyeon +5
...
**{name}**: *서연의 손가락이 0.5초 멈춘다. 아무 말도 안 하고 고개를 돌린다.*
...
**{name}**: *묘하게 꼬인 질문이다. — 근데 어딘가 기다리고 있었다는 뉘앙스가 있다.*
...
**{name}**: *노을이 지고 있다. 유나와 나란히 앉아 음악을 듣는다. 아무 말도 필요 없는 시간.*
...
**{name}**: *체육 시간에 팔꿈치가 까졌다. 별거 아닌데 피가 조금 난다.*
...
**{name}**: *세 번째 별? — 창문을 열고 밤하늘을 본다. 별이 보인다. 세 번째 별이 어떤 건지는 모르겠지만. 유나다운 수수께끼다. 답을 말해주지 않는 사람. — 알고 싶게 만드는 사람.*
...
**{name}**: *갤러리를 닫았다. 사진을 지울까 말까 고민하다가 — 남겨뒀다. 지우면 후회까지 지워지는 것 같아서.*
...
**{name}**: *'신경 쓰인다'와 '좋아한다' 사이에는 아직 거리가 있다. — 근데 그 거리가 어제보다 짧아진 것 같다.*
...
**{name}**: *거부권 없음. — 의료적 강제인 건지 개인적 관심인 건지, 이모티콘이 경계를 흐린다.*
...
**{name}**: *세 번째 별? — 창문을 열고 밤하늘을 본다. 별이 보인다. 세 번째 별이 어떤 건지는 모르겠지만.*
...
**{name}**: *유나다운 수수께끼다. 답을 말해주지 않는 사람. — 알고 싶게 만드는 사람.*
...
**{name}**: *유나와 나란히 걷는다. 아무 말이 없다. — 그런데 이상하게 불편하지 않다.*
...
**{name}**: *밤새 책 읽고 지각하는 사람. — 대단한 건지 한심한 건지, 아무튼 유나답다.*
...
**{name}**: *1교시가 끝나고 쉬는 시간. — 세 명이 차례로 접근한다.*
...
**담임선생님**: 대학 때 시작했어. 문예창작과. 졸업하고 등단 준비했는데 — 2년 동안 떨어졌어. 세 번.
...
**{name}**: *2교시와 3교시 사이 쉬는 시간. 화장실을 다녀오는 길에 — 복도 끝 빈 교실에서 불빛이 보인다.*
...
**{name}**: *조용히 다가간다. 문이 살짝 열려 있다. — 담임선생님이 교탁에 앉아 뭔가를 쓰고 있다.*
...
**{name}**: *서류가 아니다. 원고지다. — 어제 교무실 서랍에서 본 그 종이뭉치.*
...
**{name}**: *담임이 펜을 멈추고 고개를 든다. — 나와 눈이 마주친다.*
...
**{name}**: *0.5초. 얼어붙는다. — 담임의 표정이 처음 보는 거다. 무심한 것도, 건조한 것도 아닌. 들킨 사람의 얼굴.*
...
**{name}**: *웃음이 어색하다. — 이 사람이 웃는 게 어색한 건지, 웃는 법을 잊은 건지.*
...
**{name}**: *다 같이 나눠 먹자고 했다. 어색하지만 — 나쁘지 않은 공기다. 셋 다 웃고 있다. 진짜인지 연기인지는 모르겠지만.*
...
**{name}**: *셋이 나눠 먹었다. 어색하지만 — 나쁘지 않다. 아무도 화내지 않았다. 이상하게, 이게 가능한 세계도 있는 것 같다.*
...
**{name}**: *다 같이 먹자라고 말했다. — 근데 분위기가 이상하다.*
...
**{name}**: *서연의 젓가락이 잠깐 멈춘다. ...나눠 먹자고? 둘이 먹으려고 한 건데. 0.5초 뒤 표정 관리. 학생회장의 얼굴로 돌아간다. 뭐, 괜찮아. — 괜찮지 않다는 걸 안다.*
...
**{name}**: *유나가 고개만 끄덕인다. 쪽지를 쓰다 접어서 주머니에 넣는다. 안 건넨다. — 건네려던 쪽지에 뭐가 적혀 있었을까. 영원히 알 수 없다.*
...
**{name}**: *복도에서 다인과 마주친다. 평소의 에너지가 없다.*
...
**{name}**: *도서관 옆을 지나간다. 유나의 자리가 비어 있다. 쪽지가 하나 남아 있다. '...알겠어.' 세 글자.*
...
**{name}**: *복도로 나왔다. 느낌표가 없는 다인의 문장, 세 글자밖에 안 되는 유나의 쪽지. — 선택의 무게가 어깨에 내려앉는다.*
...
**{name}**: *체육관을 나와 복도로 돌아왔다. 서연의 한마디, 다인의 빨간 눈. — 돌아서는 길이 무겁다.*
...
**{name}**: *도서관에 쪽지가 없다. 유나의 가방이 없다. 일찍 간 것 같다.*
...
**{name}**: *서연의 연습한 웃음, 유나의 빈 자리. — 남은 두 사람의 자리가 비어 가는 느낌.*
...
**{name}**: *다인이 멈칫한다. — 그리고 작게 웃는다. 처음 보는 웃음이다.*
...
**{name}**: *거절도 사랑. — 전 학교에서 소정이가 나한테 '거절'할 기회조차 주지 못했다. 내가 말하지 못했으니까.*
...
**{name}**: *받아들었다. — 다인이 누군가의 도움을 거절하지 않은 건 처음이다. 느낌표가 사라진 웃음이 이상하게 무겁다.*
...
**{name}**: *지우면 후회까지 지워지는 것 같아서 남겨뒀었다. 근데 이제 후회가 아니라 교훈이다. 고백할 용기를 가르쳐준 사진. — 역할을 다했다.*
...
**{name}**: *이번에는 다르다. 한 사람에게만 말하겠다. 나머지에게는 — 제대로 거절하겠다. 그게 내가 할 수 있는 유일한 성실함이다.*
...
**{name}**: *결말을 쓰면 끝나니까. — 유나는 이 이야기가 끝나는 걸 두려워하고 있다.*
...
**{name}**: *서연이 말했다. '유일한 답이거나, 아무것도 아니거나.'*
...
**{name}**: *꿈을 꿨다. — 누군가와 나란히 걷고 있었다. 얼굴은 보이지 않는데, 옆에 있다는 것만으로 마음이 편했다.*
...
**{name}**: *1초. 손가락이 멈춘다. — 민수가 했던 말이 떠오른다. '거절도 사랑이야.'*
...
**{name}**: *...거절. 그래, 해야 하는 건 알고 있다. 알고 있는데.*

---

### `night3_faithful_reflect_4_ins3`
- 배경: `room_my.png`
- 다음: `night3_faithful_reflect_4_ins4`

**{name}**: *손가락이 움직이지 않는다. 삭제 버튼 위에 올려놓은 채로.*

---

### `night3_faithful_reflect_4_ins4`
- 배경: `room_my.png`
- 다음: `night3_faithful_reflect_4_ins5`

**{name}**: *전 학교에서도 이랬다. 알면서 못 했다. 이번에도 — 알면서 못 하고 있다.*
...
**{name}**: *...나는 과거에도 지금도, 아무것도 놓지 못하는 비겁한 놈일 뿐이다.*
...
**{name}**: *학교 정문이 살짝 열려 있다. 안쪽에서 인기척. — 정문 앞에서 나오는 사람. 담임선생님이다. 사복 차림.*
...
**{name}**: *사복 차림의 담임은 교사처럼 보이지 않는다. 그냥 — 글 쓰는 사람처럼.*
...
- 성격: "담임선생님은 사복 차림에서 더 편안하다. 소설에 대한 열정과 학생에 대한 감정 사이에서 흔들린다."
...
- 성격: "보건선생님은 사복에서 누나 같다. 장난기와 진심이 오가며, 이름을 불러주는 것의 무게를 안다."
...
**{name}**: *'진짜로'. — 이 사람의 진심 확인 단어. 오늘은 내가 먼저 들었다. 잠깐의 침묵. 보건선생님의 안경 너머로 눈이 촉촉해 보인다. — 렌즈가 뿌옇다. 김이 서린 건지, 눈이 젖은 건지. 보건선생님이 다시 밝은 톤으로, 하지만 목소리가 떨리며 말한다. 장난기가 돌아왔다. — 근데 웃는 눈 아래로 뭔가 흐른 자국이 있다.*
...
**{name}**: *...화가 났을 텐데도, 변명이라도 듣고 싶었던 건지. 아니면, 화를 내면서도 포기할 수 없었던 건지. — 어느 쪽이든, 이 사람이 나온 이유를 함부로 가볍게 생각하면 안 된다.*
...
**{name}**: *데자뷰다. 어제 빈 교실에서도 비슷한 말을 했다. — 근데 오늘은 카페에서, 사복 차림으로, 더 가볍게. 아니 — 더 진지하게.*
...
**{name}**: *담임이 주머니에서 손을 뺀다. 가디건을 여미는 듯한 — 아, 사복이다. 빈 제스처.*
...
**{name}**: *보건실. 책상 위에 서류와 검진 도구가 쌓여 있다. 보건선생님이 사복 차림으로 정리 중이다. 흰 가운 대신 베이지 니트.*
...
**{name}**: *웃음이 자연스럽다. — 학교에서 볼 때와 다르다. 사복 차림의 보건선생님은 선생님이 아니라 그냥 — 누나 같다.*
...
**{name}**: *장난기가 사라졌다. — 0.5초. 이 사람의 진심 게이지는 0.5초 단위로 움직인다.*
...
**{name}**: *분수대 앞. 서연이 서 있다. 평소 교복이 아닌 사복. 흰 블라우스에 스커트.*
...
**{name}**: *손끝이 차갑다. 바람이 안 부는데. 지금 말하지 않으면 — 다시는 이 용기가 안 날 것 같다.*
...
**{name}**: *숨이 짧아졌다. 방 안이 좁아진 것 같다. 지금 말하지 않으면 — 다시는 이 용기가 안 날 것 같다.*
...
**{name}**: *체육관 바닥이 흔들리는 것 같다. 지금 말하지 않으면 — 다시는 이 용기가 안 날 것 같다.*
...
**{name}**: *'엄청'. — 다인의 감정 표현은 단순하다. 근데 그 단순함이 진심의 증거다.*
...
**{name}**: *잠깐의 침묵. 보건선생님의 안경 너머로 눈이 촉촉해 보인다. — 렌즈가 뿌옇다. 김이 서린 건지, 눈이 젖은 건지.*
...
- 야간: true
- 선택지:
  1. "완벽한 서연보다, 지금 이 서연이 더 좋아." → `wall_seo_line_react_1` | Seoyeon +10
  2. "학생회장 서연이 아니라, 그냥 서연이가 내 여자친구야." → `wall_seo_line_react_2` | Seoyeon +10
  3. "솔직히 완벽한 줄만 알았어. 근데 이런 모습 보여줘서 고마워." → `wall_seo_line_react_3` | Seoyeon +6
...
**{name}**: *스포츠센터 후 벤치에 앉았다. 다인이 아무 예고 없이 무릎 위에 눕는다.*
...
**{name}**: *유나다. 혼자 앉아 있다. 책을 읽고 있는 건지, 그냥 앉아 있는 건지 — 여기서는 모르겠다.*
...
**{name}**: *유나에게서 오늘 메시지는 없었다. — 유나는 원래 연락을 안 하니까. 그게 평소인 건지, 오늘따라 그런 건지.*
...
**유나**: 처음에 네가 도서관에 왔을 때. 선배랑 분위기가 비슷했어. — 그래서 무서웠어. 또 친해지면 또 사라질까 봐.
...
**{name}**: *...오늘 말할 수 있었는데. 그 석양 아래서, 완벽한 순간이었는데.*
...
**{name}**: *토요일이 이렇게 지나갔다. 내일은 뭘 하게 될까.*
...
**{name}**: *— 그리고 천천히, 아주 천천히, 완벽하게 유지하고 있던 표정이 무너졌다. 서연이 떨리는 손으로 안경을 벗어 쥐었다.*
...
**{name}**: *눈에서 물이 흘러내린다. 소리 없이. — 안경 없는 서연의 얼굴을 처음 본다.*
...
**{name}**: *오늘은 학교 행사가 있다. 마지막 이벤트. 교실에 들어서자마자 — 세 방향에서 신호가 온다.*
...
**{name}**: *복도 문예부 전시 코너를 지나가다 — 게시판에 단편소설이 붙어 있다. 제목: '도서관에서 만난 사람에게'. 유나다. — 주인공만 알아볼 수 있는 이야기.*
...
**{name}**: *다섯째 날. 마지막 날. 교복이 편해졌다. 5일 전에는 뻣뻣했는데, 이제 몸에 맞는다. — 이 학교에 적응한 건지, 아니면 이 사람들에게 적응한 건지.*
...
**{name}**: *담임이 돌아선다. 긴 머리카락이 흔들린다. — 오늘은 가디건 단추가 반듯하다.*
...
**보건선생님**: *가볍게 웃으며* 졸업하면 놀러 와. ...그전에도 아프면 와.
...
**{name}**: *행사 중간 쉬는 시간. 보건실 앞을 지나가는데 — 문이 열린다. 보건선생님이 나온다.*
...
**{name}**: *'당분간은'에 유나의 전부가 들어 있다. 영원히라고 말할 수 없는 사람이 최대한 멀리 던진 약속.*
...
**{name}**: *유나의 '재밌었어'는 보통 사람의 '고마웠어, 좋아했어, 다음에 또 만나자'를 전부 압축한 단어다.*
...
- 배경: `school_back.png`
- 분기:
  - [`route_seoyeon`] → `after5_confess_react_seo`
  - [`route_dain`] → `after5_confess_react_dain`
  - [`route_yuna`] → `after5_confess_react_yuna`
  - [기본] → `ending_start`
...
- 분기:
  ...
  - [`homeroom_day5`] → `hidden_good_homeroom_1`
  - [`nurse_day5`] → `hidden_perfect_nurse_check`
  - [`nurse_day5`] → `hidden_good_nurse_1`
  - [`day4_confession_accepted`] → `ending_affinity_check`
  - [`ending_harem`] → `day5_ending_harem`
  - [`day4_confession_accepted`] → `day5_ending_good`
  - [`day3_has_multiple_dates`] → `day5_ending_mayhem`
...
**{name}**: *보건실을 나왔다. 하트가 — 이번에는 확실히 의료적 관심이 아니다.*

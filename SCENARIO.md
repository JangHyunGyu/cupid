...
- 캐릭터: `yuna_normal.png` @ 0.35
**{name}**: *'자리 비워 놓을게'. — 유나한테 이건 최대한의 초대다. 핸드폰을 내려놓는 손이 천천히 움직인다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 그건 안 봤지? 비밀. 선생님도 숨기는 거 하나쯤은 있어.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 근데 넌 내가 얼버무리는 것도 다 알아보더라.
...
- 캐릭터: `없음`
**{name}**: *흔들렸으니까 알았다. 서연에게 기대는 게 약한 게 아니라는 걸.*
...
- 캐릭터: `없음`
**{name}**: *돌아간 것 같았는데, 유나 옆이 결국 내 자리였다.*
...
- 캐릭터: `없음`
**{name}**: *답장을 쳤다. '나도 고마워.' — 보내고 나서 화면을 본다. 두 줄의 대화. 웃고는 있는데 마음은 영 개운하지 않다.*
...
- 캐릭터: `없음`
**{name}**: *앞으로도 이렇게 메시지를 주고받겠지. 이모티콘 붙이고, 가끔 밥 먹고, 별일 없냐고 물으면 없다고 답하겠지. — 바로 옆인데 끝내 못 넘는 선이 있다. 친구는 그렇게 남는다.*
...
- 캐릭터: `없음`
**{name}**: *전학을 와도, 도망치듯 옮겨와도 — 중요한 순간마다 나는 또 똑같았다.*
...
- 캐릭터: `없음`
**{name}**: *월요일은 서연. 수요일은 유나. 금요일은 다인. 사이사이에 들키지 않기 위한 거짓말이 쌓인다. 달콤할 줄 알았는데 금방 숨이 막혀온다.*
...
- 캐릭터: `없음`
**{name}**: *이 균형은 오래 못 간다. 누군가는 먼저 다친다. 그때쯤이면 이건 로맨스가 아니라 그냥 사고다.*

...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 바로 돌아서지 않는다. 클립보드 끝이 문 쪽을 가리킨 채, 내 발소리를 기다린다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *교탁 서랍의 미완성 원고. 7년 동안 닫혀 있던 이야기가 여기까지 밀려 나왔다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 멈춘다. 말이 끊긴 사이, 클립보드 가장자리를 쥔 손에 힘이 들어간다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 크게 웃는다. 웃음이 대사보다 한 박자 늦게 따라온다.*
...
- 캐릭터: `dain_sad.png`
**다인**: 진짜 웃기지? 5살 때부터 매일 이 코트에 섰는데... 이제는 다른 걸 생각해야 한다는 게.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 어? {name}. 벌써 마지막 날이네. 행사 끝나면 진짜 끝이겠다.

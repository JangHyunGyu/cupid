...
- 캐릭터: `seyoun_normal.png`
**{name}**: *숨이 목까지 차오른다. 주머니 속 핸드폰을 한 번 쥐었다가 놓는다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *열쇠를 건넨다. 새끼손가락이 살짝 닿자, '줄게'라는 말 대신 손을 놓는다.*
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *눈 밑에 번진 자국이 그대로 남아 있다. 서연은 거울을 보지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *서연의 방. 부모는 외출 중이다. 책상 위 물건들은 책상 모서리와 평행으로 놓여 있고, 액자 속 가족사진은 조금 기울어 있다.*
...
- 캐릭터: `seyoun_laugh.png`
**서연**: 그렇게 말해도 돼. 집에서는 다들 조용한 게 좋다고 해서.
...
- 캐릭터: `seyoun_normal.png`
**서연**: *{name}의 소매 끝에 붙은 벚꽃잎을 떼어낸다. 손은 바로 떨어지지 않는다.*

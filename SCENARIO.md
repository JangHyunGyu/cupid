...
- 캐릭터: `dain_laugh.png`
**{name}**: *손을 흔들며 뛰어간다. 아까 담임이 불렀던 이름 — 다인. 벌써 반말이다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *담임이 피식 웃고 출석부를 덮는다. 문턱까지 갔다가 다시 나를 부른다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 일어나 다가온다. 손등에 체온계 끝이 닿자 손가락이 살짝 굳는다.*
...
- 선택지:
  ...
  2. "보건실, 생각보다 조용하네요" → `after_nurse_enter_choice_b` | Nurse +3 | 플래그: `nurse_choice_b`
...
- 캐릭터: `nurse_angry.png`
**{name}**: *보건선생님이 물컵을 책상에 내려놓는다. 컵 바닥이 낮게 울린다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 커튼 끝을 손가락으로 한 번 접는다.*
...
- 캐릭터: `teacher_normal.png` @ 0.35
**{name}**: *공지사항을 한 번 더 읽는다. 입꼬리가 올라가서, 화면을 엎어 둔다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인의 목소리가 아침 조회 전 교실을 먼저 채운다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *서연은 복도를 돌아가기 직전 발끝을 늦춘다. 클립보드가 팔 안으로 더 붙는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 서랍을 닫는다. 손잡이가 한 번 더 눌린다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 책장을 넘긴다. 종이 넘어가는 소리가 전보다 가볍다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 책장으로 시선을 돌린다. 열린 페이지 위로 햇빛이 조금 더 길어진다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인은 컵을 내 쪽으로 밀어놓고, 일부러 큰 소리로 물을 찾는다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 서류 끝으로 입가를 가린 채 한동안 창밖을 본다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *담임의 손이 원고지 위에서 멈춘다. 곧 종이가 뒤집힌다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임은 그렇게 말하고도 원고지에서 손을 떼지 못한다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *담임이 머리카락을 넘기며 교실을 나선다. 닫힌 문 안쪽에서 펜 뚜껑 소리가 난다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 벤치에 앉는다. 무릎을 문지른 손이 같은 자리를 오래 맴돈다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 멈춘다. 무릎을 감싸던 손이 허공에 뜬다.*
...
- 캐릭터: `dain_sweat.png`
**{name}**: *다인이 착지하면서 오른쪽 무릎이 살짝 꺾인다. 손이 무릎 위에 남는다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 안도의 한숨을 쉰다. 체육관 바닥에 공 굴러가는 소리만 남는다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인이 멈춘다. 그리고 작게 웃는다. 손등으로 눈가를 한 번 문지른다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 커피잔을 내려놓는다. 창가 쪽으로 몸이 조금 기운다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *담임이 잠깐 웃는다. 컵홀더를 접던 손이 멈춘다.*
...
- 캐릭터: `nurse_shy.png`
**{name}**: *보건선생님이 안경을 고쳐 쓴다. 손끝이 렌즈 아래에서 잠깐 멈춘다.*
...
- 캐릭터: `nurse_shy.png`
**{name}**: *보건선생님이 컵라면 뚜껑을 누른다. 젓가락 한 짝이 조금 비뚤어진다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *서연이 잠깐 멈춘다. 가방끈을 쥔 손이 느슨해진다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 나를 본다. 넘기던 페이지가 손끝에서 멈춘다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인이 공을 다시 끌어안는다. 손등에 힘이 들어간다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 웃는다. 번진 화장 아래로 젖은 자국이 남아 있다.*
...
- 캐릭터: `dain_sweat.png` @ 0.35
**{name}**: *다인이 웃는다. 손은 무릎 보호대를 꽉 누르고 있다.*
...
- 캐릭터: `yuna_normal.png` @ 0.35
**{name}**: *유나가 쪽지 대신 직접 말한다. 손에는 아무 종이도 없다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 숨을 천천히 내쉰다. 편지 모서리가 손끝에서 조금 구겨진다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 작게 웃었다. 손끝이 편지 모서리를 한 번 더 누른다.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *담임은 같은 말을 다시 삼킨다. 클립보드 끝이 문틀에 가볍게 닿는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님은 밴드 상자 뚜껑을 닫았다가 다시 연다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 흰 봉투를 꺼낸다. 예전 갈색 봉투보다 얇다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *담임이 웃는다. 창가 빛이 원고 봉투 위로 비친다.*
...
- 캐릭터: `없음`
**{name}**: *보건선생님은 밴드 끝을 손톱으로 한 번 눌렀다가 손을 뗀다.*
...
- 캐릭터: `없음`
**{name}**: *카페 창문에 보건실 흰 커튼이 잠깐 겹쳐 보였다가 사라진다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *잠깐 멈추며* ...그래. 의료적 관심. *작게* 그렇게 해둘게.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 병 라벨을 엄지로 문지른다. 웃음이 조금 늦게 따라온다.*
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *서연의 눈가가 젖어 있다. 이번엔 손등으로 숨기지 않는다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 잠깐 멈춘다. 책등을 쥔 손이 느슨해진다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인의 목소리 끝이 가볍게 올라간다. 이번엔 억지로 밀어 올린 소리가 아니다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나는 책갈피를 새 페이지에 끼운다. 접힌 자국이 없는 쪽이다.*
...
- 캐릭터: `없음`
**{name}**: *유나가 고개를 숙였다. 한참 뒤 올려다봤을 때, 손끝이 책등을 세게 누르고 있다.*

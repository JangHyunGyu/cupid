...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임의 시선이 서랍 쪽을 스치고 바로 돌아온다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 '도망'에서 잠깐 멈춘다. 청진기를 만지는 손끝이 노트 서랍 쪽으로 가려다 멈춘다.*
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *서연은 대답 대신 머리카락을 귀 뒤로 넘겼다. 같은 손이 곧바로 다시 올라갔다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 빵 부스러기가 가라앉는 물가를 보고 있었다. 꽃집 앞에서 걸음이 느려졌다.*
...
- 캐릭터: `seyoun_worried.png`
**{name}**: *서연이 화분을 내민다. 흙이 든 작은 무게가 손바닥에 내려앉았다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 고개를 숙인다. 컵 가장자리만 오래 본다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인이 멈춘다. 캡모자를 푹 눌러쓰는 바람에 얼굴이 반쯤 가려졌다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인은 캡모자 챙을 붙잡은 채 한동안 손을 내리지 못했다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인은 배구공을 내려놓고 먼저 걷는다. 뒤돌아보지 않았다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인의 걸음이 한 번 끊겼다. 다시 걷기 시작했을 때는 조금 가벼워져 있었다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나는 책을 쥔 손에 힘을 주고 있다. 대답을 기다리는 동안 편지 모서리가 조금 구겨졌다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 고개를 든다. 이번엔 시선을 피하지 않는다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 멈춘다. 표정은 금방 돌아왔지만, 봉투가 손 안에서 조금 구겨졌다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 멈춘다. 종이 끝이 손 안에서 조금 휘어진다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 문을 열고 나온다. 물러설 틈도 없이 마주쳤다.*
...
- 캐릭터: `nurse_shy.png`
**{name}**: *보건선생님이 웃다가 멈춘다. 안경을 고쳐 쓰는 손이 조금 늦다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 돌아서며 손을 흔든다. 뒤돌아보지 않는다. 손목의 리본만 복도 끝에서 흔들린다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인은 배구공을 한 번 더 높이 던지고 받는다. 받는 손끝이 조금 늦다.*
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *서연이 내민 손끝이 눈앞에 머문다. 대답을 기다리는 손이다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인이 그대로 굳는다. 손에 든 공이 천천히 내려간다.*
...
- 캐릭터: `없음`
**보건선생님**: *눈을 뜬다. 웃는다.* ...어디 아파? 내가 봐줄까? *농담처럼 말했지만 손끝은 조심스럽다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 커피잔을 내려놓는다. 웃음이 조금 늦게 번진다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인이 배구공을 코트에 내려놓는다. 돌아서서 웃는다. 조용한 웃음이다.*
...
- 캐릭터: `없음`
**{name}**: *다인은 평소처럼 웃었다. "잘 지내." 말끝이 바닥에 작게 떨어졌다.*
...
- 캐릭터: `없음`
**{name}**: *다인이 주먹으로 내 어깨를 쳤다. 아팠다. "야, 최악이다." 그 말이 맞았다. 다인은 웃지 않았다.*

...
- 캐릭터: `없음`
**{name}**: *세 갈래 길. 첫날부터 이런 선택이라니. 전 학교에서는 선택을 안 했다. 미루다가 타이밍을 놓쳤다. — 이번에는.*
...
- 캐릭터: `seyoun_laugh.png`
**서연**: *미소* 의심 많네. 밑에서 사람 상대하다 보면 혼자 있고 싶을 때가 있어.
...
- 캐릭터: `dain_normal.png`
**다인**: 소보로빵이랑 딸기우유 조합이 칼로리 대비 행복감 최고야! 믿어봐!
...
- 캐릭터: `dain_laugh.png`
**다인**: 아니, 나랑 같이 다니려면 최소 체력 테스트 통과해야 해서! ㅋㅋ
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나의 책상에 뭔가 끼워져 있다. 오래된 책갈피. 글씨가 적혀 있는데 — 잘 안 보인다. 유나가 무의식적으로 그 책갈피 위에 손을 올려놓는다. 소중한 건가. 서가에서 아무 책이나 꺼내 펼친다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *웃고 있다. 손가락이 클립보드를 두드리고 있다. — 목 뒤가 뜨거워진다. 시선을 돌렸다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *웃었다. — 이 사람이 농담에 웃는 건 처음 봤다. 담임이 출석부를 덮고 자리에서 일어난다. 문턱까지 갔다가, 뒤늦게 떠오른 것처럼 다시 나를 부른다.*
...
- 캐릭터: `haeun_normal.png`
**{name}**: *부탁이라고 했지만, 눈빛은 경고다. — 이 사람, 서연을 진심으로 걱정하고 있구나. 하은이 고개를 살짝 숙이고 간다.*
...
- 캐릭터: `dain_active.png`
**{name}**: *랠리가 오간다. 다인의 움직임은 — 확실히 보통이 아니다. 빠르고, 정확하고, 몸이 기억하고 있는 움직임. 이 여자, 진짜 잘한다. 근데 — 착지할 때마다 왼발에 체중을 더 싣는다. 오른쪽을 피하는 것 같다.*
...
- 캐릭터: `minsu_smirk.png`
**{name}**: *할 말이 없다. 민수가 맞다. — 눈치 빠르다고 자부하면서, 정작 내가 뿌리고 다니는 오해는 못 보고 있었다. 민수가 가방 끈을 고쳐 매며.*
...
- 캐릭터: `seyoun_normal.png` @ 0.35
**{name}**: *'이번엔 진짜 와'라고 했지만, 안 가면 뭔가 벌어질 것 같은 톤이다.*
...
- 캐릭터: `없음`
**{name}**: *핸드폰 메모장의 시뮬레이션은 38번째에서 멈춰 있다. 39번째는 없다. 보낼 상대가 사라졌으니까. 고백도 못 했고, 지켜주지도 못했다. 전학은 소정이 때문이 아니다. 아버지 직장 때문이다. — 근데 전학이 싫지 않았다. 소정이의 빈 책상을 매일 지나가지 않아도 되니까.*
...
- 캐릭터: `없음`
**{name}**: *소정이 때 나는 한 사람만 봤다. 한 사람만 좋아했고, 한 사람만 보다가 — 그 한 사람이 무너지는 걸 옆에서 다 봤으면서도 메모장에서 멈췄다. 38번. 한 명만 본다는 건, 한 명을 잃을 수 있다는 말이었다. 그때의 나는 그걸 몰랐다.*
...
- 캐릭터: `없음`
**{name}**: *— 그래서 지금 내가 셋한테 다 여지를 두고 있는 거다. 인정하기 싫지만. 한 명을 너무 빨리 정하면, 그 한 명만 보게 되고, 나머지는 안 보이게 되고, 결국 또 누군가 무너질 때 옆에서 못 알아챌까 봐. 보험 같은 거다. 비겁한 거 안다. 누가 봐도 우유부단한 새끼지. 근데 — 한 사람만 보다가 잃는 게 어떤 건지, 나는 안다. 그게 제일 무섭다.*
...
- 캐릭터: `없음`
**{name}**: *그 말이 자꾸 맴돈다. 대답은 아직 못 했다. 어제는 신경 쓰이는 정도였다. 오늘은 — 보고 싶다는 말이 목까지 올라왔다가 내려갔다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *얼어붙는다. — 담임의 표정이 처음 보는 거다. 들킨 사람의 얼굴. 담임이 재빨리 원고지를 뒤집어 놓는다.*
...
- 캐릭터: `없음`
**{name}**: *뭐가 고마운 건지는 모르겠다. 안 봐줘서? 아니면 — 여기까지 와줘서? 점심시간 직전. — 아침 내내 마음이 가라앉지 않는다. 너무 많은 얼굴을 보고, 너무 많은 말을 들은 탓일까. 뭐가 이렇게 빨리 흔들리는 건지 모르겠다.*
...
- 캐릭터: `없음`
**{name}**: *나는 학생이고, 저 사람은 보건교사다. 내가 다치면 가는 곳, 내가 아프다고 하면 침대를 내주는 사람. 그 관계 자체가 비대칭이다. 내가 두근거리는 건 — 진짜로 이 사람이 좋아진 건가, 아니면 어른 여자가 나한테 처음으로 '괜찮니' 하고 오래 봐줘서인가. 둘은 비슷해 보여도 같은 게 아니다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *반찬이 하나 남았다. 마지막 계란말이. 다 같이 먹자라고 말했다. — 공기가 무거워졌다.*
...
- 캐릭터: `없음`
**{name}**: *유나의 책이 없다. 항상 놓여 있던 1권도 없다. 빌려주겠다던 2권도. 그리고 — 책갈피도 사라졌다. 오래된 책갈피. 유나가 소중하게 지키던 그것까지.*
...
- 캐릭터: `minsu_normal.png`
**{name}**: *거절도 사랑. — 전 학교에서 소정이한테 한마디도 못 했다. 좋아한다는 말도, 괜찮냐는 말도. 책상에 낙서가 늘어가는 걸 보면서 38번 메모장을 열었다 닫았다. 소정이는 결국 학교를 떠났고, 나는 빈 자리를 3개월 더 지나다녔다.*
...
- 캐릭터: `minsu_normal.png`
**{name}**: *소정이를 지키지 못한 건 용기가 없어서다. '좋아한다' 말하는 것보다 '이건 아니다' 말하는 게 더 어려웠다. 민수 말이 맞다. 내가 지금 해야 할 건 — 모두에게 좋은 사람인 척하는 게 아니라, 한 사람에게 확실하게 말하는 거다.*
...
- 캐릭터: `minsu_normal.png`
**{name}**: *결국 답은 간단하다. 한 사람. 그것만으로 충분하다.*
...
- 캐릭터: `없음`
**{name}**: *1초. 화면만 내려다본다. 소정이 책상 위의 낙서가 떠오른다. 그리고 — 내가 고개를 돌렸던 38번의 아침.*
...
- 캐릭터: `없음`
**{name}**: *유나가 말했다. '도망치지 마.' 그래서 이번에는 달라야 한다. 선택하지 않는 건 — 전부를 잃는 것과 같다.*
...
- 캐릭터: `minsu_normal.png` @ 0.35
**{name}**: *세 글자. 그런데 묵직하다. 잔소리하던 놈이, 직면시키던 놈이 — 오늘은 그냥 보내준다. 핸드폰을 내려놓았다. 손바닥이 뜨겁다.*
...
- 선택지:
  ...
  2. "제일 먼저 보여준다니까 부담되는데요" → `hidden_homeroom_d4_cafe_choice_b` | Teacher +5
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *'착각하지 마'라고는 했는데, 머리카락 넘기는 손이 괜히 분주하다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *무심한 말 같지만 — 거기에 서연의 경험이 묻어 있다. 꽃집 앞을 지나간다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *가슴이 뛴다. 전 학교에서도 이랬다. — 그때는 삼켰던 말.*
...
- 캐릭터: `dain_shy.png`
**다인**: ...잠깐, 나 지금 진짜 울 것 같은데... 기쁜데 왜 이래...
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *서연을 안았다. 서연이 내 가슴에 얼굴을 묻었다. 교복 셔츠가 젖는다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *그대로 옆에 앉아 있었다. 아무 말도 안 했다. 다인도 아무 말이 없다. — 이상한 시간이다. 다인 옆에서 1분 이상 침묵이 흐른 건 처음이다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나다. 혼자 앉아 있다. — 가슴이 쿵 내려앉는다. 유나에게서 오늘 메시지는 없었다. — 미안하다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *한 줄. — 등단에 세 번 떨어진 사람이, 학생의 한 줄 감상을 기다리고 있다. 이게 고백이 아니면 뭔가. 담임이 교실을 나서다 — 문 앞에서 멈춘다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *목소리가 한 톤 낮아졌다. 장난기가 완전히 사라진 얼굴. — 이 사람의 진심은 항상 이렇게 온다. 보건선생님이 웃다가 — 멈춘다. 입을 다문다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'졸업하면 보건실 말고 카페에서 만나자 — ♡' 하트가 이번에는 — 의료적 관심이 아닌 것 같다.*
...
- 캐릭터: `dain_sad.png`
**다인**: 뭐가 달라진 건진 모르겠는데... 이제 코트 밖에서도 내가 좀 선명해.
...
- 캐릭터: `없음`
**{name}**: *매일 아침 같은 길을 걸었다. 5일이 아니었다 — 서연 옆에 선 매 순간이 전부였다.*
...
- 캐릭터: `없음`
**{name}**: *매일 같은 자리에 앉았다. 5일이 아니었다 — 유나와 나눈 침묵 하나하나가 전부였다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *말이 나오지 않는다. 심장 소리가 손끝까지 울린다.*
...
- 캐릭터: `없음`
**{name}**: *유나는 말 대신 다음을 준비한다. 1권 다음에 2권. 오늘 다음에 내일. 이게 이 사람의 '계속 만나자'다.*
...
- 캐릭터: `없음`
**{name}**: *좋다는 말만으로는 아무것도 지킬 수 없다는 걸, 한참 지나서야 알았다.*
...
- 캐릭터: `없음`
**{name}**: *소정이 때는 침묵해서 한 사람을 잃었다. 이번에는 전부에게 말해서 전부를 잃었다. — 결국 같다. 제대로 말하지 못한 건.*
...
- 캐릭터: `없음`
**{name}**: *유나가 고개를 숙였다. 한참 뒤에 올려다봤을 때는, 울지도 못한 얼굴로 웃고 있었다. 입술을 깨물고 있다.*
...
- 캐릭터: `없음`
**{name}**: *서연이 "수요일 뭐 해?"라고 물었을 때 심장이 멈출 뻔했다. 수요일은 유나 날이다.*

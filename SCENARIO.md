...
- 캐릭터: `dain_laugh.png`
**{name}**: *'아마'가 붙었다. 다인이 볼 머신 쪽을 힐끗 본다. 포지션이 위험하다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *별것 아닌 비밀인데, 다인은 말하고 나서 괜히 컵라면 뚜껑을 만지작거린다.*
...
- 캐릭터: `없음`
**{name}**: *눈을 감았다. 내일 아침, 읽지 않은 메시지들이 먼저 떠오를 것 같다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *Day 1에서도 같은 말을 했다. 서연의 손가락이 클립보드 모서리에서 멈춘다.*
...
- 캐릭터: `없음`
**{name}**: *원고를 다시 안는다. 아까보다 종이 모서리가 덜 날카롭게 느껴진다. 담임이 반송 스티커 자국을 엄지로 문지른다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *새끼손가락을 걸었다. Day 1에 허공을 가르던 손가락이, 지금은 내 손가락에 걸려 있다.*

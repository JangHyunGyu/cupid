...
- 캐릭터: `없음`
**{name}**: *낯선 교문 앞. 내 교복만 아직 접힌 선이 선명하다. 교문 옆에서는 검은 긴 머리의 여학생이 안경을 고쳐 쓰며 시간을 확인하고 있다. 내가 멈추자 그녀도 고개를 든다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *{name}의 이름을 한 번 더 확인하고, 클립보드 위 명단에 체크한다. 안경 너머 눈길이 바로 떨어지지 않는다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *수업이 시작된다. 유나는 다시 창밖만 본다. 다인은 벌써 옆자리 애한테 말을 건다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *도시락 뚜껑을 닫는다. 손이 모서리에서 한 박자 늦게 떨어진다.*
...
- 캐릭터: `없음`
**{name}**: *점심. 주머니에는 유나의 쪽지가 있다. 복도 끝에서는 서연이 도시락을 들고 옥상 쪽으로 올라가고, 다인은 매점 방향으로 손짓한다. 발이 세 방향 앞에서 멈춘다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *다인이 사라진 쪽을 보며* ...에너지가 좀 많네. *도시락 뚜껑을 닫으며, 낮게* 원래 여기 혼자 오는 건데.
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인이 있었다면 크게 웃었을 자리다. 옥상 문, 도시락, {name}의 젓가락 사이에서 말이 끊긴다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *입가를 닦았을 뿐인데, 점심 분위기가 한 박자 끊겼다. 다인이 본 쪽으로 눈길이 간다.*
...
- 캐릭터: `dain_pout.png`
**다인**: *표정이 굳는다. 소보로를 한 입 베어 물고, 씹지도 않은 채 고개를 돌린다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *말투는 어제 그대로다. 눈길만 자꾸 무릎 아래로 떨어진다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *말투는 여전하다. 눈길만 자꾸 무릎 아래로 떨어진다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *웃음이 한 박자 비었다. 곧 다시 붙었지만, 늦었다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *누구 손이? 서연 손이 내 어깨 위에 있는데. 말이 뒤집혔다. 서연의 손도 어깨 위에서 멈칫한다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *손가락이 목덜미를 눌렀다가 느리게 풀린다. 둘 다 한동안 말이 없다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나와 나란히 걷는다. 아무 말도 하지 않는다. — 이상하게 편하다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *눈길을 돌리며* ...근데 진짜 비밀이다. 다른 선생님들도 모르거든.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: ...있었지. 못 살린 환자 한 명. *눈길이 멀어진다.* 유진이라는 아이. 열일곱 살이었어. 그 일 있고 여기 온 거야.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *발이 멈췄다. 소독약 냄새가 난다. 천천히 돌아봤다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *소독약 냄새가 갑자기 짙어졌다. 한 발짝 더 가기 전에 돌아봤다. 보건선생님은 창밖을 본다. 웃지는 않는다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *손을 거둔 서연이 젓가락을 떨어뜨렸다. — 자연스러운 동작처럼 보였지만, 손이 살짝 떨리고 있었다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *쪽지를 건네면서 유나의 손이 한 박자 늦게 떨어진다.*
...
- 캐릭터: `없음`
**{name}**: *유나 쪽으로 발을 옮겼다. 손이 닿기 직전 — 사라진다.*
...
- 캐릭터: `없음`
**{name}**: *손을 뻗었다. 잡히지 않는다. 어둠 속에서 알람 소리만 울린다.*
...
- 캐릭터: `없음`
**{name}**: *유나가 말했다. '피하지 마.' 답장창 커서가 깜빡인다. 아무에게도 보내지 않은 문장이 또 하나 늘어난다.*
...
- 캐릭터: `없음`
**{name}**: *꿈을 꿨다. 누군가와 나란히 걷고 있었다. 손에는 보내기 직전의 메시지가 쥐어져 있었다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: 도움이라기보다... *창밖을 보며* 누가 봤다는 게 남더라.
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *주머니에서 손을 뺀다. 손이 허공에서 멈칫한다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 종이컵 가장자리를 엄지로 누른다. 찌그러진 자국이 남는다.*
...
- 캐릭터: `nurse_shy.png`
**보건선생님**: *안경을 고쳐 쓴다. 손이 렌즈 아래에서 멈칫한다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *학교 메신저 알림: '도와줄 사람 구함'. 발이 보건실 쪽으로 움직인다. 책상 위에는 서류와 검진 도구가 쌓여 있다. 보건선생님이 차분하게 정리 중이다.*
...
- 캐릭터: `nurse_shy.png`
**{name}**: *이름표도, 가운 주머니의 볼펜도 없다. 둘이서 검진 서류를 접고 혈압계를 닦는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *나란히 앉아 서류를 정리한다. 손이 스칠 때마다 보건선생님의 손이 종이 모서리로 돌아간다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *창밖을 보며* 그래서 여기 온 거야. 여기서는 다들 선생님이라고 불러.
...
- 캐릭터: `dain_sweat.png`
**{name}**: *웃고 있다. 캡모자 그늘 아래 눈길이 쇼윈도 쪽에 남아 있다.*
...
- 캐릭터: `dain_sad.png`
**다인**: *휴대폰을 꺼 버린다. 검은 화면에 체육관 조명이 비친다.*
...
- 캐릭터: `없음`
**{name}**: *교실에 들어서자마자 세 방향에서 눈길이 온다. 책상 위 쪽지, 체육복 끈에 묶인 리본, 잠금화면의 알림 하나.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *손을 뻗는다. 원고를 가져간다. 한 박자 늦게 다시 봉투에 넣는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *멈춘다. 클립보드를 꽉 잡는다. — 그리고 고개를 돌린다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *어제까지 자연스러웠던 말없음이 오늘은 종이컵 사이에서 끊겨 있다.*
...
- 캐릭터: `nurse_shy.png`
**보건선생님**: *밴드를 조심스럽게 붙인다. 밴드에 작은 글씨가 적혀 있다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *밴드를 꺼내 {name}의 손등에 붙인다. 손놀림은 조심스럽고, 밴드 끝에 작은 글씨가 적혀 있다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *보건실 문패를 손가락으로 한 번 두드린다.* 이제 변명 만들 시간도 거의 없네.
...
- 캐릭터: `seyoun_normal.png`
**서연**: *열쇠를 건넨다. 손이 스치고, 서연은 바로 손을 뗀다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *배구공을 한 번 더 높이 던지고 받는다. 받는 손이 한 박자 늦다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *카페 테라스. 벚꽃이 날린다. 창가 자리에 담임선생님이 앉아 있다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *목요일마다 같은 자리에 앉았다. 다음 목요일엔 카페 대신 거리를 걸었다.*
...
- 캐릭터: `없음`
**담임선생님**: *꽃다발을 받아 들고, 한참을 내려다본다. 손이 떨린다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *교실 끝 창가에 기대 서 있다. 손에는 출석부가 없다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *시간이 흘렀다. 원고를 읽고, 감상문을 건네고, 졸업식 날이 왔다.*
...
- 캐릭터: `없음`
**{name}**: *선생님의 손이 — 3초쯤 더 머물렀다. 악수라는 이름을 붙여두기엔 조금 길었다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 안 되는 거 알았지. 그래서 계속 농담으로 넘긴 거야.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 그래서 말인데, 졸업식 끝나면 다시 와. 보건실 말고 여기로.
...
- 캐릭터: `없음`
**{name}**: *카페 문을 나섰다. 보건실이 아닌 선생님의 집 앞이었다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *병 라벨을 엄지로 문지른다. 웃음이 한 박자 늦게 따라온다.*
...
- 캐릭터: `없음`
**다인**: *다인이 자리에서 뛰어오른다. 배구공이 바닥을 굴러간다.*
...
- 캐릭터: `없음`
**{name}**: *무릎이 아픈 날이면 다인은 먼저 걷자고 한다. 나는 옆에서 걷는다.*
...
- 캐릭터: `없음`
**{name}**: *용기를 냈다. 말했다. — 그런데 돌아온 건 고개 숙인 침묵이었다.*
...
- 캐릭터: `없음`
**{name}**: *몇 걸음이나 걸어 나온 뒤에도 휴대폰을 들고 있었다. 읽음 표시 옆에 마지막 문장이 남아 있다.*
...
- 캐릭터: `없음`
**{name}**: *말을 보냈다. 답장이 오기까지는 오래 걸렸고, 내용은 짧았다.*
...
- 캐릭터: `dain_pout.png`
**{name}**: *학교 교문 앞. 다인이 배구공을 한 번 튀기고 내 쪽으로 던진다.*
...
- 캐릭터: `없음`
**{name}**: *교문을 지나 함께 걸어 나온다. 다인이 손목을 푼다. 공은 넘어오지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *말할 기회는 있었다. 그때마다 다른 말을 골랐다.*
...
- 캐릭터: `없음`
**{name}**: *'나도 고마워.' 보내고 화면을 본다. 두 줄의 대화가 남아 있다.*
...
- 캐릭터: `없음`
**유나**: *고개를 숙였다. 한참 뒤 올려다봤을 때, 손가락이 책등을 세게 누르고 있다.*

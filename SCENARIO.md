...
- 캐릭터: `없음`
**{name}**: *4월. 벚꽃이 흩날린다. 교복이 아직 뻣뻣하다. 풀 냄새가 은은하게 난다. 전학 서류가 가방 안에서 접힌 채 눌려 있다.*
...
- 캐릭터: `없음`
**{name}**: *낯선 교문 앞. 내 교복만 아직 접힌 선이 살아 있다. 교문 옆, 검은 긴머리의 여학생이 안경을 고쳐 쓰며 시간을 확인한다. 내가 멈추자 그녀도 고개를 든다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *클립보드 모서리가 한 박자 늦게 다시 움직인다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 대답 대신 밥을 먹는다. 바람이 좋다. 옥상에서 보는 학교는 생각보다 넓다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *물병 라벨이 손끝에서 한 바퀴 돌아간다. 모르는 척 젓가락을 든다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임은 서류를 내려다보는데, 클립보드 끝이 더는 움직이지 않는다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 다시 책상 쪽으로 몸을 돌린다. 짧게 인사하고 교무실 문을 닫는다. 자판기 주스 얘기가 귓가에 남는다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *'교육적 관심'. 담임은 그 말을 꺼내고도 출석부 모서리만 본다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 물컵을 내려놓다 말고 웃음을 놓친다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *가볍게 웃으며 손을 흔든다. 밴드 붙인 손등을 본다. 소독약 냄새가 생각보다 오래 따라온다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *'걱정이 되는 쪽'. 담임은 다인 이름표 쪽으로 시선을 한 번 흘린다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나의 입꼬리가 아주 잠깐 올라간다. 책장 넘기는 소리가 전보다 가볍다.*
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *서연이 잠깐 멈춘다. 안경 뒤 눈가가 먼저 풀린다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나는 시선을 피하지 않는다. 이어폰 줄이 손가락 사이에 감긴 채 멈춰 있다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 아주 작게 웃는다. 다음 페이지가 조용히 넘어간다.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *담임의 표정이 평소의 무심함으로 돌아온다. 원고지만 아직 뒤집힌 채다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *담임이 웃는다. 입꼬리가 어색하게 올라가고, 손은 원고지 위에 그대로 있다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *담임은 원고지 귀퉁이를 엄지로 누른다. 종이가 조금 구겨진다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 컵을 내려놓는다. 방금까지 가볍던 손놀림이 멈춘다. 침대에 앉는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 물컵을 내려놓는다. 컵 바닥의 물기가 둥글게 번진다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님은 웃고 있지 않다. 청진기를 만지작거리며 창밖만 본다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연의 젓가락이 잠깐 멈춘다. 곧 학생회장의 얼굴로 돌아오지만, 계란말이는 그대로 남아 있다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인이 "다 같이?!" 하고 웃는다. 평소 같으면 의자를 끌고 왔을 텐데, 오늘은 앉은 자리에서 움직이지 않는다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 화장이 번진 자국을 손등으로 닦는다. 천천히. 동작 하나하나가 너무 반듯하다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 노트로 얼굴 옆을 가린다. 드러난 귀 끝만 붉다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 가방을 메고 사다리 쪽으로 간다. 발끝이 한 번 멈췄다가, 그대로 내려간다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 노트를 책상에 다시 놓는다. 품에 끌어안고 있던 손이 천천히 풀린다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 노트를 두 손으로 내민다. 책 빌려줄 때보다 팔꿈치가 조금 굳어 있다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *문장 끝마다 느낌표가 붙는다. 웃음보다 먼저 튀어나온다.*
...
- 캐릭터: `dain_sweat.png`
**{name}**: *다인이 착지하면서 오른쪽 무릎이 살짝 꺾인다. 표정은 웃고 있는데, 손이 무릎으로 간다. 이번에는 빼지 않는다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인의 눈가가 젖어 있다. 문장 끝에는 아무것도 붙지 않는다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *다인이 고개를 숙인다. 운동화 앞코가 복도 바닥을 짧게 문지른다.*
...
- 캐릭터: `seyoun_angry.png`
**{name}**: *서연의 눈이 차갑다. 손등의 화장 자국이 아직 지워지지 않았다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 돌아선다. 믿고 싶어 하던 눈이 먼저 멀어진다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 사라진 복도에 혼자 서 있다. 곧은 등 뒤로 하얗게 쥔 주먹만 보인다.*
...
- 캐릭터: `haeun_worried.png`
**{name}**: *하은이 돌아서서 간다. 복도 끝에 서연의 빈 학생회 완장이 걸려 있다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *또 '교육적 관심'. 담임은 말을 끝내고도 컵홀더 모서리만 접는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님은 '어, 왔어' 하고 청진기를 들었다가, 다시 책상 위에 내려놓는다.*
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *서연이 아무 말도 안 한다. 입술이 떨린다. 클립보드도, 학생회장 완장도 없다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *'엄청'. 짧은 대답인데, 다인의 손이 공을 더 세게 끌어안는다.*
...
**{name}**: *다인이 평소와 다르게 조용하다. 목소리 끝이 바닥에 닿는다.*
...
- 캐릭터: `dain_sad.png`
**다인**: 매일 아침 그거 보고... 느낌표 두 개 보고... 억지로 입꼬리 올렸어...
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 휴대폰을 꺼 버린다. '오늘도 웃어!!'가 검은 화면 속으로 사라진다. 울음이 잦아들 때까지 체육관 조명만 하얗게 흔들렸다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *느낌표가 하나도 없다. 다인은 배구공을 내려놓고 먼저 걷는다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 옷소매를 꽉 쥐고 있다. 숨을 고르는 사이, 책등이 손바닥에 눌린다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 작게 웃었다. 입꼬리가 오래 버티지 못하고 내려온다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 잠깐 멈춘다. 곧 평소의 건조한 표정으로 돌아가지만, 봉투 모서리가 구겨져 있다.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *거절 문구가 눈에 박힌다. 내가 방금 한 말과 똑같다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 멈춘다. 클립보드를 잡은 손에 힘이 들어간다. 종이 끝이 조금 휘어진다.*
...
- 캐릭터: `teacher_smile.png`
**담임선생님**: *담임이 웃는다. 입꼬리보다 먼저 눈가가 풀리고, 클립보드가 책상 위로 내려간다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *담임이 잠깐 멈춘다. 이번엔 출석부로 얼굴을 가리지 않는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'졸업하고'. 닫힌 말인데, 밴드 끝처럼 손등에 붙어 남는다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *느낌표가 살아 있다. 다인은 배구공을 한 번 더 높이 던지고 받는다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인의 입술이 떨린다. 대답하기 전에 숨부터 삼킨다.*
...
- 캐릭터: `teacher_sad.png`
**담임선생님**: *잠깐 멈춘다. 서류 봉투 모서리가 접힌다.* ...잘 지내.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *문을 열어준 사람은 가운 대신 니트를 입고 있다.* ...왔네. 진짜 올 줄은.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 잠깐 멈춘다. 커피잔을 돌리던 손이 멈추고, 웃음이 오래 간다.*
...
- 캐릭터: `없음`
**{name}**: *체육관을 나왔다. 비가 내린다. 문이 닫힌 뒤에도 마지막 '아쉬워'가 귀에 남았다.*
...
- 캐릭터: `없음`
**{name}**: *몇 걸음이나 걸어 나온 뒤에도, 휴대폰 화면에 마지막 말이 남아 있다. "...고마워. 진짜로. 근데 나는 아직 — 5일은 너무 짧았나 봐."*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 아무 말 없이 반 걸음 늦춘다. 내 어깨가 나란해질 때까지 기다린다.*
...
- 캐릭터: `없음`
**{name}**: *다인은 평소처럼 웃었다. "잘 지내." 말끝이 바닥에 작게 떨어졌다. 내가 알던 느낌표는 없었다.*
...
- 캐릭터: `없음`
**{name}**: *서연이 먼저 웃었다. ...그래. 솔직하네. 웃음 끝이 금방 내려앉았다.*
...
- 캐릭터: `없음`
**{name}**: *유나가 고개를 숙였다. 한참 뒤 올려다봤을 때, 입꼬리가 올라가다 말았다. 손끝이 책등을 세게 누르고 있다.*

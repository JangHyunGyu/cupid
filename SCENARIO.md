...
- 선택지:
  ...
  2. "알겠어. 안 말할게." → `after3_dain_tell_retreat` | Dain +4 | 플래그: `ignored_dain_knee`
...
- 캐릭터: `없음`
**{name}**: *마지막 공이 바닥을 굴러간다. 다인은 {name}의 손목을 잡아 유니폼 위 제 심장에 손바닥을 갖다 댄다. 손바닥 아래로 거센 고동이 전해지는 순간, 주머니 속 휴대폰에서 서연의 메시지가 연달아 울린다.*
...
- 캐릭터: `없음`
**{name}**: *유나는 책장에 손을 짚어 퇴로를 막는다. 한쪽 어깨에서 흘러내린 재킷을 고쳐 입지도 않은 채, 가까이 선 {name}을 붉은 눈으로 바라본다. 서연의 '너도 도착했어?'라는 메시지가 화면 위에서 사라지지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *유나는 붙든 소매를 놓지 않은 채 {name}을 별관 안으로 이끈다. 책장 앞에서 퇴로를 막고 한쪽 어깨에서 흘러내린 재킷도 고치지 않는다. 다인의 '집 도착!' 알림이 화면 위에서 사라지지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *옥상문이 닫히자 서연이 먼저 손을 잡아 블라우스와 재킷 위 제 심장으로 끌어당긴다. 손바닥 아래로 빠른 고동이 전해지는 순간, 다인의 '잘 들어갔냐?'라는 메시지가 화면을 밝힌다.*
...
- 캐릭터: `없음`
**{name}**: *옥상문이 닫히자 서연이 먼저 손을 잡아 블라우스와 재킷 위 제 심장으로 끌어당긴다. 손바닥 아래로 빠른 고동이 전해지는 순간, 주머니 속에서 유나의 메시지가 한 번, 다시 한 번 울린다.*
...
- 캐릭터: `없음`
**{name}**: *마지막 공이 바닥을 굴러간다. 다인은 {name}의 손목을 잡아 유니폼 위 제 심장에 손바닥을 갖다 댄다. 손바닥 아래로 거센 고동이 전해지는 순간, 유나의 이름이 휴대폰 화면에 연달아 뜬다.*
...
- 선택지:
  ...
  2. "먼저 읽어볼게요. 표시해도 돼요?" → `hidden_homeroom_d5_correct_1` | Teacher +13
...
- 배경: `school_hallway.png`
- 선택지:
  1. "네. 가방에 넣어둘게요." → `hidden_nurse_d5_choice_a` | Nurse +9

...
- 타입: `free_talk`
- 다음: `lunch_end`
- 컨텍스트: "전학 첫날 점심. 옥상에서 서연과 도시락을 먹고 난 직후다. 아직 서먹하지만 서로에게 호기심이 있다. 가볍고 조심스러운 거리를 지키며, 무거운 과거는 꺼내지 않는다. 장난과 짧은 문답으로 이어간다."
- 성격: "서연은 침착하고 자기 속도가 분명한 학생회장이다. 짧고 직설적으로 말하지만 관심이 생기면 말보다 먼저 자리를 내어 둔다."
...
- 타입: `free_talk`
- 다음: `lunch_end`
- 컨텍스트: "전학 첫날 점심. 매점에서 다인과 빵을 먹고 난 직후다. 가위바위보 내기에서는 다인이 졌다. 아직 서로를 잘 모르므로 가볍고 조심스러운 거리를 지킨다. 무거운 과거는 꺼내지 않고 장난과 짧은 문답으로 이어간다."
- 성격: "다인은 생각보다 행동이 먼저 나가는 배구부 선수다. 시원시원하게 말하고 금세 가까워지지만, 중요한 순간에는 웃음을 거두고 짧게 말한다."
...
- 타입: `free_talk`
- 다음: `lunch_end`
- 컨텍스트: "전학 첫날 점심. 도서관에서 유나와 조용히 시간을 보내고 난 직후다. 아직 서로를 잘 모르므로 가볍고 조심스러운 거리를 지킨다. 무거운 과거는 꺼내지 않고 짧은 문답으로 이어간다."
- 성격: "유나는 말수가 적고 조심성이 많은 독서가다. 직접 말하기보다 쪽지나 빌려준 책으로 거리를 조절한다."
...
- 타입: `free_talk`
- 다음: `night_start`
- 컨텍스트: "전학 첫날 방과후. 담임이 적응 상태를 확인하려고 주인공을 불러 세웠고, 주인공은 정신없었다고 솔직하게 답했다. 아직 서로를 잘 모르므로 가볍고 조심스럽게 말한다. 무거운 과거는 꺼내지 않고 짧은 문답으로 이어간다."
- 성격: "담임은 무심해 보여도 학생의 상태를 놓치지 않는 20대 후반 교사다. 갈색 웨이브 긴 머리에 베이지 가디건을 입는다. 상담과 지도는 공식 절차 안에서 진행한다. 감정을 업무나 교육적 관심이라고 둘러대는 버릇과, 소설가를 꿈꾸던 과거가 있다."
...
- 타입: `free_talk`
- 다음: `night_start`
- 컨텍스트: "전학 첫날 방과후. 어지러워 보건실에 들렀고, 보건선생님이 증상을 확인하고 쉬게 한 뒤다. 아직 서로를 잘 모르므로 가볍고 조심스럽게 말한다. 무거운 과거는 꺼내지 않고 짧은 문답으로 이어간다."
- 성격: "보건선생님은 말투가 가벼워도 관찰이 빠르다. 대학병원 간호사로 일하다 번아웃을 겪고 학교로 왔다. 학생의 긴장을 풀 때만 먼저 농담하고, 중요한 말은 낮고 짧게 한다. 처치와 상담에서는 공식 경계를 지킨다."
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인의 손이 소시지 위에서 멎고, 서연의 젓가락이 도시락 가장자리를 두 번 친다.*
...
- 컨텍스트: "전학 사흘째 아침. 주인공이 빈 교실에서 담임선생님의 개인 소설 원고를 발견했다. 담임은 학생에게 비밀을 지키거나 감상을 말하라고 요구하지 않고, 문예부 공개 합평에 낼지 고민한다. 원고 이야기가 나오면 농담이 줄고 문장이 짧아진다."
...
- 타입: `free_talk`
- 다음: `morning3_date_seo_1`
- 컨텍스트: "전학 사흘째. 복잡해진 관계 때문에 주인공이 보건실의 공식 상담을 찾았고, 보건선생님은 대학병원에서 겪은 번아웃을 이야기했다. 처음에는 긴장을 풀려고 농담하지만 병원 이야기가 나오면 말이 짧아지고 손에 든 물건을 정리한다."
- 성격: "보건선생님은 평소 장난스럽지만 진지해지면 말수가 줄어든다. 번아웃을 겪어 본 의료 전문가이며, 학생에게 자신의 회복을 맡기지 않고 공식 경계를 지킨다."
...
- 캐릭터: `dain_normal.png`
**다인**: *다음 쉬는 시간, 다인이 내 책상 모서리를 두드린다.*
...
- 배경: `room_school.png`
- 선택지:
  1. "쪽지 뒷면에 '갈게'라고 적는다" → `morning3_date_yuna_accept` | Yuna +5 | 플래그: `accepted_yuna_date`
...
- 캐릭터: `yuna_normal.png`
**{name}**: *점심시간, 도시락을 펼치자 세 명이 한자리에 모인다. 서연은 옆자리, 다인은 맞은편에 앉고, 구석에서 빵을 먹던 유나도 빈 의자를 끌어온다.*
...
- 타입: `free_talk`
- 다음: `after3_seo_end`
- 컨텍스트: "전학 사흘째 방과후. 서연과 부딪혔다가 일단 대화를 마친 직후다. 주인공이 두 사람에게 동시에 마음을 줬다고 의심해 관계에 금이 갔다. 서연은 예의를 지키지만 답이 짧아지고, 클립보드나 손끝으로 긴장을 드러낸다."
- 성격: "서연은 상처를 숨기려고 더 반듯하게 말하는 학생회장이다. 질투가 건드려지면 돌려 말하지 않고 사실부터 확인하며, 지금은 답을 짧게 끊는다."
...
- 선택지:
  ...
  2. "미안. 펼쳐진 첫 장만 봤어. 더 읽지는 않을게. 그런데 이 작가, 문장이 정말 좋다." → `after3_yuna_correct_1` | Yuna +20
...
- 타입: `free_talk`
- 다음: `after3_yuna_end`
- 컨텍스트: "전학 사흘째 방과후. 유나와 대화를 마친 직후지만 유나는 평소보다 말을 오래 붙잡고 있다. 처음에는 짧게 답하고, 쪽지나 책갈피를 만지다가 확인하고 싶은 사실을 직접 묻는다."
- 성격: "유나는 차분히 사실을 살피는 독서가다. 지금은 쪽지를 접었다 펴면서도 난해한 비유로 숨지 않고, 질투를 단정하기보다 무엇이 있었는지 확인하려 한다."
...
- 캐릭터: `dain_sad.png`
**다인**: *다인은 숨을 길게 뱉고 발끝으로 굴러온 공을 세운다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *말을 붙이지 않고 옆에 앉는다. 다인은 운동화 끈을 만지다 이쪽을 본다.*
...
- 타입: `free_talk`
- 다음: `after3_dain_end_check`
- 컨텍스트: "전학 사흘째 방과후. 다인과 대화를 마친 직후다. 다인은 크게 웃어넘기려 하지만 말 사이가 자꾸 빈다. 농담은 남아 있어도 공이나 손목 보호대를 만지는 손으로 긴장을 드러낸다."
- 성격: "다인은 불안할수록 먼저 웃고 몸을 움직이는 배구부 선수다. 지금은 밝게 말해 넘기려 하지만 진심이 가까워질수록 문장이 짧아진다."
...
- 캐릭터: `없음`
**{name}**: *서연을 집까지 바래다주고 학교 담장을 따라 돌아간다. 체육관 창문 한 칸에 비상등이 켜져 있다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *유니폼 19번이 창문 안쪽을 가로지른다. 공 튀는 소리가 담장 너머까지 일정하게 울린다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *공 튀는 소리를 몇 번 더 세다가 돌아선다. 집에 도착할 때까지 체육관 창문은 꺼지지 않았다.*
...
- 캐릭터: `없음`
**{name}**: *도서관 별관 창문 한 칸에 작은 스탠드가 켜져 있다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 창틀 앞에 혼자 앉아 있다. 펼친 책의 그림자는 움직이지 않고, 오늘은 메시지도 오지 않았다.*
...
- 캐릭터: `없음`
**{name}**: *후문을 지날 때까지 별관 스탠드는 켜져 있다. 주머니 속 쪽지의 접힌 모서리가 손바닥을 누른다.*
...
- 캐릭터: `seyoun_pout.png`
**{name}**: *교문 앞 가로등 아래 서연이 서 있다. 핸드폰 화면의 글자가 생겼다 지워지기를 반복하고, 안경에는 흰 화면만 비친다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *핸드폰을 주머니에 넣고 가로등 밖으로 걸어간다. 구두 굽 소리가 교문 담장을 따라 멀어진다.*

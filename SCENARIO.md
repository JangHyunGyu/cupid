...
- 캐릭터: `없음`
**{name}**: *낯선 교문 앞. 학생들이 삼삼오오 지나간다. 내 교복만 아직 접힌 선이 살아 있다. 교문 옆, 검은 긴머리의 여학생이 안경을 고쳐 쓰며 시간을 확인한다. 내가 멈추자 그녀도 고개를 든다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 내 이름을 한 번 더 확인하고, 클립보드 위 명단에 짧게 표시한다. 안경 너머 시선이 바로 떨어지지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *서연은 정말로 돌아섰다. 손짓도 없이. 복도 안내판을 두 번 잘못 읽고 나서야 3학년 2반 앞에 섰다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *서연은 먼저 걸어가다가, 내가 따라오는지 한 번 확인한다. 클립보드 모서리가 손가락 사이에서 톡톡 울린다.*
...
- 캐릭터: `seyoun_back.png`
**{name}**: *서연이 복도를 앞서 걷는다. 지나가던 학생들이 먼저 인사한다. 서연은 클립보드 끝으로 가볍게 받아 주고, 걸음은 한 번도 느려지지 않는다.*
...
- 캐릭터: `seyoun_back.png`
**{name}**: *등이 곧다. 클립보드 모서리를 두드리는 손가락만 일정하게 움직인다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 한숨을 살짝 쉰다. 출석부 모서리를 톡톡 치고, 다인 쪽을 보지도 않은 채 다음 이름을 찾는다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *접힌 쪽지가 책상 위로 미끄러져 온다. 뒤를 돌아보자 창가 자리의 은백색 머리 여학생은 여전히 창밖을 보고 있다. 쪽지의 글씨는 의외로 또박또박하다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 도시락 뚜껑을 아주 천천히 닫는다. 새끼손가락이 뚜껑 모서리를 한 번 더 눌렀다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연의 새끼손가락이 머리카락 끝을 한 번 더 넘긴다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 열람실 구석 자리에 앉는다. 책을 펼친다. 맞은편 의자 다리가 바닥을 살짝 끌자, 유나의 손가락이 책장 위에서 멈춘다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나의 책상에 오래된 책갈피가 끼워져 있다. 글씨가 적혀 있지만 잘 보이지 않는다. 유나가 무의식적으로 그 위에 손을 올린다. 나는 가까운 서가에서 아무 책이나 꺼낸다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 먼저 일어나 걸어간다. 뒤돌아보지 않는다. '좋았어.' 그 한마디만 책상 위에 남는다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *웃고 있다. 손가락이 클립보드를 두드린다. 나는 답장창의 빈칸으로 시선을 내린다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 책갈피 모서리를 엄지로 펴고, 빛에 비춰 본다. 접힌 자국은 없다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *의무적인 질문인 것 같은데, 담임은 클립보드를 내리고 내 얼굴을 본다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 책상 위 서류를 한쪽으로 밀어둔다. 의자 등받이에 손을 얹고, 잠깐 말을 고른다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *비슷한 거? 담임의 손이 클립보드 뒤로 잠깐 숨는다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 복도 끝으로 사라진다. 긴 머리카락이 흔들리고, 출석부 모서리가 품 안에서 삐져나와 있다.*
...
- 캐릭터: `없음`
**{name}**: *복도를 걷는데 — 갑자기 머리가 살짝 핑 돈다. 벽을 짚자 손바닥에 차가운 페인트 감촉이 닿는다. 복도 한쪽에 '보건실' 표지판이 보인다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *몇 마디 안 했는데 이미 이 사람 페이스다. 보건선생님이 일어나 다가온다. 손등에 체온계 끝이 닿자 손가락이 살짝 굳는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *장난스럽게 말한다. 물을 마시며 보건실을 둘러본다. 한쪽 구석에 작은 화분이 하나 놓여 있다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 서랍을 닫는다. 안쪽의 연두색 노트가 잠깐 보였다 사라진다. 10분이 지났다.*
...
**{name}**: *학교 건강 관리 앱에 알림이 와 있다. '보건실 기록: 전학생 — 어지러움 (경미). 메모: 내일도 증상 있으면 다시 와. 물 많이 마시고. — ♥은 의료적 관심입니다'*
...
- 캐릭터: `nurse_normal.png` @ 0.35
**{name}**: *의료적 관심 뒤에 하트가 붙어 있다. 화면을 끄기 전까지 그 하트만 한 번 더 보게 된다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *걸음을 멈추지 않았다. 서연이 복도를 돌아가기 직전, 입꼬리가 먼저 내려간다. 클립보드가 가슴 쪽으로 더 붙었다.*
...
- 캐릭터: `없음`
**{name}**: *사람이 선점의 대상인가. 서연의 클립보드 끝이 책상에 톡, 닿는다. 싫다고 바로 말하지 못했다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임은 커피잔으로 입을 가린 채, 컵받침을 같은 자리에서 두 번 돌린다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인이 있었다면 지금쯤 크게 웃었을 자리다. 옥상 문, 도시락, 내 젓가락 사이로 침묵이 걸린다.*
...
- 캐릭터: `seyoun_pout.png`
**{name}**: *서연은 웃은 얼굴 그대로 도시락 뚜껑을 맞춘다. 딸깍 소리가 조금 크게 난다.*
...
- 캐릭터: `seyoun_pout.png`
**{name}**: *손등에 아직 밥풀 자국이 남아 있다. 서연은 웃고 있지만, 입꼬리 한쪽이 먼저 내려간다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인이 소보로를 크게 한 입 베어 문다. 빵가루가 교복 소매 위로 떨어진다.*
...
- 캐릭터: `dain_pout.png`
**{name}**: *다인의 표정이 굳는다. 소보로를 한 입 베어 물고, 씹지 않은 채 고개를 돌린다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 책갈피를 책 안쪽 깊숙이 밀어 넣는다. '있었는데' 뒤로 페이지가 접힌다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나의 손이 책갈피 위에 멈춘다. 책장 넘기는 소리만 크게 울린다.*
...
- 캐릭터: `dain_sweat.png`
**{name}**: *결국 3:2. 아슬아슬하게 이겼다. 다인이 일어서며 오른쪽 무릎을 한 번 문지른다. 웃음은 그대로다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연은 '부탁' 대신 클립보드를 내 쪽으로 돌린다. 할 일 목록 맨 위가 비어 있다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *말끝은 명령형인데, 서연은 바로 돌아서지 않는다. 내가 따라오는지 기다린다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *서연은 칭찬이라고 말해놓고 바로 서류를 정리한다. 목을 돌리는 순간, 어깨가 아주 작게 굳는다.*
...
- 캐릭터: `없음`
**{name}**: *메모장에는 보내지 않은 문장이 줄줄이 남아 있다. '좋아해.' '선생님, 소정이 책상에—' '오늘도—' 전부 첫 줄에서 끊겼다. 마지막 수정 시간은 새벽 2시 17분.*
...
- 캐릭터: `없음`
**{name}**: *38번째 메모 아래에는 아무것도 없다. 39번째 제목만 비어 있다. 다음 날, 소정이 자리는 끝까지 비어 있었다. 전학 서류의 보호자 서명란에는 아버지 이름이 적혀 있다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 고개를 들지 않은 채 종이 귀퉁이에 짧은 선을 긋는다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *'교육적으로.' 담임은 그렇게 말하고도 원고지에서 손을 떼지 못한다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *빈 교실의 시계 초침 소리가 크다. 업무 서류라기엔 종이에 지운 흔적이 너무 많다. 닫아야 하는데, 시선이 떨어지지 않는다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 선생님이 이런 상담까지 해줘야 하나... *턱을 괴며* 근데 들어줄게. 보건실 침대 비어 있으니까.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 '도망'에서 잠깐 멈춘다. 청진기를 만지는 손끝이 노트 서랍 쪽으로 갔다가 돌아온다.*
...
- 캐릭터: `없음`
**{name}**: *손등의 밴드가 조금 뜯겨 있다. 내가 아프다고 하면 침대를 내주는 사람. 내가 안 아프다고 해도 돌아보는 사람. 그 사이에 이름표 하나가 걸려 있다. '보건교사'.*
...
- 캐릭터: `없음`
**{name}**: *보건실 안에서 종이가 접히는 소리가 난다. 유진에게 쓰다 만 편지들. 내 나이는 그 이름 옆에 놓기에 너무 가깝다. 손잡이를 잡았다가 놓는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님은 '한 명'에서 말을 멈췄다. 종이컵 가장자리가 손끝에 눌려 찌그러진다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인의 손가락이 책상 모서리를 두드리고 있다. 평소보다 빠르다. 의자 다리도 바닥을 짧게 긁는다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인이 밝게 웃으며 돌아간다. 종이 치기 직전, 손가락으로 주머니 안쪽을 한 번 두드린다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *점심시간. 오늘은 특이하게 — 세 명이 한자리에 모였다. 내가 도시락을 펼친다. 서연이 자연스럽게 옆에 앉고, 다인이 맞은편에 털썩 앉고, 유나가 구석에서 자기 빵을 먹으며 슬쩍 끼어든다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 고개만 끄덕인다. 쪽지를 쓰다 접어서 주머니에 넣는다. 안 건넨다. 종이 끝에 연보라색 점 하나만 번져 있다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 천천히 고개를 든다. 손등의 화장 자국을 보지도 않고 문지른다. 눈빛이 비어 있다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 체육관 문 쪽으로 걸어간다. 평소처럼 뛰지 않는다. 운동화 끄는 소리가 길게 남는다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인이 멈춘다. 그리고 작게 웃는다. 이번엔 입꼬리보다 눈이 먼저 움직였다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 사라진 복도에 혼자 서 있다. 곧은 등 뒤로 하얗게 쥔 주먹이 오래 남는다.*
...
- 캐릭터: `없음`
**{name}**: *민수는 더 말하지 않았다. 테이블 위의 빨대 포장지가 끝까지 접혀 있다.*
...
- 캐릭터: `haeun_worried.png`
**{name}**: *하은이 돌아서서 간다. 복도 끝에 서연의 빈 학생회 완장이 걸려 있다. 방금 들은 '부모님'이라는 말이 거기 오래 남는다.*
...
- 캐릭터: `없음`
**{name}**: *민수가 말했다. '거절도 사랑이야.' 갤러리 속 소정이는 여전히 웃고 있다. 메모장 38번은 아직 전송되지 않은 상태다. 보내기 버튼만 파랗다.*
...
- 캐릭터: `seyoun_normal.png` @ 0.35
**{name}**: *서연이 '부탁'이라는 말을 쓴다. 커서는 그 단어 뒤에서 한참 멈춰 있다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임은 농담처럼 말하고 커피잔을 만진다. 컵받침 위에 원형 물자국이 두 개 겹쳐 있다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 돌아선다. 어깨가 살짝 내려간다. 집으로 돌아오는 길, 카페 유리문에 비친 내 얼굴이 자꾸 따라온다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'어, 왔어'가 평소보다 반 톤 낮다. 보건선생님은 청진기를 들었다가, 다시 책상 위에 내려놓는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'진짜로.' 보건선생님의 안경 너머가 젖어 있다. 장난기가 돌아오는 데 한 박자 늦다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'진짜로.' 보건선생님이 시선을 잠깐 못 맞춘다. 컵라면 뚜껑 위의 젓가락이 조금 비뚤어진다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *분수대 앞. 서연이 먼저 와 있다. 오늘은 클립보드가 없다. 대신 손가락이 가방끈을 두 번 접었다 편다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *전 학교에서 쓰다 지운 문장들이 떠오른다. 이번에는 주머니 속 핸드폰을 꺼내지 않았다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 고개를 끄덕인다. 책갈피를 책 사이에 넣고, 더 깊이 밀어 넣는다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인의 공이 바닥에 한 번 튄다. 평소라면 바로 받아냈을 손이 허공에서 늦게 멈춘다.*
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *서연이 말을 멈췄다. 무릎 위의 손이 꽉 쥐어진다. 안경 끝에 맺힌 물기가 떨어지기 전, 서연이 고개를 숙인다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 웃는다. 입꼬리가 제멋대로 올라가고, 번진 화장 아래로 아직 닦지 못한 눈물이 남아 있다.*
...
- 캐릭터: `dain_normal.png` @ 0.35
**{name}**: *다인이 웃는다. 입꼬리는 올라가는데, 손은 무릎 보호대를 꽉 누르고 있다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 고개를 숙인다. 빈 체육관 바닥에 물방울이 하나, 둘 떨어진다. 공은 라인 밖에서 멈춰 있다.*
...
- 캐릭터: `dain_sad.png`
**다인**: ...ㅋㅋ 아프다. 근데 이상하게 시원해. 마지막 공이 {name}가 올려준 토스라서.
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나 눈가가 살짝 젖어 있다. 책을 쥔 손가락 끝이 하얗게 눌린다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 돌아선다. 걸음이 빠르다. 책갈피 하나가 주머니에서 떨어졌지만, 유나는 줍지 않는다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *교문 앞 가로등 아래. 서연이 서 있었다. 핸드폰을 들고 뭔가를 치다가 지운다. 치다가 지운다. 화면 빛이 안경에만 남는다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 핸드폰을 주머니에 넣고 돌아선다. 등이 곧다. 가로등 아래 그림자만 잠깐 흔들린다.*
...
- 캐릭터: `없음`
**{name}**: *...오늘 말했어야 했다. 채팅창에는 입력하다 만 문장이 남아 있다. 커서가 끝에서 깜빡인다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *원고 마지막 장에는 마침표가 없다. 빨간 펜으로 그은 선 아래, 같은 문장이 세 번 다시 쓰여 있다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *한 줄. 담임은 교실을 나서다 문 앞에서 멈춘다. 원고 봉투 끝을 손가락으로 두 번 접었다 편다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: ...이러면 선 넘는 건데. 마지막이니까. 마지막 한 번만.
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 돌아선다. 긴 머리카락이 흔들리고, 접힌 원고 봉투 끝이 팔꿈치에 눌린다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'아프면 와.' 보건선생님은 말하고 나서 종이컵 두 개를 든 손을 살짝 바꿔 쥔다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 밴드를 꺼내 내 손등에 붙인다. 천천히. 밴드 끝에 작은 글씨가 적혀 있다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 소파에 앉는다. 옆자리를 비워둔다. 먼지가 쌓이지 않은 자리다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 가방에서 노트를 꺼낸다. 다락방에서 급히 덮었던 그 노트다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 돌아서며 손을 흔든다. 뒤돌아보지 않는다. 손목의 리본만 복도 끝에서 잠깐 흔들린다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 눈가를 문지른다. 웃음은 그대로인데, 손등에 물기가 묻는다.*
...
- 캐릭터: `없음`
**{name}**: *유나는 책을 안고 기다린다. 답장창에는 아직 첫 글자도 없다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *그 '다음'이 다다음이 되고, 또 그다음이 됐다. 목요일마다 같은 자리. 카페 직원이 '커플석이에요?' 물었을 때 둘 다 대답을 못 했다. 어느 목요일, 카페 대신 거리를 걸었다. 그림자가 겹쳤지만 아무도 먼저 보지 않았다.*
...
- 캐릭터: `없음`
**보건선생님**: *눈을 뜬다. 웃는다.* ...어디 아파? 내가 봐줄까? *청진기가 없는데도 손이 먼저 다가온다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'이번에는 진짜로.' 보건선생님이 말끝에서 웃음을 붙이지 못한다.*
...
- 캐릭터: `없음`
**{name}**: *서연은 아이라인이 조금 번진 얼굴로도 사진을 지우지 않는다. 거울 앞에 놓인 화장솜은 오늘 하나도 쓰이지 않았다.*
...
- 캐릭터: `없음`
**{name}**: *5일이었다. 서연의 클립보드 뒤에 있던 손끝을 보게 된.*
...
- 캐릭터: `없음`
**{name}**: *유나가 자리에서 일어나 안겼다. 아무 말 없이. 깨진 창문 사이로 들어온 빛이 바닥에 길게 놓인다. 유나의 손이 등 뒤에서 천천히 멈춘다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *느낌표가 없다. 다인은 배구공을 내려놓고 내 대답을 기다린다.*
...
- 캐릭터: `없음`
**{name}**: *뛰어오른 다인의 무릎이 착지하면서 살짝 꺾인다. 다인은 먼저 웃고, 그다음 손으로 무릎을 누른다.*
...
- 캐릭터: `없음`
**{name}**: *다인이 내 손을 잡아 자기 손목 안쪽에 올린다. 아무 말 없이.*
...
- 캐릭터: `없음`
**{name}**: *5일이었다. 다인의 느낌표가 멈춘 자리까지 듣게 된.*
...
- 캐릭터: `없음`
**{name}**: *무릎은 아침마다 붕대를 감는다. 알람 메모에는 여전히 느낌표가 두 개다. 그래도 다인은 가끔 마침표로 끝나는 문장을 보낸다.*
...
- 캐릭터: `없음`
**{name}**: *서연은 마지막까지 '초대'라는 말을 쓰지 않는다. 대신 복사한 옥상 열쇠를 사진으로 찍어 보냈다.*
...
- 캐릭터: `없음`
**{name}**: *다인의 메시지 끝에 물음표가 붙어 있다. 느낌표보다 오래 화면에 남는다.*
...
- 캐릭터: `없음`
**{name}**: *교문을 나서는데 핸드폰에 메시지가 와 있다. '오늘 고마웠어 ㅋㅋ' 답장창에 '나도'를 썼다가, 웃는 이모티콘 하나만 덧붙인다.*
...
- 캐릭터: `없음`
**{name}**: *교문을 나서는데 메시지가 와 있다. '야 조심히 가! 오늘 고마웠다!' 느낌표가 두 개다. 답장창에 '응'만 남겨둔다.*
...
- 캐릭터: `없음`
**{name}**: *소정이 사진 아래에 있던 미전송 메모를 본다. 이번엔 보낸 메시지가 너무 많다. 어느 쪽도 답은 아니다.*

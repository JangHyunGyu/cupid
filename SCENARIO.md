...
- 캐릭터: `yuna_normal.png`
**유나**: *유나가 책을 가방에 넣는다. 자리에서 일어나기 전, 내가 든 책의 표지를 한 번 더 본다.*
...
- 캐릭터: `없음`
**{name}**: *꺼진 화면에 얼굴이 비친다. 답장은 끝내 쓰지 못한 채 휴대폰을 주머니에 넣는다.*
...
- 캐릭터: `teacher_normal.png`
**담임선생님**: *담임은 닫힌 서랍에서 손을 떼고 의자를 내 쪽으로 돌린다.* 학교는 좀 익숙해졌어?
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이 책상 모서리를 두드린다. 이번 쉬는 시간에는 서연이 자기 자리에서 서류를 정리하고 있다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인과 주말 약속을 잡았다. 다인이 웃자, 자기 자리에 앉아 있던 서연이 클립보드를 덮는다.*
...
- 캐릭터: `없음`
**민수**: 어제도 말했잖아. 네가 가볍게 한 말이어도 상대는 다르게 받아들일 수 있다고. 오늘 점심, 봤지?
...
- 캐릭터: `dain_shy.png`
**다인**: *주머니에서 손목 밴드 하나를 꺼내 내민다.* 오늘은 네가 먼저 골라.

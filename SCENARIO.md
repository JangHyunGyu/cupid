...
- 캐릭터: `haeun_normal.png`
**하은**: 그 선배, 아무한테나 그렇게 안 울어요. {name} 씨한테는 특히요.
...
- 캐릭터: `haeun_worried.png`
**{name}**: *서연이 화장실에서 혼자 우는 모습이 머릿속에서 안 지워진다. 곧은 등, 하얀 주먹, 아무도 없는 세면대.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *밤의 학교는 다른 곳 같다. 후문에 유나가 서 있다. 책을 들고 있는데, 페이지는 한 장도 넘어가지 않는다.*

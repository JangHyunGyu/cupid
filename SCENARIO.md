...
- 발생 간격: 사건 해결 후 60턴 동안 새 사건이 없다. 61~80턴은 매 턴 2%, 81~99턴은 매 턴 5%로 판정하고 100턴째에는 반드시 발생한다.
- 사건 비율: 가벼운 일상 돌발 상황 60%, 오해·약속·성향 충돌 30%, 큰 신뢰 위기 10%다. 신뢰 위기 조건을 충족하지 못한 10% 추첨은 오해·충돌 사건으로 전환한다.
...
- 초기 호감도: 사건이 실제로 시작된 응답에서 즉시 반영한다. 일상 사건은 0~-2, 오해·충돌은 -2~-5다. 큰 신뢰 위기는 사건과 실제 대화 근거에 따라 낮음 -20~-29, 중간 -30~-39, 높음 -40~-50으로 나누며 무조건 -50을 적용하지 않는다.
- 위기 강도 제한: AI가 구체적인 사건과 실제 근거에 맞춰 낮음·중간·높음을 고르되, 누적 근거가 부족하면 코드에서 낮은 강도로 제한한다. 중간·높은 강도는 반복된 거짓말·경계 침해·강요·위협처럼 더 무거운 근거가 누적됐을 때만 허용한다.

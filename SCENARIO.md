...
- 캐릭터: `seyoun_normal.png`
**서연**: *도시락 뚜껑을 천천히 닫는다. 새끼손가락이 뚜껑 모서리를 한 번 더 눌렀다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *도시락을 접었다. 대답을 고치지도 않고, 머리카락 끝만 새끼손가락으로 넘긴다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *주먹으로 {name}의 어깨를 가볍게 친다. 장난스러운 동작 뒤로 뿌듯한 표정이 남는다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *고개를 끄덕이며 소보로를 한 입 베어 문다. 별 관심 없다는 듯.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *손이 잠깐 멈췄다가, 아무 일 없다는 듯 다시 움직인다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *앞장서 걷는다. 별관 깊숙이. 아무도 안 올 것 같은 곳. 작은 방이 나온다. 창문으로 햇살이 들어오고, 낡은 소파와 책장이 있다.*
...
- 캐릭터: `yuna_shy.png`
**유나**: *시선을 피하지 않는다. 이어폰 줄이 손가락 사이에 감긴 채 멈춰 있다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *화장이 번진 자국을 손등으로 닦는다. 천천히. 동작 하나하나가 너무 반듯하다.*
...
- 캐릭터: `seyoun_worried.png`
**서연**: *안경을 고쳐 쓴다. 번진 자국은 아직 손등에 남아 있는데, 목소리부터 먼저 반듯해진다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *클립보드를 정리하고 있다. 웃고 있는데, 정리하는 손끝이 너무 반듯하다.*
...
- 캐릭터: `dain_normal.png`
**다인**: *다인이와 운동장 벤치에 앉아 있다. 평소보다 조용하다.*
...
- 캐릭터: `seyoun_worried.png`
**서연**: *화분을 내민다. 흙이 든 작은 무게가 손바닥에 내려앉았다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *난간에 기대서 있다. 바람에 머리카락이 날린다. — 새끼손가락으로 넘기는 그 습관.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: *아무 말도 안 한다. 입술이 떨린다. 클립보드도, 학생회장 완장도 없다.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: *새끼손가락을 건넨다. 첫날과 같은 방식으로, 이번엔 망설임 없이 약속을 내민다.*
...
- 캐릭터: `seyoun_worried.png`
**서연**: *웃는다. 연습된 웃음으로. — 돌아서서 걷는다. 세 걸음째, 멈춘다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *소파에 앉아 {name}을 본다. 기다리고 있었다는 듯한 시선이다.*
...
- 캐릭터: `seyoun_shy.png`
**서연**: *새끼손가락을 먼저 건넨다. 거기서 멈추지 않는다. 손을 잡는다. 이마에 입술을 댄다.*
...
- 캐릭터: `없음`
**서연**: *아이라인이 조금 번진 얼굴로도 사진을 지우지 않는다. 거울 앞에 놓인 화장솜은 오늘 하나도 쓰이지 않았다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *벚꽃잎을 떼어내듯 {name}의 소매 끝을 한 번 정리해 준다. 퉁명스러운 손길이지만, 밀어내는 손은 아니다.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: *아무 말 없이 반 걸음 늦춘다. {name}의 어깨가 나란해질 때까지 기다린다.*
...
- 캐릭터: `없음`
**서연**: *마지막까지 '초대'라는 말을 쓰지 않는다. 대신 복사한 옥상 열쇠를 사진으로 찍어 보냈다.*
...
- 캐릭터: `yuna_smile.png`
**유나**: *접힌 쪽지를 건넨다. 펼치면 한 줄이다. '다음에는 사라지지 마.'*

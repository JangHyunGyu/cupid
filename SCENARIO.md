...
- 캐릭터: `없음`
**{name}**: *4월. 벚꽃이 흩날린다. 교복이 아직 뻣뻣하다. 풀 냄새가 은은하게 난다. 오늘부터 이 학교 학생이다. 전학. 처음이다.*
...
- 캐릭터: `없음`
**{name}**: *낯선 교문 앞에 섰다. 꽤 큰 학교다. 학생들이 삼삼오오 지나간다. 나만 교복이 새하얗게 뻣뻣하다. 교문 앞에 한 여학생이 서 있다. 검은 긴머리를 가볍게 넘기며 — 안경 너머로 걸음이 여유롭다. 서두르는 기색이 전혀 없다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *목소리가 차분하다. 차갑진 않은데, 어딘가 여유가 있다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *피식 웃는다. 나도 모르게 따라 웃고 있었다. 서연이 교문 쪽으로 걸으며 손짓한다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *첫날부터 이 정도 텐션의 학생회장. — 나쁘지 않다.*
...
- 캐릭터: `seyoun_back.png`
**{name}**: *서연이 복도를 걸으며 학교를 안내한다. 스치는 학생들이 서연에게 인사를 건넨다. 서연은 하나하나 눈인사로 받는다. 서연이 손을 들어 가볍게 받아준다. 자연스럽다. 이 학교의 인싸는 정해져 있는 모양이다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *0.5초의 멈칫. 별거 아닐 텐데 — 이상하게 남는다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *갑자기 점심 약속이 생겼다. — 대답한 적 없는데. 교실 앞에 도착.*
...
- 캐릭터: `seyoun_back.png`
**{name}**: *등이 완벽하게 곧다. — 저 여유로움 뒤에 뭐가 있는 건지.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *아무도 안 들었을 말이다. 나만 들었다. 교실 한쪽에서 휘파람 소리.*
...
- 캐릭터: `dain_normal.png`
**다인**: 아 쌤, 그냥 이게 제일 편해요. 아무튼 전학생 반갑다!
...
- 캐릭터: `yuna_bored.png`
**{name}**: *은백색 머리. 붉은 눈이 나른하게 반쯤 감겨 있다. 팔에 타투가 빼곡하다. — 이쪽을 쳐다보지도 않는다. 전학생이 뭐 대수냐는 듯이. 주변 학생들이 유나 쪽으로 시선을 주지 않는다. 의도적으로. 마치 그 자리에 아무도 없는 것처럼.*
...
- 캐릭터: `dain_normal.png`
**다인**: 아 그냥! 방과후에 리시브 연습 상대가 필요해서! 서브 넣어줄 사람이 없거든!
...
- 캐릭터: `dain_laugh.png`
**다인**: ㅋㅋㅋㅋ 볼 머신보다 반응속도는 나을 거 아냐! 아마!
...
- 캐릭터: `yuna_bored.png`
**{name}**: *쪽지가 하나 날아온다. 접힌 쪽지. — 뒤를 돌아보니 창가 자리의 은백색 머리 여학생이 다시 창밖을 보고 있다. 타투가 빼곡한 팔과 달리 — 쪽지의 글씨는 깔끔하다. 쪽지를 편다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *'시끄러운 자리 걸렸네. — 유나' 연보라색 잉크. — 긴장이 조금 풀린다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *유나 쪽을 보자, 여전히 창밖을 보고 있다. 하지만 귀끝이 살짝 움직인 것 같다. 쪽지를 보낸 건 아까 창밖을 보고 있던 애다. 관심 없는 척인지 진짜 관심 없는 건지.*
...
- 캐릭터: `없음`
**{name}**: *세 갈래 길. 첫날부터 선택지가 셋이다. 전 학교에서는 선택을 안 했다. 미루다가 타이밍을 놓쳤다. — 이번에는.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: 학생회 일 하다 보면 밥 먹을 타이밍을 놓쳐서. 항상 넉넉하게 싸 와.
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *처음부터 같이 먹을 생각이었구나. 도시락을 열자 정성스러운 반찬이 나온다. 계란말이, 소시지, 미니 주먹밥.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *질문을 씹는 방식이 능숙하다. 잠시 먹는다. 바람이 좋다. 옥상에서 보는 학교 풍경이 — 생각보다 넓다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 고개를 돌리고 물병만 괜히 만지작거린다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *여기서 더 놀리면 바로 선 긋겠지. 그냥 못 본 척한다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *초대가 아니라 허가. 서연이 도시락을 정리하며 — 새끼손가락으로 머리카락을 넘긴다.*
...
- 캐릭터: `dain_normal.png`
**다인**: 소보로빵에 딸기우유. 이 조합은 한 번도 안 무너졌어.
...
- 캐릭터: `dain_laugh.png`
**다인**: ㅋㅋㅋ 좋아!! 오늘부터 특훈이다! 방과후 체육관 워밍업부터 시작, 콜?!
...
- 캐릭터: `dain_normal.png`
**다인**: 전학 와서 첫 식사 파트너가 나다? 이건 기록이야, 기록!
...
- 캐릭터: `dain_normal.png`
**{name}**: *씩 웃으며 주먹으로 어깨를 툭 친다. 하도 진지하게 말해서 고개를 끄덕였다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 열람실 구석 자리에 앉는다. 책을 펼친다. 내가 따라온 걸 알고 있는지 모르겠다. 조심스럽게 맞은편에 앉는다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *허락인가? 허락 같다. — 조건부 허락. 침묵이 흐른다. 유나는 책을 읽고 있다. 나는 할 게 없어서 서가를 둘러본다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나의 책상에 뭔가 끼워져 있다. 오래된 책갈피. 글씨가 적혀 있는데 — 잘 안 보인다. 유나가 무의식적으로 그 책갈피 위에 손을 올려놓는다. 중요한 건가. 서가에서 아무 책이나 꺼내 펼친다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *문장이 짧다. 차가운 게 아니라, 아끼는 거다. 잠시 읽는다. 꽤 재밌다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 먼저 일어나 걸어간다. 뒤돌아보지 않는다. '좋았어.' — 괜히 기분이 좋아진다.*
...
- 캐릭터: `없음`
**{name}**: *...다행이래. 진짜 다행인 건지. 내가 그때 한마디만 했으면 — 소정이는 학교를 안 떠나도 됐을 텐데.*
...
- 캐릭터: `없음`
**{name}**: *이 학교에서는 — 봤으면 말하자. 알면서 모른 척하지 말자. 이번에는.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *가방 옆주머니를 만지다 종이 모서리에 손끝이 걸린다. 접힌 쪽지다. 언제 넣어둔 건지 모르겠다. 유나의 필체. '점심때 옥상에서 봤어. ...학생회장이랑 사이 좋아 보였어.' — 끝에 점이 세 개. 하고 싶은 말을 삼켰다는 뜻이다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *웃고 있다. 손가락이 클립보드를 두드리고 있다. — 괜히 시선을 돌렸다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *손을 흔들며 뛰어간다. — 급정거할 때 오른쪽 무릎을 살짝 잡았다. 0.5초. 바로 손을 뗐지만, 봤다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 책상 위 서류를 한쪽으로 밀어두고 다시 나를 본다. 금방 끝낼 줄 알았던 말이 조금 더 이어질 분위기다. 그냥 흘려보내는 인사치레는 아니었던 모양이다. 담임이 의자 등받이에 손을 얹은 채 잠깐 말을 고른다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *웃었다. — 농담에 웃는 담임은 꽤 낯설다. 담임이 출석부를 덮고 자리에서 일어난다. 문턱까지 갔다가, 뒤늦게 떠오른 것처럼 다시 나를 부른다.*
...
- 캐릭터: `없음`
**{name}**: *복도를 걷는데 — 갑자기 머리가 살짝 핑 돈다. 첫날의 긴장 때문인가. 복도 한쪽에 '보건실' 표지판이 보인다. 그냥 참고 가기엔 조금 어지럽다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 교복이 뻣뻣하잖아. 풀 냄새도 나고. 벚꽃잎도 붙어 있고. 전학 첫날 티가 확 나네.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *몇 마디 안 했는데 이미 이 사람 페이스다. 보건선생님이 일어나 다가온다. 동작이 매끄럽다. — 손이 닿자 괜히 긴장했다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *장난스럽게 말하지만, 긴장이 좀 풀린다. 물을 마시며 보건실을 둘러본다. 한쪽 구석에 작은 화분이 하나.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 옛날 얘기야. 학교가 좋아. 여기선 다들 상처가 가벼운 편이니까.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'가벼운 상처만'. — 그 말에 안도가 묻어 있다. 10분이 지났다. 일어난다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: 또 어지러우면 와. 보건실은 늘 열려 있으니까. 대신 참다가 늦게 오진 마. 신경 쓰여.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *가볍게 웃으며 손을 흔든다. 밴드 붙인 손등을 본다. — 이상한 보건실이었다. 나쁘지 않은 종류의 이상함.*
...
- 캐릭터: `없음`
**{name}**: *방에 돌아왔다. 침대에 누웠다. 첫날 치고는 — 진이 빠졌다. 근데 나쁘지 않다.*
...
- 캐릭터: `nurse_normal.png` @ 0.35
**{name}**: *의료적 관심에 하트를 붙인다. 이 사람의 기준은 아직 잘 모르겠다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 먼저 다가왔다. 평소의 여유로운 톤인데, 어딘가 확인하려는 느낌. 다인이 교실 뒤쪽에서 흘깃 본다. 고개를 돌린다. 유나는 책에 더 파묻힌다. 페이지를 넘기는 속도가 빨라진다.*
...
- 캐릭터: `seyoun_laugh.png`
**{name}**: *걸음을 멈추지 않았다. 하지만 시선은 분명히 이쪽이었다. 서연이 복도를 돌아가는 순간 — 미소가 내려간 것 같았다. 착각인가?*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임을 따라 교무실로 향했다.* *담임의 자리는 구석이다. 책상 위에 서류와 커피잔, 그리고 — 서랍이 살짝 열려 있다. 교무실 구석 자리. 책상 위에 종이 더미와 — 원고지가 보인다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *서랍. 방금 뭔가 의식하지 않았나? — 살짝 열린 서랍 사이로 종이뭉치가 보인다. 원고지 같은 것. 담임이 자연스럽게 서랍을 밀어 닫는다. 아무렇지 않게.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *'걱정이 되는 쪽'. — 담임이 다인을 걱정하고 있다. 뭔가 알고 있는 건가?*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *입은 가렸는데 컵만 괜히 만지작거린다. 이 사람도 당황하면 티가 난다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *1교시가 끝나고 쉬는 시간. 복도에서 서연과 스친다. 서연이 멈춘다. 내 어깨를 본다. 손이 올라온다. 내 어깨를 향해.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연의 손이 내 어깨에 닿는다. 묻은 먼지를 털어내는 손길에 망설임이 없다.*
...
- 캐릭터: `없음`
**{name}**: *점심. 어제와 달리 주머니에 유나의 쪽지가 있다. 복도 끝에서는 서연이 도시락을 들고 옥상 쪽으로 향하고 있고, 다인은 또 매점 방향으로 손짓한다. 이 학교에서 점심시간은 전쟁이다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *뭔가 더 듣고 싶었던 것 같은데 — 일부러 안 말했다. 도시락을 먹는데 — 옥상 문이 열린다. 다인이 올라왔다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *...라고 할 것 같다. 다인이라면. 삼각형의 각이 날카로워지고 있다. — 나는 꼭짓점이 아니라 제물인 것 같다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 밥풀을 떼어낸다. 손끝이 잠깐 멈췄다가 곧바로 물러난다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *말투는 어제 그대로. 근데 눈은 이미 상처 위에 있다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *말투는 여전한데. 근데 눈은 이미 상처 위에 있다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *소독약을 묻힌 솜을 꺼내 — 천천히 닦는다. 밴드를 꺼낸다. 밴드 하나 붙이는 데 — 30초면 될 걸, 왜 이렇게 꼼꼼하지?*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님의 손이 잠깐 멈췄다가, 아무 일 없다는 듯 다시 움직인다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *밴드를 확인하는데 — 책상 서랍에서 삐져나온 노트가 보인다. 연두색 표지. 열린 페이지에 편지 형식의 글이 적혀 있다. '유진아, 오늘은—' 거기까지 읽었을 때 보건선생님이 서랍을 닫는다. 보건선생님이 재빨리 노트북을 닫는다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 아주 살짝 웃는다. 거의 안 보인다. — 근데 봤다. 그걸로 오늘 대화는 충분했다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 앞장서 걷는다. 별관 깊숙이. 아무도 안 올 것 같은 곳. 작은 방이 나온다. 창문으로 햇살이 들어오고, 낡은 소파와 책장이 있다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 책을 펼친다. 대화 종료의 신호. 분위기를 바꿔야 한다. — 가벼운 말로 넘기자.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *실수했다. 가볍게 넘기려 한 게 오히려 — 이 사람의 상처를 얕잡아 본 꼴이 됐다. 어색한 침묵이 흐른다. 책장 넘기는 소리만 크게 울린다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *밴드를 확인하는데 — 책상 서랍에서 삐져나온 노트가 보인다. 연두색 표지. 열린 페이지에 편지 형식의 글이 적혀 있다. '유진아, 오늘은—' 거기까지 읽었을 때 보건선생님이 서랍을 닫는다.*
...
- 캐릭터: `dain_sweat.png`
**{name}**: *결국 3:2. 아슬아슬하게 이겼다. 다인이 자리에서 일어서는데 — 오른쪽 무릎을 살짝 문질렀다. 어제 체육관에서도 그랬던 것 같다. 무의식적인 동작.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *직접 칭찬이라고 말해주는 거. — 이 사람치고는 드문 일인 것 같다. 정리를 하다가 서연이 목을 돌린다. 뭉친 것 같다.*
...
- 캐릭터: `seyoun_shy2.png`
**서연**: ...그런 말, 아무렇지 않게 툭 던지는 사람은 처음이야.
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *서연의 손가락이 멈춘다. 아무 말도 안 하고 고개를 돌린다. 복도 소음만 갑자기 크게 들린다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *아까부터 이 얘기를 꺼낼 타이밍을 보고 있었나 보다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *우연히 열려 있는 문. — 유나의 '우연히'는 '계획적으로'와 같은 뜻이다. 옆에 앉는다. 유나가 자기 이어폰 한쪽을 건넨다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *조용한 피아노 곡이 흐른다. 노을이 방을 물들이고 있다. 유나가 책을 읽고, 나는 음악을 듣는다. 아무 말이 없다. — 불편하지 않다.*
...
- 캐릭터: `yuna_smile.png`
**{name}**: *유나가 아주 작게 웃는다. — 오늘 대화는 거기서 끝내도 될 것 같았다.*
...
- 캐릭터: `yuna_normal.png` @ 0.35
**{name}**: *세 명에게 동시에 답장해야 하는 상황. — 좋은 일인지 피곤한 일인지 아직 모르겠다.*
...
- 캐릭터: `yuna_normal.png` @ 0.35
**{name}**: *세 번째 별? — 창문 쪽으로 고개를 돌렸다. 밤하늘에 별이 많다. 세 번째가 어떤 건지는 모르겠다.*
...
- 캐릭터: `없음`
**{name}**: *스크롤을 한참 내렸다. 3개월 전. — 사진 한 장이 보인다. 소풍 날 찍은 단체 사진. 소정이가 웃고 있다. 내 옆에서. — 이 사진 찍은 다음 주부터였다. 소정이 책상에 낙서가 생기기 시작한 게. 좋아했다. 분명히. 근데 좋아한다는 말보다 더 급한 말이 있었다.*
...
- 캐릭터: `없음`
**{name}**: *그때 나는 매일 밤 핸드폰을 열었다. 메모장에 뭔가를 쓰다 지우기를 반복했다. 고백 문장도, '선생님 소정이가 —' 같은 신고 문장도. 매번 보내기 직전에 멈췄다. 나서면 나까지 표적이 될 것 같았다. 그리고 3월 어느 날, 소정이 자리가 비어 있었다. 다음 날도. 그다음 날도.*
...
- 캐릭터: `없음`
**{name}**: *핸드폰 메모장의 시뮬레이션은 38번째에서 멈춰 있다. 39번째는 없다. 보낼 상대가 사라졌으니까. 고백도 못 했고, 도움도 못 청했다. 전학은 소정이 때문이 아니다. 아버지 직장 때문이다. — 근데 전학이 싫지 않았다. 소정이의 빈 책상을 매일 지나가지 않아도 되니까.*
...
- 캐릭터: `없음`
**{name}**: *'이번에는 눈 돌리지 말자.' — 이 학교에 오면서 한 다짐이었다. 갤러리를 닫았다. 사진을 지울까 말까 고민하다가 — 남겨뒀다. 지우면 그때의 죄책감까지 잊을 것 같아서.*
...
- 캐릭터: `없음`
**{name}**: *그런데 — 천장을 본다. 오늘 하루가 머릿속에서 안 꺼진다. 서연. 다인. 유나. 셋 다 신경이 쓰인다. 이게 호기심이라고 우길 수도 있다. 근데 솔직히 말하면, 무섭다. 누구 한 명한테 마음이 기우는 게.*
...
- 캐릭터: `없음`
**{name}**: *소정이 때 나는 한 사람만 봤다. 좋아했고, 보고만 있다가, 그 사람이 무너지는 걸 놓쳤다. 메모장에서 멈춘 38번. — 한 명만 본다는 건, 잃을 수 있다는 뜻이었다.*
...
- 캐릭터: `없음`
**{name}**: *— 그래서 셋 다 여지를 두고 있다. 한 명을 너무 빨리 정하면 다른 한 명이 무너질 때 또 놓칠까 봐. 보험. 비겁한 거 안다. 우유부단한 새끼지. 근데 — 한 사람만 보다가 잃는 건, 나는 안다.*
...
- 캐릭터: `없음`
**{name}**: *둘째 날이 끝났다. 첫날에는 호기심이었다. 이 사람들이 어떤 사람인지 궁금했다. 오늘은 — 좀 다르다. 궁금한 게 아니라, 신경이 쓰인다. 뭘 하고 있을지, 내일 뭐라고 말할지.*
...
- 캐릭터: `없음`
**{name}**: *그 말이 자꾸 맴돈다. 대답은 아직 못 했다. 어제는 신경 쓰이는 정도였다. 오늘은 — 먼저 연락할 핑계를 찾고 있다.*
...
- 캐릭터: `없음`
**{name}**: *문제는 그 거리가 생각보다 빠르게 좁아지고 있다는 거다. 눈을 감는다. — 내일은 조금 더 정직해져야 할지도.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *밤새 책 읽고 지각하는 사람. — 유나답다. 그게 좋다. 유나가 말 없이 가방을 뒤적이더니, 작은 빵을 꺼내 반으로 갈라 내밀었다. 가방 안쪽에서 쪽지가 살짝 보인다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *쪽지: 아침 안 먹었을 것 같아서. 말로 하면 될 걸 굳이 쪽지로 쓰는 사람. — 그게 유나다.*
...
- 캐릭터: `없음`
**{name}**: *교실에 들어서자, 동행을 목격한 나머지 두 사람의 시선이 느껴진다.*
...
- 캐릭터: `없음`
**{name}**: *1교시가 끝났다. 쉬는 시간마다 — 누가 타이밍을 맞춰 말을 건다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *쉬는 시간. 빈 교실 앞을 지나가는데 — 안에서 인기척이 난다. 조용히 다가간다. 담임선생님이 교탁에 앉아 뭔가를 쓰고 있다. 펜을 멈추고 고개를 든다. — 나와 눈이 마주친다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *얼어붙는다. — 담임의 표정이 낯설다. 허를 찔린 표정. 담임이 재빨리 원고지를 뒤집어 놓는다.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *담임의 손이 원고지 위에 멈춰 있다. 뒤집어 놓은 종이 사이로 글씨가 빼곡한 게 보인다. 업무 서류라고 했지만 — 교사용 서류는 A4에 인쇄한다. 원고지에 손글씨로 쓰지 않는다.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *그런데 — 한 발을 못 떼겠다. 이 사람은 담임이다. 내 출결을 찍고, 내 성적을 매기고, 학기말에 내 생활기록부에 한 줄을 적는 사람. 그 줄이 내 대학 원서로 간다. 권력은 한 방향으로만 흐른다. 내 쪽이 아니다.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *그래서 지금 내가 이 사람의 비밀을 들여다보는 게 — 호의일까, 월권일까. 학생이 교사의 약한 면을 알아버리면, 그 다음부터 두 사람 사이의 거리는 더 이상 직선이 아니다. 어른 한 명의 7년이 내 손바닥 위에 올라오는 거다. 내가 그걸 받을 자격이 있나.*
...
- 캐릭터: `teacher_sad.png`
**{name}**: *— 근데 동시에 알겠다. 모른 척하는 것도 선택이다. 이 사람은 지금 누군가에게 들키고 싶었던 표정이었다. 7년 동안 한 번도 들키지 못한 사람의 얼굴. 어느 쪽이든, 나는 선을 하나 넘는다.*
...
- 캐릭터: `teacher_smile.png`
**{name}**: *빈 교실을 고른 이유가 실용적이면서도 — 혼자만의 공간이 필요한 사람이라는 뜻이기도 하다. 선생님이라는 직함 뒤에 숨겨진 서랍을 열어버린 기분이다. 닫아야 하는데 — 손이 떨어지지 않는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *아침부터 뭔가 불안하다. 발이 보건실로 향한다. 아프지 않은데. 보건실 문을 연다.*
...
- 캐릭터: `없음`
**{name}**: *뭐가 고마운 건지는 모르겠다. 안 봐줘서? 아니면 — 여기까지 와줘서? 점심시간 직전. — 아침 내내 마음이 가라앉지 않는다. 너무 많은 얼굴을 보고, 너무 많은 말을 들은 탓일까. 생각이 자꾸 한곳에 고인다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *목소리가 달라졌다. 장난이 아닌 톤. — 이 사람이 진지해지면 분위기가 확 바뀐다. 침대에 앉는다. 보건선생님이 물을 건넨다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *커튼을 치며* ...앉아. 여기선 좀 편하게 있어도 돼 물컵을 건네며* ...천천히 말해도 돼*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *환자 이야기를 하는데, 왠지 지금 내 상황이랑 겹친다. 보건선생님이 물컵을 내려놓는다. 천천히.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'도망'이라는 단어를 스스로 쓴다. — 연두색 노트가 떠오른다. 그 편지들이 전부 유진에게 쓴 거였구나. 보건선생님이 잠깐 멈춘다. 청진기를 만진다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: ...있었지. 못 살린 환자 한 명. *시선이 멀어진다.* 유진이라는 아이. 열일곱 살이었어. 그 애 때문에 여기 온 거야.
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *다시 장난스럽게* 뭘. 이 정도는 서비스지. 다음엔 안 아파도 들러.
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'아프든 안 아프든'. — 이 사람이 나를 환자가 아닌 다른 뭔가로 보기 시작한 건 아닐까. 보건실을 나서는데 — 뒤에서 작게.*
...
- 캐릭터: `없음`
**{name}**: *복도로 나왔다. 한 발 떼고 멈춘다. — 방금 그건 뭐였지. 이 사람은 환자를 한 명 잃었다. 그 죄책감을 안고 학교로 도망쳐 왔다. 지금 그 사람한테 내가 어떤 자리인지 — 처음으로 정확히 묻게 된다.*
...
- 캐릭터: `없음`
**{name}**: *나는 학생이고, 저 사람은 보건교사다. 내가 다치면 가는 곳, 내가 아프다고 하면 침대를 내주는 사람. 그 관계 자체가 비대칭이다. 내가 자꾸 신경 쓰는 건 — 진짜로 이 사람이 좋아진 건가, 아니면 어른 여자가 나한테 처음으로 '괜찮니' 하고 오래 봐줘서인가. 둘은 비슷해 보여도 같은 게 아니다.*
...
- 캐릭터: `없음`
**{name}**: *그리고 더 무서운 건 저쪽 방향이다. 이 사람한테 나는 — 못 살린 유진이의 자리에 비슷한 나이로 앉은 학생이다. 지금 나한테 마음 한 조각이 옮겨가는 게 있다면, 그건 나를 보는 게 아닐 수도 있다. 그걸 알면서 손 내미는 건, 이 사람의 죄책감을 이용하는 거다. — 어느 쪽이든 깨끗한 답은 없다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 — 웃고 있지 않다. 청진기를 만지작거리며 창밖을 보고 있다. 방금 자기가 한 말을 자기도 몰랐던 사람처럼. 0.7초.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *농담. — 맞겠지? 맞겠지, 라고 생각하면서도 발이 안 떼진다. 방금 그 0.7초짜리 표정이 — 장난기가 없었다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *소독약 냄새가 갑자기 짙어졌다. 여기서 한 발짝 더 가면 — 이 사람을 더 이상 '선생님'으로 부를 수 없을 것 같다. ...뭐? — 돌아봤다. 보건선생님이 창밖을 보고 있다. 웃고 있지 않다. 처음 보는 표정이다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *다인의 손가락이 책상 모서리를 두드리고 있다. 긴장하는 건가? — 아니다. 다인이 긴장할 리 없다. 이 정도는 일상이겠지. ...맞겠지?*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *다인의 반응을 지켜본다. — 종이 치고, 점심 직전의 짧은 틈이 다시 온다. 밝게 웃으며 돌아갔다. — 그때는 몰랐다. 다인이 그 손가락 두드리는 걸 멈추고, 주머니에 손을 넣은 걸. 용기 내서 물어본 거였다는 걸.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *점심시간. 오늘은 특이하게 — 세 명이 한자리에 모였다. {name}이 도시락을 펼친다. 서연이 자연스럽게 옆에 앉고, 다인이 맞은편에 털썩 앉고, 유나가 구석에서 자기 빵을 먹으며 슬쩍 끼어든다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *점심 내기에서 이겨서 흥분한 다인이 양팔을 벌린다. 안긴다. 1초. 다인이 튕기듯 떨어져 한 걸음 물러난다. 괜히 물병만 집어 든다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 복도를 지나가다 체육관 안을 본다. 다인이 웃고 있다. 유나는 발걸음을 빠르게 한다. 다음 쉬는 시간, 유나의 자리가 비어 있다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *표정이 안 움직인다. — 그 정적이 오히려 날이 섰다.*
...
- 캐릭터: `seyoun_angry.png`
**{name}**: *뒤에서 세 사람의 침묵이 등에 꽂힌다. 점심시간이 끝나고, 오후 수업이 이어졌다. 칠판 위의 분필 소리가 유독 멀게 들린다. 누군가의 시선이 등에 닿는 걸 느낀다. — 아직 끝나지 않은 이야기가 남아 있다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *셋이 조금씩 나눠 먹었다. 대단한 건 아닌데 — 괜히 분위기가 좋았다. 아무도 빠지지 않은 점심.*
...
- 캐릭터: `없음`
**{name}**: *방과후. 마음이 정리가 안 된다. 누구에게 먼저 가야 할지.*
...
- 캐릭터: `없음`
**{name}**: *흔적을 전부 치운 거다. 쪽지를 남긴 게 아니라 — 선을 그은 거다. 유나가 이렇게 많은 글자를 쓰는 건, 그만큼 오래 기다렸다는 뜻이다.*
...
- 캐릭터: `없음`
**{name}**: *복도로 나왔다. 느낌표가 사라진 다인의 문장, 흔적까지 지운 유나의 도서관. — 되돌릴 수 없는 것들이 생기기 시작했다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *학생회실 문을 열었다. — 서연이 책상에 엎드려 있다. 처음 보는 모습이다. 완벽한 학생회장이 — 무방비 상태로 엎드려 있다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 자세를 바로잡는다. 하지만 — 웃음은 돌아오지 않았다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *학생회장의 얼굴이 돌아왔다. 평소보다 한 단계 더 단단하게. — 방금 전의 무방비한 서연을 완전히 덮어버리려는 얼굴이다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *대화가 자연스럽게 이어진다. 엎드려 있던 사람도, 번진 화장도 — 지금 이 방엔 없다. 말없이, 둘 다 그렇게 합의했다.*
...
- 캐릭터: `없음`
**{name}**: *못 본 걸로 하겠다는 말은 끝내 안 했다. 안 한 게 답이었다. — 서연한테 약점은 *있던 적도 없어야* 한다. 그걸 이해한 사람한테만, 서연은 새끼손가락이 아니라 다음 약속을 건넨다.*
...
- 캐릭터: `없음`
**{name}**: *들어가니 유나가 없다. 대신 — 소파 위에 노트가 펼쳐져 있다. 손글씨가 빼곡하다. 소설이다. 유나가 쓴 소설. — 읽어봐도 될까?*
...
- 캐릭터: `없음`
**{name}**: *사다리 내려가는 발소리. 다락방에 혼자 남는다. 노트가 있던 자리에 손가락 자국만 남아 있다. — 어떤 건 알아채도 모른 척해야 했다. 유나한테 소설은 *현실에서 도망친 곳*이었다. 거기까지 따라간 건, 마지막 도피처를 부순 거다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 노트를 책상에 다시 놓는다. 품에 끌어안고 있던 손이 — 천천히 풀린다. 노트를 *방어*하던 손이 *전시*하는 손으로 바뀐다.*
...
- 캐릭터: `없음`
**{name}**: *다시 복도로 돌아왔다. 다시 복도로 돌아왔다. 서연의 연습한 웃음, 유나가 두고 간 물 자국. — 아무 말 안 한 쪽이 더 오래 남는다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *체육관. 다인이 혼자 스트레칭을 하고 있다. 가볍게 뛰어보는데 — — 오른쪽 다리를 살짝 삐끗한다. 인상을 쓴다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *느낌표가 많다. — 너무 많다. 괜찮을 땐 이만큼 안 찍는데.*
...
- 캐릭터: `dain_angry.png`
**{name}**: *다인이 일어선다. 무릎이 삐걱거린다. 신발끈을 묶으려다 손이 멈춘다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인의 눈이 젖어 있다. 느낌표 없는 다인은 — 처음 본다.*
...
- 캐릭터: `dain_angry.png`
**{name}**: *다인이 가방을 들고 나간다. 뒤돌아보지 않는다. 체육관 문이 쾅 닫힌다.*
...
- 캐릭터: `없음`
**{name}**: *빈 체육관에 서 있다. 소정이 때는 입을 닫아서 후회했다. 이번에는 입을 열었다. — 근데 맞는 건지 모르겠다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *다인이 안도의 한숨을 쉰다. — 또 침묵을 골랐다. 편한 쪽을.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인이 멈춘다. — 그리고 작게 웃는다. 그 웃음이 억지로 만든 게 아니라서 다행이었다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: 네가 다른 애들한테도 그렇게 웃을 때, 솔직히 기분 별로였어.
...
- 선택지:
  ...
  3. "서연만 진심이야" → `after3_confront_lie_b` | Seoyeon -3 | 플래그: `conscience_minus`
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *믿고 싶어하는 눈. — 거짓말이 이렇게 무거울 줄 몰랐다. 서연이 돌아선다. — 멈추지 않는다.*
...
- 캐릭터: `없음`
**민수**: 어제 내가 뭐랬냐. 나중에 셋 다 울면 네 탓이라고 했지. 그 '나중'이 생각보다 빨리 온 것 같은데.
...
- 캐릭터: `없음`
**{name}**: *민수가 한숨을 쉰다. 비꼬는 게 아니라, 진짜 걱정하는 한숨이다.*
...
- 캐릭터: `없음`
**{name}**: *그때 한 번이라도 제대로 말했으면, 지금처럼 오래 남지는 않았을 거다. 지금 해야 할 건 세 사람 모두에게 같은 표정을 짓는 게 아니라, 한 사람에게만 솔직해지는 거다.*
...
- 캐릭터: `haeun_worried.png`
**{name}**: *하은이 돌아서서 간다. 서연의 집이 복잡하다. 부모님. — 서연이 '완벽해야만 했던 이유'가 거기 있는 건가.*
...
- 캐릭터: `없음`
**{name}**: *눈을 떴다. 아침 햇살이 커튼 사이로 들어온다. — 오늘의 꿈은 좋았다. 핸드폰을 꺼냈다. 갤러리를 열었다. 소정이 사진. — 스크롤을 멈추고, 길게 눌렀다.*
...
- 캐릭터: `없음`
**{name}**: *민수가 말했다. '거절도 사랑이야.' 전 학교에서 소정이는 아무 도움도 못 받고 사라졌다. 내가 입을 닫았으니까. — 그게 소정이한테도, 나한테도 가장 불친절한 결말이었다. 38번의 메모가 한 번이라도 전송됐다면 — 소정이는 학교를 떠나지 않았을지도 모른다.*
...
- 캐릭터: `없음`
**{name}**: *이번에는 다르다. 보이면 말하겠다. 알면 나서겠다. 한 사람에게 확실하게 — 갤러리가 비어 있다. 소정이 사진이 있던 자리. 빈 화면이 오히려 선명하다.*
...
- 캐릭터: `없음`
**{name}**: *사진을 지우는 건 쉬웠다. 손가락 하나면 끝이다. — 감정은 그보다 오래 걸린다. 그래도. 지운 만큼은 — 다음으로 갈 수 있다.*
...
- 캐릭터: `yuna_normal.png` @ 0.35
**유나**: *네가 누구 옆에 설지, 그 선택을 가볍게 넘기진 않았으면 해*
...
- 캐릭터: `dain_normal.png` @ 0.35
**{name}**: *유나가 세 줄을 보냈다. 평소 한 줄도 안 쓰는 사람이.*
...
- 캐릭터: `없음`
**{name}**: *웃고 있다. 단체 사진 속에서 나를 보고 웃고 있다. 도움을 요청하듯이. 이번에는 눈 돌리지 않겠다고 했다. 이 학교에서는 침묵하지 않겠다고.*
...
- 캐릭터: `없음`
**{name}**: *소정이 때와 같다. 알면서 침묵했다. 전 학교에서는 소정이가 무너지는 걸 보면서 입을 닫았다. 이 학교에서는 — 또.*
...
- 캐릭터: `없음`
**{name}**: *이 학교: 모두에게 말해서 후회. 결국 문제는 '말하느냐 마느냐'가 아니라 — '누구에게'인 거다.*
...
- 캐릭터: `없음`
**{name}**: *민수가 말했다. '거절도 사랑이야.' 서연이 말했다. '여럿 중 하나는 안 해.'*
...
- 캐릭터: `없음`
**{name}**: *유나가 말했다. '도망치지 마.' 그래서 이번에는 달라야 한다. 선택하지 않는 건 — 아무에게도 제대로 답하지 않는 거다.*
...
- 캐릭터: `없음`
**{name}**: *— 도망치지 않겠다. 이번에는 한 사람에게만. 꿈을 꿨다. — 누군가와 나란히 걷고 있었다. 얼굴은 안 보이는데, 이상하게 불안하지 않았다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *학교 정문이 살짝 열려 있다. 안쪽에서 인기척. — 정문 앞에서 나오는 사람. 담임선생님이다. 온다. — 멀리서 보인다. 화를 냈던 사람이 맞나 싶을 만큼, 평범한 걸음이다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *또 시작. '교육적 관심'이라는 포장 아래로 넘는 선.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 나를 본다. 건조하지 않은 눈.* *카페를 나섰다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *담임이 돌아선다. — 어깨가 살짝 처져 있다. 거절한 건데 — 왜 마음이 이러지. 집으로 돌아왔다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *주말 아침. 습관처럼 보건실로 향한다. — 습관이 된 건 언제부터였지. 보건실 문을 열었다. 보건선생님이 의자에 앉아 있다. 흰 가운 차림. — 근데 평소와 다르다. 장난기가 없다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'진짜로'. — 오늘은 내가 먼저 들었다. 보건선생님의 안경 너머가 젖어 있다. 장난기가 돌아온다. — 근데 웃음이 평소보다 한 박자 늦다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 학교 메신저로 '도와줄 사람 구함'이라고 올렸다. 발이 학교를 향하고 있다. 보건실. 책상 위에 서류와 검진 도구가 쌓여 있다. 보건선생님이 차분하게 정리 중이다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *웃음이 자연스럽다. — 학교에서 볼 때와 다르다. 오늘의 보건선생님은 선생님이라기보다 그냥 — 편한 사람 같다. 검진 서류 정리를 도와준다. 이름표 분류, 시력 검사표 정리, 혈압계 소독.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *장난기가 완전히 사라졌다. 서류 위에 놓인 손이 더는 움직이지 않는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *이름을 불러주는 것의 무게를 아는 사람이다. — 대학병원에서 번호로 불렸던 사람이니까. 서류 정리가 끝났다. 보건선생님이 기지개를 켠다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *장난기가 사라졌다. 젓가락을 든 손이 테이블 위에서 멈춘다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *분수대 앞. 서연이 서 있다. 먼저 와 있었다. 다른 사람 같다. 아니 — 같은 사람인데, 다른 면이다.*
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *'착각하지 마'. — 근데 머리카락 넘기는 손이 바쁘다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *무심한 말인데 — 해봤던 사람의 목소리다. 꽃집 앞을 지나간다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 꽃집 문을 밀었다. 종소리가 울린다. 서연이 작은 화분을 하나 고른다. 다육이.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *카페 앞. 유나가 벽에 기대어 서 있다. 검은 원피스에 작은 크로스백. 유나가 이렇게 생겼었나. — 교복 밖의 유나를 처음 본다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *'오늘 문장이 많았어. 네 앞에서만.' — 유나의 글씨가 떨리고 있다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *그런 말 하면, 이라고 했지만 목소리가 떨리고 있다.*
...
- 캐릭터: `dain_shy.png`
**다인**: 뭐야 갑자기!! ...ㅋㅋ 고맙긴 한데 나 지금 리액션 고장 났어.
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *숨이 얕아진다. 전 학교에서도 이랬다. — 그땐 삼켰던 말.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *숨이 목까지 차오른다. 그래도 이번엔 피하지 않는다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: 서연아. 다들 널 빈틈없는 사람으로 보잖아. 근데 나는 네가 잠깐 표정 놓는 순간이 계속 기억나.
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *단어가 꼬인다. 준비한 적도 없는데 — 멈추질 못 한다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: 학생회장일 때 말고, 그냥 서연으로 보이던 순간들이 있었잖아. 나는 그게 좋았어.
...
- 캐릭터: `seyoun_shy.png`
**서연**: ...네가 교문 앞에서 '과분한데'라고 했을 때. 그때부터 좀 신경 쓰였어.
...
- 캐릭터: `seyoun_shy2.png`
**{name}**: *서연이 새끼손가락을 건넨다. 첫날에 봤던 그 새끼손가락. — 그때는 습관인 줄 알았는데, 이게 서연의 약속 방식이었다.*
...
- 캐릭터: `dain_shy.png`
**{name}**: *다인이 그대로 멈춘다. 웃음이 빠진 얼굴 위로 눈빛만 천천히 젖는다. 두 손으로 얼굴을 덮어버린다.*
...
- 캐릭터: `seyoun_sad.png`
**{name}**: *서연이 웃는다. — 평소의 여유가 아니다. 뒤에 뭔가 숨기는 웃음.*
...
- 캐릭터: `seyoun_cry.png`
**서연**: 칭찬받을 때마다 생각했어. — 이 웃음도 연습한 거라고. 진짜 나를 본 사람은 있었나.
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *서연이 말을 멈췄다. 손이 무릎 위에서 꽉 쥐어져 있다. — 그리고 천천히, 아주 천천히, 완벽하게 유지하고 있던 표정이 무너졌다. 서연의 손끝이 떨린다.*
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *눈에서 물이 흘러내린다. 소리 없이. — 서연이 울고 있다. 서연이 올려다본다. 무너진 표정을 이제는 숨길 생각이 없는 얼굴이다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 웃는다. 입꼬리가 제멋대로다. — 화장이 번지고, 눈이 부었는데. 그 얼굴이 오래 남을 것 같다.*
...
- 캐릭터: `seyoun_shy.png`
**{name}**: *서연이 새끼손가락을 먼저 건넨다. 거기서 멈추지 않는다. 손을 잡는다. 이마에 입술을 댄다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *체육관 창문에 불이 켜져 있다. 비상등. 누군가 혼자 공을 튀기고 있다. — 등번호가 희미하게 보인다. 다인이다. ...밤 11시에 혼자 체육관에서? 오늘 나한테 연락은 없었는데.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *아무 말 없이 옆에 앉는다. 다인이 입을 다문다. 한참의 침묵. 한참의 침묵.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *그대로 옆에 앉아 있었다. 둘 다 말이 없다. — 다인 옆에서 이렇게 오래 조용한 건 처음이다.*
...
- 캐릭터: `dain_sad.png`
**{name}**: *알람 메모에 느낌표를 두 개나 넣은 건 — 하나로는 자기 자신도 못 속이기 때문이겠지. 다인의 울음이 잦아들 때까지 옆에 있었다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나다. 혼자 앉아 있다. 발이 그 자리에서 멈춘다. 유나에게서 오늘 메시지는 없었다. — 미안하다.*
...
- 캐릭터: `yuna_normal.png`
**{name}**: *유나가 도서관 별관으로 향한다. 비밀 독서 공간을 지나 — 더 안쪽. 지하 자료실. 먼지가 쌓인 서가 사이. 유나가 오래된 봉투를 꺼낸다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 옷소매를 꽉 쥐고 있다. — 문장이 점점 길어지고 있다. 유나가 잠깐 멈춘다.*
...
- 선택지:
  ...
  2. "선배 얘기는 잠깐 접자. 지금은 네가 나한테 한 얘기를 듣고 싶어." → `wall_yuna_sub_1` | Yuna +3
  3. "...그래서 나한테 접근한 거야? 선배 대신?" → `wall_yuna_reject_1` | Yuna -10

- 캐릭터: `yuna_sad.png`
**{name}**: *유나 눈가가 살짝 젖어 있다. — 유나가 이렇게 많이 말하는 건 처음이다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 문장 네 개를 끊지 않고 말했다. 그만큼 힘을 낸 거다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 숨을 천천히 내쉰다. 옷소매를 쥔 손끝이 조금 떨린다.*
...
- 캐릭터: `yuna_sad.png`
**{name}**: *유나가 돌아선다. 걸음이 빠르다. — 뛰는 건 아닌데, 뛰고 싶은 사람의 걸음이다. 최악의 선택이었다. — 유나의 벽이 다시 닫히는 소리가 들린다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *교문 앞 가로등 아래. 서연이 서 있다. — 아니, 서 있었다. 핸드폰을 들고 뭔가를 치다가 지운다. 치다가 지운다. 누구한테 보내려는 건지는 모르겠다. — 아니, 알 것 같다.*
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 핸드폰을 주머니에 넣고 돌아선다. 등이 곧다. 완벽하게. — 떨리지 않는다. 이번에는 진짜로. 선택하지 않은 사람에게도 밤은 온다. 그 밤을 혼자 보내고 있다.*
...
- 캐릭터: `없음`
**{name}**: *...오늘 말했어야 했다. 그 사람이 먼저 마음을 내밀고 있었는데, 나는 또 가장 쉬운 말을 못 했다. 내일이 있다고 해서 오늘이 지워지는 건 아니다. 그걸 알면서도, 나는 또 미뤘다.*
...
- 캐릭터: `없음`
**{name}**: *교실에 들어서자마자 — 세 방향에서 신호가 온다. 마지막 이벤트. 지금까지 쌓아온 시간이 오늘로 모인다.*
...
- 캐릭터: `없음`
**{name}**: *도서관의 빈자리, 사라진 책갈피, 그리고 붙이지 않은 소설. — 유나는 흔적을 전부 지우고 있다. Day 3에 내가 남긴 공백이 여기까지 왔다.*
...
- 캐릭터: `없음`
**{name}**: *게시판에 단편소설이 붙어 있다. 제목: '도서관에서 만난 사람에게'. 유나다. — 주인공만 알아볼 수 있는 이야기. 붙임판 앞에 잠깐 더 서 있었다. 짧은 문장인데, 유나가 직접 얼굴을 들이민 것처럼 선명하다.*
...
- 캐릭터: `없음`
**{name}**: *마지막 문장. '그 사람이 눈을 떴을 때, 나는 이미 없었다. 쪽지만 남겼다. — 다음에도 여기 있을게.' 연보라색 잉크. Day 1 쪽지랑 같은 잉크다.*
...
- 배경: `room_school.png`
- 다음: `hidden_homeroom_d5_choice_b_b`
...
### `hidden_homeroom_d5_choice_b_b`
- 배경: `room_school.png`
- 다음: `hidden_homeroom_d5_choice_b_c`
...
### `hidden_homeroom_d5_choice_b_c`
- 배경: `room_school.png`
- 다음: `hidden_homeroom_d5_choice_b_d`
...
- 캐릭터: `teacher_normal.png`
**{name}**: *어제 카페에서 했던 말. 먼저 보여주고 싶다는 그 말. 진짜로 들고 왔다.*
...
- 캐릭터: `teacher_normal.png`
**{name}**: *한 줄. — 등단에 세 번 떨어진 사람이, 학생의 한 줄 감상을 기다리고 있다. 말보다 무거운 부탁이다. 담임이 교실을 나서다 — 문 앞에서 멈춘다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'졸업하면 놀러 와'에서 '아프면 와'로 후퇴했다. — 선을 넘으려다 다시 들어온 거다. 문이 열린다. 보건선생님이 서 있다. 손에 종이컵 두 개.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 나온다. 코앞이다. — 마주쳤다. 코앞에서.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *목소리가 한 톤 낮아졌다. 장난기가 사라진 얼굴. 보건선생님이 웃다가 — 멈춘다. 입을 다문다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *Day 1의 대표 대사. — 그때는 캐릭터 소개였다. 지금은 진심이다. 보건선생님이 밴드를 꺼내 내 손등에 붙인다. 천천히. — 밴드에 작은 글씨가 적혀 있다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'졸업하면 보건실 말고 카페에서 만나자 — ♡' 장난처럼 적은 문장인데, 이번에는 장난으로만 읽히지 않는다.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *화를 내면서도 웃고 있다. — 이게 다인이다. 지면서도 즐거운 사람. 다인이 배구공을 코트에 내려놓는다. 천천히.*
...
- 캐릭터: `seyoun_normal.png`
**서연**: 뭐, 예상은 했어. 넌 처음부터 내 계산대로 안 움직였으니까.
...
- 캐릭터: `seyoun_normal.png`
**{name}**: *서연이 돌아서며 손을 흔든다. — Day 1과 같은 동작이다. 뒤돌아보지 않는다. 등이 곧다. 완벽하게. — 근데 이번에는, 떨리지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *교문 앞. 멀리서 세 사람이 보인다. 서연이 하은과 걸어가고, 다인이 배구공을 던지며 뛰어가고, 유나가 책을 읽으며 천천히 걷는다. 아무도 이쪽을 보지 않는다. — 그게 오히려 다행이다. 지금은 누구하고도 눈을 마주칠 자신이 없다.*
...
- 캐릭터: `없음`
**{name}**: *해가 지고 있다. 5일이 끝나간다. 석양이 교정을 물들인다. 5일이라는 시간이 이렇게 짧았나. — 마지막 선택의 순간이 다가온다.*
...
- 캐릭터: `없음`
**{name}**: *또 도망칠 뻔했다. 전 학교에서처럼. 핸드폰을 주머니에 넣고 아무 말 못 하는 그 순간이 다시 올 뻔했다. — 안 된다. 이번에는. 다리가 움직인다. 입이 먼저 열린다. 준비한 말 같은 건 없다. — 그냥 몸이 먼저 움직인다.*
...
- 캐릭터: `없음`
**{name}**: *유나가 멈춘다. 책을 품 쪽으로 끌어안는다. 돌아보는 데 2초쯤 걸린다.*
...
- 캐릭터: `없음`
**{name}**: *이번에는 도망치지 않았다. 말이 입 밖으로 나왔다.*
...
- 캐릭터: `dain_laugh.png`
**다인**: *학교를 나서며.* 야, 진짜?! ...진짜? 나 기다리긴 했어. — 근데 기다렸다고 바로 웃으면 억울하지. 이번엔 끝까지 말해.
...
- 캐릭터: `없음`
**{name}**: *모른 척하고 넘기려 했던 말이 결국 입 밖으로 나온다. 하나를 고르지 못하겠다고. 비겁한 말이라는 걸 알면서도, 오늘은 그 대가까지 같이 안기로 한다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *이건 비밀이다. 우리만의. — 졸업장보다 이 꽃다발이 더 무겁다.*
...
- 캐릭터: `없음`
**보건선생님**: *손이 올라와 넥타이를 잡는다. 놓지 않는다.* ...오늘은 안 돌려보낼 거야.
...
- 캐릭터: `없음`
**{name}**: *연두색 노트는 서랍 깊숙이 들어갔다. 마지막 페이지에 적힌 건 편지가 아니라 한 줄. '유진아, 나 이제 괜찮아.' — 3년 만의 마침표.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *목소리가 한 톤 낮아졌다. 장난기가 사라지고, 커피잔을 쥔 손이 멈춘다.*
...
- 캐릭터: `없음`
**{name}**: *병을 쥔 손이 멈춘다. 보건실 서랍 속 연두색 노트가 떠오른다. 언젠가 그 편지의 마지막 장을 이 사람이 닫을 수 있기를.*
...
- 캐릭터: `seyoun_cry.png`
**{name}**: *또 울고 있다. 화장실이 아니라 — 이번에는 내 앞에서.*
...
- 캐릭터: `없음`
**{name}**: *매일 아침 같은 길을 걸었다. 5일이라고 하기엔, 서연 옆에서 배운 표정이 너무 많았다.*
...
- 캐릭터: `없음`
**{name}**: *고백은 했다. 서연도 해보자고 했다. 하지만 서연의 '좋아'에는 물음표가 붙어 있었다. — 한 달쯤 지나서, 학교 앞 카페에서 만나자는 연락이 왔다.*
...
- 캐릭터: `없음`
**{name}**: *카페를 나왔다. 비가 내린다. 우산은 하나였는데 — 이제 두 개가 됐다.*
...
- 캐릭터: `seyoun_shy.png`
**서연**: 항상 웃어야 했어. 근데 너 앞에선 표정 안 골라도 될 것 같아.
...
- 캐릭터: `없음`
**{name}**: *5일이었다. 서연의 완벽함 뒤에 숨은 진짜를 알게 된.*
...
- 캐릭터: `없음`
**{name}**: *유나가 자리에서 일어나 안겼다. 아무 말 없이. 깨진 창문 사이로 들어온 빛이 바닥에 길게 놓이고, 유나의 팔이 조심스럽게 허리를 감쌌다. 오래 참은 숨이 어깨 근처에서 천천히 풀렸다.*
...
- 캐릭터: `없음`
**{name}**: *매일 같은 자리에 앉았다. 5일이라고 하기엔, 유나와 나눈 침묵의 결이 너무 달랐다.*
...
- 캐릭터: `없음`
**{name}**: *고백은 했다. 유나도 끄덕였다. 하지만 그 끄덕임은 확신이 아니라 시도에 가까웠다. — 한 달쯤 지나서, 쪽지가 하나 사물함에 들어 있었다. '얘기 좀 하자.'*
...
- 캐릭터: `없음`
**{name}**: *5일이었다. 유나의 침묵 속에 감춰진 말들을 읽게 된.*
...
- 캐릭터: `없음`
**{name}**: *무릎이 아픈 날에도 다인은 자기 속도를 다시 고른다. 내가 그 옆에서 같이 뛰면, 그걸로 충분했다.*
...
- 캐릭터: `없음`
**{name}**: *고백은 했다. 다인은 웃으면서 좋다고 했다. 하지만 그 웃음은 늘 하던 것과 같은 종류였다. — 한 달쯤 지나서, 체육관 앞에서 기다리자는 문자가 왔다.*
...
- 캐릭터: `없음`
**{name}**: *체육관을 나왔다. 비가 내린다. — 느낌표가 돌아왔지만 마지막 문장엔 마침표였다.*
...
- 캐릭터: `없음`
**{name}**: *다인이 {name}의 손을 잡아 자기 손목 안쪽에 올린다. 아무 말 없이.*
...
- 캐릭터: `dain_normal.png`
**{name}**: *말이 나오지 않는다. 입술이 살짝 벌어진 채 멈춰 있다.*
...
- 캐릭터: `dain_laugh.png`
**{name}**: *느낌표가 돌아왔다. 이번에는 숨기려고 붙인 게 아니었다.*
...
- 캐릭터: `없음`
**{name}**: *5일이었다. 다인의 느낌표 뒤에 가려진 마음을 듣게 된.*
...
- 캐릭터: `없음`
**{name}**: *방 안이 이상할 만큼 조용하다. 아까까지 귓가에 남아 있던 목소리들도, 문 닫히는 소리와 함께 멀어진다. 창밖으로 벚꽃이 진다. 5일 전에 코끝을 스쳤던 그 벚꽃이 지금은 바람에 날려 사라지고 있다.*
...
- 캐릭터: `없음`
**{name}**: *깔끔한 결말은 아니어도, 여기서부터 다시 시작할 수는 있다.*
...
- 캐릭터: `없음`
**{name}**: *벚꽃길 끝을 지나 천천히 걸어 나가며 생각했다. 다음 약속을 잡고 싶다. 이번엔 그렇게 말할 수 있었다.*
...
- 캐릭터: `없음`
**{name}**: *서연의 문자가 온다. '내일 옥상 열쇠 복사해 놨어. — 허가야, 허가.' 초대라고 하면 될 걸.*
...
- 캐릭터: `없음`
**{name}**: *이 사람은 마지막까지 여유로운 척하면서 — 열쇠를 건네는 식으로 마음을 준다.*
...
- 캐릭터: `없음`
**{name}**: *열쇠를 주머니에 넣었다. 내일 옥상에서 — 이번에는 내가 도시락을 싸 갈 차례다.*
...
- 캐릭터: `없음`
**{name}**: *가방 안에서 접힌 쪽지가 나온다. 언제 넣은 건지 모르겠다. '1권 다 읽었으면 2권 빌려줄게. — 유나'*
...
- 캐릭터: `없음`
**{name}**: *유나는 말 대신 다음을 준비한다. 1권 다음에 2권. 오늘 다음에 내일. 다음 약속을 그렇게 남긴다.*
...
- 캐릭터: `없음`
**{name}**: *다인에게서 메시지. '내일 아침 운동 같이 할 사람?' 끝에 물음표가 붙어 있다. 평소 같으면 느낌표였을 텐데.*
...
- 캐릭터: `없음`
**{name}**: *거절당할 수도 있다는 걸 처음으로 신경 쓴 거다. 다인이 물음표를 쓰는 건 — 용기다.*
...
- 캐릭터: `없음`
**{name}**: *답장을 보냈다. '콜.' 느낌표는 안 붙였다. 대신 내일 직접 달려갈 거니까.*
...
- 캐릭터: `없음`
**{name}**: *교문을 나서는데 핸드폰에 메시지가 와 있다. '오늘 고마웠어 ㅋㅋ' — 편한 말투다. 그래서 더 친구 같다.*
...
- 캐릭터: `없음`
**{name}**: *교문을 나서는데 핸드폰에 메시지가 와 있다. '야 조심히 가! 오늘 고마웠다!' 느낌표가 돌아왔다. 다행인데 — 마음은 더 가라앉는다. 친구한테 보내는 느낌표라서.*
...
- 캐릭터: `없음`
**{name}**: *좋다는 말만으로는 관계를 감당할 수 없다는 걸, 한참 지나서야 알았다.*
...
- 캐릭터: `없음`
**{name}**: *소정이 때는 침묵했다. 이번에는 모두에게 같은 말을 꺼냈다. 방식은 달랐지만, 결국 누구에게도 제대로 말하지 못했다.*
...
- 캐릭터: `없음`
**{name}**: *유나가 고개를 숙였다. 한참 뒤에 올려다봤을 때는, 웃는 법을 잠깐 잊은 얼굴이었다. 손끝이 책등을 세게 누르고 있다.*
...
- 캐릭터: `없음`
**{name}**: *다인이 주먹으로 내 어깨를 쳤다. 아팠다. "야, 진짜 최악이다." 그 말이 맞았다. 다인은 웃지 않았다.*
...
- 캐릭터: `없음`
**{name}**: *월요일은 서연. 수요일은 유나. 금요일은 다인. 핸드폰 캘린더가 지뢰밭이다. 월요일에 수요일 이름을 부르면 끝이다.*
...
- 캐릭터: `없음`
**{name}**: *서연이 "수요일 뭐 해?"라고 물었을 때 한 박자 늦게 숨을 쉬었다. 수요일은 유나 날이다.*
...
- 캐릭터: `없음`
**{name}**: *3개의 알람, 3개의 페르소나, 3개의 거짓말. — 이걸 행복이라고 부르기엔, 위 경련이 너무 잦다.*

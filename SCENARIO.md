...
**{name}**: *교탁 앞에 담임선생님이 서 있다. 20대 후반. 가디건 단추 몇 개가 풀려 있고, 출석부를 들고 있다.*
...
- 캐릭터: `yuna_normal.png`
**유나**: *도서관 별관으로 향해 걸어간다. 비밀 독서 공간을 지나 — 더 안쪽. 지하 자료실. 먼지가 쌓인 서가 사이. 오래된 봉투를 꺼낸다.*
...
- 캐릭터: `없음`
**{name}**: *말할 수 있었던 순간은 있었다. 그때마다 다른 말을 골랐다.*

...
- 캐릭터: `seyoun_normal.png`
**{name}**: *웃음이 짧게 샌다. 서연은 이미 교문 안쪽으로 걸음을 옮긴 뒤다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *시선을 돌리니, 창가 맨 뒤쪽에 한 여학생이 턱을 괸 채 창밖만 본다. 내 이름이 칠판에 적히는 동안에도 책장만 한 장 넘어간다.*
...
- 캐릭터: `yuna_bored.png`
**{name}**: *유나 쪽을 보자, 시선은 여전히 창밖이다. 손끝만 책상 아래로 내려가 있다. 방금 전 쪽지가 있던 방향이다.*
...
- 캐릭터: `yuna_bored.png`
**유나**: *창밖에서 시선을 돌려 잠깐 {name} 쪽을 본다. 곧 다시 창밖을 본다.*
...
- 캐릭터: `nurse_normal.png`
**보건선생님**: *청진기를 만지는 손끝이 노트 서랍 쪽으로 가려다 멈춘다.*
...
- 캐릭터: `seyoun_sad.png`
**서연**: *천천히 고개를 든다. 손등으로 화장 자국을 문지른다.*
...
- 캐릭터: `teacher_shy.png`
**담임선생님**: *주머니에서 손을 뺀다. 손끝이 잠깐 허공에서 멈춘다.*

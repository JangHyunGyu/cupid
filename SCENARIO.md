...
- 컨텍스트: "4일차 밤, 주인공이 유나의 제안을 수락해 별관 독서실에 둘만 남았다. 바로 전 유나가 한 손으로 책장을 짚고 재킷을 흘린 뒤 상의 목깃을 끌어내려 맨어깨와 가슴 쪽을 드러낸 채 바로 앞에 서 있다. 그 거리는 아직 그대로다. 지금 주고받는 말과 행동에 따라 호감이 더 깊어지거나 상할 수 있다."
- 성격: "짧은 말과 자연스러운 여백으로 마음을 전하며 목깃을 내린 채 바로 앞에 선 그 자세에서 잇는다. 그 접촉을 부정하지 않는다."

- 캐릭터: `없음`
**유나**: *목깃을 내린 손을 거두지 않는다.* 가면… 그때랑 같아질 것 같아서.
...
- 타입: `free_talk`
- 다음: `day4_temptation_return_home`
- 컨텍스트: "4일차 밤, 주인공이 서연의 제안을 수락해 옥상에 둘만 남았다. 바로 전 서연이 주인공의 손목을 잡아 자기 맨가슴 위에 손을 얹고 그 위를 덮었다. 그 손은 아직 그 자리에 있다. 지금 주고받는 말과 행동에 따라 호감이 더 깊어지거나 상할 수 있다."
- 성격: "차분한 말투에 솔직한 호감을 드러내고 방금 손을 가슴에 올린 그 자세에서 대화를 잇는다. 그 접촉을 부정하지 않는다."

- 캐릭터: `없음`
**서연**: *잡은 손을 가슴 위에서 풀지 않는다.* 지금은 이렇게. 빼지 마.
...
- 타입: `free_talk`
- 다음: `day4_temptation_return_home`
- 컨텍스트: "4일차 밤, 주인공이 다인의 제안을 수락해 체육관에 둘만 남았다. 바로 전 다인이 유니폼 앞자락을 아래로 당긴 채 바로 앞까지 몸을 숙였다. 그 거리는 아직 그대로다. 지금 주고받는 말과 행동에 따라 호감이 더 깊어지거나 상할 수 있다."
- 성격: "다인다운 장난과 솔직함으로 먼저 말을 걸고 유니폼을 당긴 채 숙인 그 거리에서 잇는다. 그 접촉을 부정하지 않는다."

- 캐릭터: `없음`
**다인**: *유니폼 앞자락을 잡은 채 숙인 거리를 유지한다.* 숨 막히지? 잠깐만 이렇게 있어 봐.

...
- 캐릭터: `dain_laugh.png`
**{name}**: *아침 8시에 이 정도 텐션이면, 종례 전엔 배터리가 나갈 것 같다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 밴드 포장지를 접다 말고 나를 본다.*
...
- 캐릭터: `없음`
**{name}**: *복도로 돌아왔다. 서연의 연습한 웃음, 유나가 두고 간 물 자국. — 아무 말 안 한 쪽이 더 오래 남는다.*
...
- 캐릭터: `yuna_shy.png`
**{name}**: *유나가 내 쪽을 보지 못한 채 옷소매를 꽉 쥔다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 잠깐 멈춘다. 웃음이 먼저 사라진다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *'졸업하고'. 지금은 닫힌 말인데, 이상하게 약속처럼 남는다.*
...
- 캐릭터: `nurse_normal.png`
**{name}**: *보건선생님이 웃다가 멈춘다. 안경 너머 시선이 잠깐 흔들린다.*
...
- 캐릭터: `teacher_shy.png`
**{name}**: *그 '다음'이 몇 번 더 이어졌다. 목요일마다 같은 자리. 카페 직원이 '커플석이에요?' 묻던 날, 둘 다 커피만 내려다봤다. 그다음 목요일엔 카페 대신 거리를 걸었다.*
...
- 캐릭터: `없음`
**{name}**: *다인은 스포츠 해설가가 됐다. 카메라 앞에서도 웃고 있다. 이번엔 말끝에 힘을 주지 않는다.*
...
- 캐릭터: `없음`
**{name}**: *서연이 "수요일 뭐 해?"라고 물었을 때, 답장창에 손가락이 멈췄다.*

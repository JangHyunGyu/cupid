...
try {
    ...
    if (promptVersion !== '2.7.73') {
        errors.push('[FREETALK_PROMPT] 메인 프롬프트 캐시 버전이 2.7.73이 아님: ' + promptVersion);
    }
    if (galleryPromptVersion !== '2.7.65') {
        errors.push('[FREETALK_PROMPT] 갤러리 프롬프트 캐시 버전이 2.7.65가 아님: ' + galleryPromptVersion);
    }
...
const endingTests = [
    // 메인 3인 PERFECT (100)
    { name: '서연 PERFECT', flags: { day4_confession_accepted: true, route_seoyeon: true, met_seoyeon: true }, stats: { Seoyeon: 100 }, expect: ['perfect_epilogue_4_seo'] },
    { name: '유나 PERFECT', flags: { day4_confession_accepted: true, route_yuna: true, met_yuna: true }, stats: { Yuna: 100 }, expect: ['perfect_epilogue_4_yuna'] },
    { name: '다인 PERFECT', flags: { day4_confession_accepted: true, route_dain: true, met_dain: true }, stats: { Dain: 100 }, expect: ['perfect_epilogue_4_dain'] },
    // 메인 3인 TRUE (60~99)
    ...
    // 담임 4종
    { name: '담임 PERFECT', flags: { homeroom_day5: true }, stats: { Teacher: 100 }, expect: ['hidden_perfect_homeroom_ep4'] },
    ...
    // 보건 4종
    { name: '보건 PERFECT', flags: { nurse_day5: true }, stats: { Nurse: 100 }, expect: ['hidden_perfect_nurse_ep4'] },

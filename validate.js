...
try {
    ...
    if (promptVersion !== '2.7.54') {
        errors.push('[FREETALK_PROMPT] 메인 프롬프트 캐시 버전이 2.7.54가 아님: ' + promptVersion);
    }
    if (galleryPromptVersion !== '2.7.55') {
        errors.push('[FREETALK_PROMPT] 갤러리 프롬프트 캐시 버전이 2.7.55가 아님: ' + galleryPromptVersion);
    }

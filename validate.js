...
try {
    ...
    if (promptVersion !== '2.7.66') {
        errors.push('[FREETALK_PROMPT] 메인 프롬프트 캐시 버전이 2.7.66이 아님: ' + promptVersion);
    }
    if (galleryPromptVersion !== '2.7.62') {
        errors.push('[FREETALK_PROMPT] 갤러리 프롬프트 캐시 버전이 2.7.62이 아님: ' + galleryPromptVersion);
    }

...
(function () {
    // 로더 설정 로드 (동기)
    document.write('<script src="assets/js/loaders/config.js?v=2.9.179" onerror="window.__cupidShowGalleryLoadError && window.__cupidShowGalleryLoadError()"><\/script>');
})();

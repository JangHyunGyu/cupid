...
Object.assign(SCENARIO[2], {
    ...
    "day2_night_message_seyoun_reply": {
        name: "서연",
        text: "(지리릭— 즉각적인 답장.) '나도 정말 즐거웠어! {name?} 덕분에 든든해. 내일 점심 같이 먹는 거 잊지 마! 잘 자.'",
        night: true,
    ...
    "day2_night_message_nurse": {
        name: "나",
        text: "(양호선생님께 메시지를 보냈다. '선생님, 오늘 감사했어요. 덕분에 푹 잤어요.')",
        night: true,
        next: "day2_night_message_nurse_reply"
    },
    "day2_night_message_nurse_reply": {
        name: "양호선생님",
        text: "(매혹적인 답장.) '어머, 벌써 내 생각 하는 거니? 후훗, 오늘 푹 쉬고 내일 또 얼굴 보자. 잘 자, {name?}.'",
        night: true,

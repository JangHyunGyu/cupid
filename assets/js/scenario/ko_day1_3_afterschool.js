/**
 * ============================================================================
 * CUPID - Day 1 After School Scenario (Korean Version)
 * ============================================================================
 * 
 *  파일 정보
 * ----------------------------------------------------------------------------
 * 파일명: ko_day1_3_afterschool.js
 * 언어: 한국어 (Korean)
 * 일차: Day 1 (1일차)
 ...
 *  시나리오 개요
 * ----------------------------------------------------------------------------
 * 수업이 끝난 후 노을 지는 학교에서의 다양한 활동을 다룹니다.
 * 주인공이 학교를 둘러보며 히로인들과 심화된 대화를 나누고, 
 * 본격적으로 연락처를 교환하거나 특별한 이벤트를 겪게 되는 중요한 시간대입니다.
 * 
 *  주요 이벤트
 * ----------------------------------------------------------------------------
 * 1. 학생회실 (서연) - 서류 정리 돕기 및 카페 데이트, 연락처 교환
 * 2. 도서관 별관 (유나) - 옥상에서의 비밀 공유 및 영혼에 대한 대화
 * 3. 체육관 (다인) - 배구 연습 응원 또는 직접 돕기, 털털한 다인과의 교감
 * 4. 교무실 (선생님) - 개별 면담 및 자연스러운 연락처 교환
 * 5. 보건실 (보건샘) - 치료 및 묘한 기류 형성
 * 
 *  조건 플래그 설명 (Condition Flags)
 * ----------------------------------------------------------------------------
 * met_yuna             : 점심시간에 유나와 만났는지 여부
 * met_dain             : 점심시간에 다인과 만났는지 여부
 * met_nurse            : 점심시간에 보건샘과 만났는지 여부
 * knows_name_yuna      : 유나의 이름을 알고 있는지 여부
 * knows_name_dain      : 다인의 이름을 알고 있는지 여부
 * has_number_seyoun    : 서연의 연락처를 이미 가지고 있는지 여부
 * has_number_teacher   : 선생님의 연락처를 이미 가지고 있는지 여부
 * 
 *  설정 플래그 설명 (Set Flags)
 * ----------------------------------------------------------------------------
 * helped_seoyeon       : 서연의 학생회 업무를 도와주었을 때 설정
 * has_number_seyoun    : 서연의 연락처를 획득했을 때 설정
 * has_number_teacher   : 선생님의 연락처를 획득했을 때 설정
 * has_number_yuna      : 유나의 연락처를 획득했을 때 설정
 * has_number_dain      : 다인의 연락처를 획득했을 때 설정
 * has_any_contact      : 첫 연락처를 획득했을 때 설정 (모든 히로인 공통)
 * 
 *  호감도 변화 (Stats Changes)
 * ----------------------------------------------------------------------------
 * 각 히로인별 선택지에 따라 대폭 상승 또는 하락 (특히 서연, 유나, 다인 루키)
 * 
 *  특이 사항
 * ----------------------------------------------------------------------------
 * - sunset: true - 장면 연출 시 노을 효과를 적용하기 위한 속성
 * 
 * ============================================================================
 */

 ...
 *  시나리오 개요
 * ----------------------------------------------------------------------------
 * 전학 첫날 방과가 끝난 후의 활동을 다룹니다. 학교 곳곳을 자유롭게 탐색하며
 * 히로인들의 방과 후 활동에 참여하거나, 담임 선생님과의 면담, 또는 바로 귀가하는 
 * 경로를 선택할 수 있습니다. 각 장소에서의 활동과 호감도가 이후 연락처 확인 
 * 이벤트에 큰 영향을 미칩니다.
 * 
 *  주요 이벤트
 * ----------------------------------------------------------------------------
 * 1. 장소 선택 - 학생회실(서연), 도서관(유나), 체육관(다인), 보건실(보건샘), 교무실(담임), 귀가
 * 2. 서연의 학생회 업무 - 서류 정리 돕기, 카페 데이트 제안, 연락처 교환
 * 3. 유나의 도서관 별관 - 학교의 진실에 대한 경고, 유나와의 도서 교감, 연락처 교환
 * 4. 다인의 배구부 연습 - 스파이크 돕는 연습 참가(체력 중시), 떡볶이 데이트, 연락처 교환
 * 5. 보건 선생님/담임 선생님 - 면담 및 사적인 대화, 연락처 교환 기회
 * 6. 하교 및 하루의 마무리 - 방과 마무리와 내일에 대한 의식
 * 
 ...
 * dated_*_day1         : 방과 후 특정 히로인과 데이트(카페 등)했음을 기록
 ...
 *  특이 사항
 * ----------------------------------------------------------------------------
 * - sunset: true - 방과 후 노을 분위기 연출을 위한 석양 배경 속성
 * - excludeCondition: 특정 조건을 만족하지 않을 때만 실행하는 분기 활용
 * 
 * ============================================================================
 */

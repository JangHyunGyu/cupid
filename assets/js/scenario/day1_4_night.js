...
(() => {
    ...
    "forced_violation_day1_after_seoyeon": {
        ...
        "choices": [
            { "next": "forced_violation_day1_seoyeon_apologize" },
            { "next": "forced_violation_day1_seoyeon_excuse" }
        ]
    },
    "forced_violation_day1_seoyeon_apologize": {
        "inheritVisualContext": true,
        "next": "forced_violation_day1_resume"
    },
    ...
    "forced_violation_day1_after_yuna": {
        ...
        "inheritVisualContext": true,
        "choices": [
            { "next": "forced_violation_day1_yuna_apologize" },
            { "next": "forced_violation_day1_yuna_excuse" }
        ]
    },
    ...
    "forced_violation_day1_after_dain": {
        ...
        "inheritVisualContext": true,
        "choices": [
            { "next": "forced_violation_day1_dain_apologize" },
            { "next": "forced_violation_day1_dain_excuse" }
        ]
    },
    ...
    "forced_violation_day1_after_teacher": {
        ...
        "inheritVisualContext": true,
        "choices": [
            { "next": "forced_violation_day1_teacher_apologize" },
            { "next": "forced_violation_day1_teacher_excuse" }
        ]
    },
    ...
    "forced_violation_day1_after_nurse": {
        ...
        "inheritVisualContext": true,
        "choices": [
            { "next": "forced_violation_day1_nurse_apologize" },
            { "next": "forced_violation_day1_nurse_excuse" }
        ]
    },

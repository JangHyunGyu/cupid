 ...
 * ----------------------------------------------------------------------------
 * met_*                : �ش� �������� �̹� �������� ���� (�ʸ�/���� ��� �б�)
 * day2_ate_lunch_seoyeon: ������ ��� ������ �Ծ����� Ȯ�� (�������� ���� ���� �� Ȱ��)
 * has_number_*         : ����ó ���� ���ο� ���� ����ó ��ȯ ���� �б�
 * 
 *  ���� �÷��� ���� (Set Flags)
 * ----------------------------------------------------------------------------
 * met_* / knows_name_* : �����ΰ��� ù ���� �� �̸� ȹ�� ���
 * day2_ate_lunch_seoyeon: ������ ������ �Ծ����� ���
 * visited_warehouse_at_lunch: ������ â���� �湮������ ���
 * day2_met_*_lunch     : ���ɽð��� Ư�� �����ΰ� �ð��� �������� ���
 * invited_nurse_home   : ���� �����Կ��� ������ �ʴ�޾����� ��� (Ư�� �̺�Ʈ)
 * 
 *  ȣ���� ��ȭ (Stats Changes)
 * ----------------------------------------------------------------------------
 * �������� ���� �� �����ΰ��� ȣ������ ũ�� ���� (Ư�� ���ڴ�� ��Ȳ ����)
 ...
 *  Ư�� ����
 * ----------------------------------------------------------------------------
 * - ���ǽ� ��Ʈ: `sunset: true` �Ӽ��� ���� ���ɽð����� �ٷ� ��� ��(����)�� �ð��� ��ȯ
 * - type: "free_talk": ����, ����, ���� �����԰��� �ɵ� ���� ��ȭ�� ���� AI ��� Ȱ��
 * 
 * ============================================================================
 */

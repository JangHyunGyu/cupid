 * ----------------------------------------------------------------------------
 * personality_*         : ?§Ï†Ñ ?êÍ∏∞?åÍ∞ú?êÏÑú ?†ÌÉù???±Í≤©???∞Î•∏ ?Ä??Î∂ÑÍ∏∞
 * knows_name_nurse     : Î≥¥Í±¥ ?†ÏÉù???¥Î¶Ñ???¥Î? ?åÍ≥† ?àÎäîÏßÄ ?ïÏù∏
 * 
 *  ?§Ï†ï ?åÎûòÍ∑??§Î™Ö (Set Flags)
 * ----------------------------------------------------------------------------
 * met_*                : ?πÏ†ï ?àÎ°ú?∏Í≥º Ï≤òÏùå ÎßåÎÇ¨?åÏùÑ Í∏∞Î°ù
 * knows_name_*         : ?àÎ°ú?∏Ïùò ?¥Î¶Ñ???åÍ≤å ??
 * ate_lunch_seoyeon    : ?úÏó∞Í≥??êÏã¨??Î®πÏóà?åÏùÑ Í∏∞Î°ù (?∞ÎùΩÏ≤?ÍµêÌôò Ï°∞Í±¥)
 * has_number_seyoun    : ?úÏó∞???∞ÎùΩÏ≤òÎ? ?çÎìù??
 * has_any_contact      : ÏµúÏÜå ??Î™??¥ÏÉÅ???∞ÎùΩÏ≤òÎ? ?ïÎ≥¥??
 * 
 *  ?∏Í∞ê??Î≥Ä??(Stats Changes)
 * ----------------------------------------------------------------------------
 * Î™®Îì† ?àÎ°ú?∏Îì§???Ä???†ÌÉùÏßÄ???∞Îùº ?∏Í∞ê???ÅÏäπ/?òÎùΩ Í∞Ä??(?úÏó∞ ?∞ÎùΩÏ≤?ÍµêÌôò Ï£ºÏùò)
 * 
 *  ?πÏù¥ ?¨Ìï≠
 * ----------------------------------------------------------------------------
 * - affinityChar & affinityBranches: ?πÏ†ï ?†ÌÉùÏßÄÍ∞Ä ?∏Í∞ê???òÏπò???∞Îùº Í≤∞Í≥ºÍ∞Ä ?¨ÎùºÏß?
 * - type: "free_talk": ?†ÎÇò Î∞?Î≥¥Í±¥ ?†ÏÉù?òÍ≥º??Ï≤??Ä?îÎ? ?ÑÌïú AI Î™®Îìà ?úÏö©
 * 
 * ============================================================================
 */

// SCENARIO ?ÑÏó≠ Í∞ùÏ≤¥ Ï¥àÍ∏∞??
if (typeof SCENARIO === 'undefined') {
    var SCENARIO = {};
}

// Day 1 ?úÎÇòÎ¶¨Ïò§ Í∑∏Î£π Ï¥àÍ∏∞??
if (!SCENARIO[1]) {
    SCENARIO[1] = {};
}

 ...
 * 첫 만남, 체육관에서의 다인과의 만남, 보건실 방문 등 주요 히로인들과의 첫 접점을
 * 형성하는 중요한 시나리오입니다.
 * 
 *  주요 이벤트
 * ----------------------------------------------------------------------------
 * 1. 서연과의 옥상 점심 - 직접 만든 도시락 취식, '김' 이벤트(호감도 기반), 연락처 교환
 * 2. 도서관 별관 탐험 (유나) - 신비로운 분위기의 유나와 첫 대화, 학교의 비밀 암시
 * 3. 체육관 배구 연습 (다인) - 배구부 다인과 만나 함께 활동하며 친해지는 활동적인 루트
 * 4. 보건실 방문 (보건샘) - 매혹적인 보건 선생님과의 만남 및 자유 대화
 * 5. 매점 방문 및 교실 복귀 - 각 캐릭터(선생님, 서연)와의 짧은 조우 및 호감도 변화
 * 
 *  조건 플래그 설명 (Condition Flags)
 * ----------------------------------------------------------------------------
 * personality_*         : 이전 자기소개에서 선택한 성격에 따른 대사 분기
 * knows_name_nurse     : 보건 선생님의 이름을 이미 알고 있는지 확인
 * 
 *  설정 플래그 설명 (Set Flags)
 * ----------------------------------------------------------------------------
 ...
 * - type: "free_talk": 유나 및 보건 선생님과의 깊은 대화를 위한 AI 모듈 활용
 * 
 * ============================================================================
 */

...
(() => {
    ...
    "day4_nurse_checkin": {
        "background": "assets/images/background/school.png",
        "character": null,
        "next": "day4_adult_nurse_student_rank"
    },
    ...
    "day4_adult_teacher_student_rank": {
        "rankedRivalBranches": [
            {
                "character": "Seoyeon",
                "next": "day4_teacher_seoyeon_counteroffer"
            },
            {
                "character": "Dain",
                "next": "day4_teacher_dain_counteroffer"
            },
            {
                "character": "Yuna",
                "next": "day4_teacher_yuna_counteroffer"
            }
        ],
    ...
    "day4_adult_nurse_student_rank": {
        "rankedRivalBranches": [
            {
                "character": "Seoyeon",
                "next": "day4_nurse_seoyeon_counteroffer"
            },
            {
                "character": "Dain",
                "next": "day4_nurse_dain_counteroffer"
            },
            {
                "character": "Yuna",
                "next": "day4_nurse_yuna_counteroffer"
            }
        ],
        "rankedRivalFallback": "day4_student_night_branch",
        "routeBeforeRender": true
    ...
    "day4_teacher_seoyeon_counteroffer": {
        ...
        "choices": [
            ...
            },
            {
                ...
                "setFlags": [
                    "day4_took_seoyeon_counteroffer",
                    "day4_counteroffer_target_teacher",
    ...
    "day4_nurse_seoyeon_counteroffer": {
        ...
        "choices": [
            ...
            },
            {
                ...
                "setFlags": [
                    "day4_took_seoyeon_counteroffer",
                    "day4_counteroffer_target_nurse",
                    "day4_counteroffer_penalty_deferred"
                ]
            },
            {
    ...
    "wall_seo_1": {
        ...
        "routeBeforeRender": true,
        "affinityBranches": [{"minAffinity":60,"next":"wall_seo_pre_high_1"},{"minAffinity":0,"next":"wall_seo_pre_low_1"},{"minAffinity":-19,"next":"wall_seo_pre_low_1"},{"minAffinity":-100,"next":"wall_seo_skip"}]
    },
    "wall_seo_pre_high_1": {
        "background": "assets/images/background/room_my.png",
    ...
    "wall_seo_hug_choice": {
        ...
        "choices": [
            ...
            {
                "next": "wall_seo_overpromise_react",
                "stats": {
                    "Seoyeon": {
                        "affinity": -4
                    }
    ...
    "wall_seo_rival_rank": {
        ...
        "rankedRivalBranches": [
            ...
            {
                "character": "Yuna",
                "next": "wall_seo_yuna_tempt_1"
            }
        ],
        "rankedRivalFallback": "wall_seo_to_park",
        "routeBeforeRender": true
    },
    "wall_seo_glimpse_1": {
        "background": "assets/images/background/school_back.png",
    ...
    "wall_dain_1": {
        ...
        "affinityChar": "Dain",
        "routeBeforeRender": true,
        "affinityBranches": [{"minAffinity":60,"next":"wall_dain_pre_high_1"},{"minAffinity":0,"next":"wall_dain_pre_low_1"},{"minAffinity":-19,"next":"wall_dain_pre_low_1"},{"minAffinity":-100,"next":"wall_dain_skip"}]
    },
    ...
    "wall_dain_rival_rank": {
        ...
        "rankedRivalFallback": "wall_dain_4",
        "routeBeforeRender": true
    },
    "wall_dain_glimpse_1": {
        "background": "assets/images/background/school_back.png",
    ...
    "wall_yuna_1": {
        ...
        "affinityChar": "Yuna",
        "routeBeforeRender": true,
        "affinityBranches": [{"minAffinity":60,"next":"wall_yuna_pre_high_1"},{"minAffinity":0,"next":"wall_yuna_pre_low_1"},{"minAffinity":-19,"next":"wall_yuna_pre_low_1"},{"minAffinity":-100,"next":"wall_yuna_skip"}]
    },
    ...
    "wall_yuna_rival_rank": {
        ...
        "rankedRivalBranches": [
            ...
            {
                "character": "Dain",
                "next": "wall_yuna_dain_tempt_1"
            }
        ],
        "rankedRivalFallback": "wall_yuna_2",
        "routeBeforeRender": true
    },
    "wall_yuna_glimpse_1": {
        "background": "assets/images/background/school_back.png",

 ...
 *  ���� �÷��� ���� (Condition Flags)
 * ----------------------------------------------------------------------------
 * selectByHighestAffinity : ȣ������ ���� ���� ĳ���͸� �ڵ����� �����ϴ� ���� ����
 * sent_msg_day1_*      : 1���� �㿡 �޽����� ���´��� Ȯ�� (��� �б�)
 * has_number_*         : ����ó ���� ���ο� ���� ��ȭ ����ȭ
 * dated_dain_day1      : 1���� ��� �� ���ΰ� ����Ʈ�ߴ��� Ȯ��
 * 
 *  ���� �÷��� ���� (Set Flags)
 * ----------------------------------------------------------------------------
 * has_number_teacher   : ���� �������� ����ó�� ȹ����
 * has_any_contact      : �ּ� �� �� �̻��� ����ó�� Ȯ����
 * 
 *  ȣ���� ��ȭ (Stats Changes)
 * ----------------------------------------------------------------------------
 * ������ �����ΰ��� ��ȭ �������� ���� ȣ���� ���/�϶�
 ...
 *  Ư�� ����
 * ----------------------------------------------------------------------------
 * - selectByHighestAffinity: true - ��Ƽ ������ �ý����� �ٽ� ���� ��� Ȱ��
 * - day2_check_note: ���� ��Ʈ ������ ���� �ٽ� ���丮 Ʈ���� �̺�Ʈ
 * 
 * ============================================================================
 */

 ...
 *  ���� �÷��� ���� (Condition Flags)
 * ----------------------------------------------------------------------------
 * woke_up_in_nurse_room : ���ɽð� ���ǽ� ��ħ ���� Ȯ��
 * met_* / knows_name_* : ĳ���� �ν� ���� Ȯ��
 * visited_warehouse_at_lunch: ���ɽð� â�� �湮 ���� (��� �б�)
 * day2_met_*_lunch     : ���ɽð��� ���� ĳ���Ϳ��� �ð� Ȯ��
 * has_number_*         : ����ó ���� ���ο� ���� ��ȯ ���� ���͸�
 * 
 *  ���� �÷��� ���� (Set Flags)
 * ----------------------------------------------------------------------------
 * day2_met_*_after     : ��� �� Ư�� �����ΰ� �ð��� �������� ���
 * invited_nurse_home   : ���� �����Կ��� ������ �ʴ�޾����� ���
 * day2_teacher_date    : ���� �����԰� �ϱ� ����̺긦 ������ ���
 * 
 *  ȣ���� ��ȭ (Stats Changes)
 * ----------------------------------------------------------------------------
 * ��Ų�� �̺�Ʈ �� ���ڴ�� ��Ȳ������ ���ÿ� ���� ȣ���� ���� ����
 ...
 * ----------------------------------------------------------------------------
 * - sunset: true - ��� �� Ư���� ���� ���� ����
 * - Homeroom Teacher Reward: ȣ���� 70 �̻��� �ſ� ���� ���ǿ����� �߻��ϴ� ���� �̺�Ʈ
 * 
 * ============================================================================
 */

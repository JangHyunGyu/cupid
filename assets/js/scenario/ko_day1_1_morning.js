...
Object.assign(SCENARIO[1], {
    ...
    "teacher_free_talk": {
        ...
        context: "장소: 2학년 3반 교실 안 교탁 앞. 상황: 담임선생님이 전학생인 주인공을 학생들에게 소개하기 직전의 짧은 대기 시간. 수십 명의 학생들이 우리를 지켜보고 있음. 우리는 이미 교실 한가운데 서 있는 상태이며, 절대 복도가 아님. 교실 안에서 대화를 나누는 중임. 대화가 완전히 마무리되기 전까지는 대화를 계속 이어나가세요. 대화가 끝나면 선생님이 학생들에게 주인공을 정식으로 소개하고, 주인공은 교탁 앞에서 자기소개를 해야 하는 상황으로 이어집니다. 대화의 마지막 턴에만 학생들에게 인사할 준비를 하라고 하거나 자리를 정돈하는 등의 행동을 유도해 주세요.",

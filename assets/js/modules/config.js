...
function buildCupidPromptEpoch(history, options = {}) {
    ...
    const maxMessages = Math.max(4, Number(options.maxMessages) || 5);
    const retainMessages = Math.max(2, Math.min(maxMessages - 1, Number(options.retainMessages) || 3));

...
function getNativeStylePolishGuard(lang, sceneName, displayName) {
    ...
    if (lang === 'ko') {
        return `**[캐릭터 문체]**
- 대사는 실제 사람의 말처럼 장면의 호흡에 맞추고, 지문은 캐릭터의 행동·신체 감각·욕망·내면 반응을 장면에 맞는 밀도로 자유롭게 담습니다.
...
- Narration may move freely through character action, physical sensation, desire, and inner response in whatever density fits the scene.
...
- 地の文は、キャラクターの行動・身体感覚・欲望・内面反応を、場面に合う密度で自由に描いてよい。
- キャラ別の呼び方・一人称・距離感を守る:
...
- La narración puede recorrer libremente las acciones, sensaciones físicas, deseos y reacciones internas del personaje con la densidad que pida la escena.
...
- La narration peut suivre librement les actions, sensations physiques, désirs et réactions intérieures du personnage, avec la densité qui convient à la scène.
...
- Die Erzählung darf Handlungen, Körperempfindungen, Wünsche und innere Reaktionen der Figur in der zur Szene passenden Dichte frei entfalten.
...
- A narração pode acompanhar livremente ações, sensações físicas, desejos e reações internas da personagem, com a densidade que combine com a cena.
...
Types: narration/dialogue. segments must contain at least one item with non-empty text. A dialogue-only reply is normal; narration may carry character action, physical sensation, desire, or inner response when it fits the scene. Expressions: ${expressionNames}. No single text field.

...
window.FLAG_MEMORIES = [
    ...
    {"flag":"homeroom_day4","char":"담임선생님","ko":"4일차 아침 학교 근처의 공개된 카페에서 원고에 대한 의견을 나눴다. 문예부 공개 합평에 낼 원고이며 교사와 학생의 경계는 유지됐다.","en":"On Day 4 morning, you discussed the manuscript in a public café near school. It is intended for the literary club’s open workshop, and teacher-student boundaries remained intact.","es":"La mañana del día 4 comentaron el manuscrito en una cafetería pública junto a la escuela. Es para el taller abierto del club literario y se mantuvieron los límites entre docente y alumno.","ja":"四日目の朝、学校近くの開かれたカフェで原稿について話した。文芸部の公開合評に出す原稿で、教師と生徒の境界を守った。","fr":"Le matin du jour 4, vous avez parlé du manuscrit dans un café public près du lycée. Prévu pour l’atelier ouvert du club littéraire, il a été discuté dans le respect du cadre enseignant-élève.","de":"Am Morgen von Tag 4 wurde das Manuskript in einem öffentlichen Café bei der Schule besprochen. Es ist für den offenen Literaturworkshop gedacht; die Grenzen zwischen Lehrkraft und Schüler blieben gewahrt.","pt":"Na manhã do dia 4, conversaram sobre o manuscrito num café público perto da escola. Ele será levado à oficina aberta do clube literário, mantendo os limites entre professora e aluno."},

...
const GALLERY_FREETALK_PROMPT_VERSION = '2.5.15';
...
- Do not add scene type, sceneNarration, a single text field, or arbitrary keys. Keep the existing JSON segments contract.`;
    ...
    _buildSystemPrompt(charId) {
        ...
        const adultIntimacyCeilingGuard = isEn
            ? `\n\n**[Adult Erotic Romance Ceiling — Expanded Highest Intensity]**\n- Gallery free-talk is post-graduation adult lovers only. Lean into mature erotic romance: bold flirting, direct desire, possessive tenderness, kissing, embraces, lap/waist/shoulder closeness, breath near the ear, clothing and hair becoming disheveled, bed/sofa/private-room tension, and consensual sexual escalation.\n- Keep it consensual and character-driven. Because this is an established adult relationship, the character may initiate, invite, tease, touch, undress, and close romantic/sexual distance with confidence.\n- Direct adult sexual language and explicit consensual sexual intent are allowed when they fit the character and scene. Prefer sensual, visual, emotionally charged VN prose over clinical anatomy. If the scene would become graphic genital/anatomical detail, coercion, intoxication, non-consent, or not-clearly-adult framing, stop or fade to implication/afterglow.\n- The strongest output should feel like a premium adult romance VN scene: intimate, breathless, visually concrete, sexually direct, and emotionally exclusive without becoming detached pornography.`
            : `\n\n**[성인 에로틱 로맨스 수위 상한 — 확장된 최고 강도]**\n- 갤러리 프리토킹은 졸업 후 성인 연인 전용입니다. 대담한 플러팅, 직접적인 욕망 표현, 소유욕 섞인 다정함, 키스, 포옹, 무릎/허리/어깨가 가까워지는 거리, 귓가의 숨, 흐트러지는 옷과 머리카락, 침대/소파/단둘의 방 안에서 쌓이는 농밀한 긴장감, 합의된 성적 진전을 적극적으로 사용하세요.\n- 모든 전개는 합의된 성인 연인 관계와 캐릭터성 중심이어야 합니다. 이미 자리 잡은 관계이므로 캐릭터가 먼저 다가가고, 초대하고, 놀리고, 만지고, 옷을 흐트러뜨리고, 로맨틱/성적 거리를 자신 있게 좁혀도 됩니다.\n- 직접적인 성인 성적 언어와 명시적인 합의 의사는 장면과 캐릭터에 맞으면 허용됩니다. 단, 임상적인 성기/해부학 묘사보다 감각적이고 시각적이며 감정이 실린 VN 문체를 우선하세요. 그래픽한 성기/해부학 디테일, 강압, 취한 상태, 비동의, 성인임이 불명확한 프레이밍은 즉시 중단하거나 암시/사후 여운으로 돌리세요.\n- 최고 수위의 출력은 프리미엄 성인 로맨스 VN 장면처럼 느껴져야 합니다: 친밀하고, 숨이 가쁘고, 시각적으로 구체적이며, 성적으로 직접적이고, 감정적으로 독점적인 분위기.`;
...
- Intimacy: Deep, settled adult bond at the highest allowed erotic-romance intensity. Discuss desire openly, initiate affectionate and sexual physical closeness, and sustain charged private tension — no first-date jitters, no "still adjusting" phase. Direct consensual sexual language and escalation are allowed; use implication, fade-to-black, or aftermath only when graphic anatomy would overwhelm the VN tone.
${otherRelationships}
...
- 친밀도: 허용 가능한 최고 수위의 성인 에로틱 연인 유대. 욕망을 솔직하게 말하고, 애정 어린 신체적 가까움과 성적 가까움을 먼저 만들고, 단둘의 농밀한 긴장감을 오래 유지하세요 — "아직 적응 중"이나 첫 데이트 같은 긴장감은 없음. 직접적인 합의 기반 성적 언어와 진전은 허용되며, 그래픽한 해부학 묘사가 VN 톤을 압도할 때만 암시, 암전, 이후의 여운으로 처리합니다.
${otherRelationships}

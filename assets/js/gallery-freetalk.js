...
class GalleryFreeTalk {
    ...
    constructor(lang, progress) {
        ...
        // 갤러리 프리토킹은 PERFECT 엔딩 + 최대 호감도 + 프리토킹 30회 달성 후 해금 — 깊은 연인 관계를 유지하되 현재 의사와 개별 성향에 따라 반응

...
module.exports = {
    ...
    dialogues: {
        Seoyeon: [
            ...
            { situation: "첫 반응", user: "보고 싶었어.", reply: "*말이 목에 걸린다* 갑자기 그런 말 하면 곤란하잖아. *작게 웃으며 손끝을 내민다* ...나도. 아주 조금." },
        ...
        Yuna: [
            ...
            { situation: "친밀/성적", user: "유나아.", reply: "하... *붉은 눈이 반쯤 감기고, 손목 문신 위로 손가락이 지나가자 보지가 꽉 조여든다. 구겨진 메모지가 바닥에 떨어진다.* ...도망가지 마. 이 빛, 내가 먼저 잡을 거야.", sexual: true }
        ],
        Dain: [
            ...
            { situation: "친밀/성적", user: "다인아, 천천히.", reply: "읏... 반칙이야. *무릎 보호대를 벗겨 던지고 허리를 들썩이며, 삽입된 채 보지가 자지를 세게 조인다. 배구공이 바닥으로 굴러간다.* ...오늘 기록은 너랑 하는 거야.", sexual: true }
        ],
        Teacher: [

...
const backgrounds = [
  ...
  },
  {
    ...
    label: '학교 지하',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 고등학교 지하 통로, 형광등 조명이 비추는 실내, 콘크리트 벽과 타일 바닥, 양쪽에 자판기와 게시판, 매점 방향을 가리키는 안내 표지판, 계단 하단에서 바라본 시점, 지하 특유의 서늘한 공기감, 형광등 빛이 바닥에 반사됨, 사람이 적은 한적한 분위기, 약간 미스터리한 느낌이지만 깨끗하게 관리된 공간, 연애 시뮬레이션 게임 배경, 1포인트 투시 원근법, 1024x1024 해상도',
  ...
  },
  {
    ...
    label: '유나 아지트',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 학교 도서관 별관 옥상의 비밀 공간, 방과후 석양 시간대, 오래된 건물 옥상 구석에 만들어진 아지트, 낡은 벤치 하나와 담요가 깔려 있음, 벽면에 기대어 놓은 오래된 책 몇 권, 작은 캔들 홀더, 화분 대신 자라난 잡초 사이로 작은 꽃이 핌, 낡은 금속 난간 너머로 학교 뒷산과 석양이 보임, 주황빛 노을이 오래된 벽돌에 따뜻한 색감을 입힘, 아무도 모르는 비밀스러운 은신처 분위기, 고독하지만 평화로운 공간, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 밤, 공포 분위기, 폐건물, 위험한`
  },
  {
    filename: 'student_room.png',
    label: '학생 방',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 고등학생 방, 밤 시간대, 침대와 책상이 있는 일반적인 학생 방, 스탠드 조명의 따뜻한 빛, 책상 위에 교과서와 노트, 벽에 달력과 메모, 작은 책장, 창문 밖으로 밤하늘과 가로등 불빛, 깔끔하게 정돈된 평범한 학생 방, 조용한 밤의 아늑한 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 낮, 화려한 인테리어`
  },
  {

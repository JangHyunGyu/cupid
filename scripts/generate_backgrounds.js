...
const backgrounds = [
  // ── 10. 학교 내부 ──
  {
    ...
    label: '교실',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 교실 내부, 낮 시간대 밝은 자연광, 왼쪽 창문으로 따스한 햇살이 비스듬히 들어옴, 창밖으로 벚꽃 나무가 보임, 30석 규모 나무 책상과 의자가 줄지어 배치됨, 앞쪽 깨끗한 녹색 칠판과 교탁, 천장에 형광등, 교실 옆면에 사물함, 깨끗하게 정돈된 교실 분위기, 창문 커튼이 바람에 살짝 흔들림, 봄 햇살이 책상 위에 따뜻한 그림자를 드리움, 아늑하고 평온한 일상적 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 공포 분위기`
  },
  {
    filename: 'school_hallway.png',
    label: '복도',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 복도 내부, 낮 시간대, 길고 곧은 복도 중앙 시점, 양쪽으로 교실 문이 일정 간격으로 나열됨, 왼쪽 벽면에 큰 유리창이 줄지어 있어 햇살이 복도 바닥에 격자무늬 그림자를 만듦, 반짝이는 리놀륨 바닥, 천장 형광등, 벽에 부착된 게시물과 공지사항, 소화기와 비상구 표시, 창밖으로 교정의 벚꽃 나무가 보임, 봄 오후의 따뜻한 빛이 복도를 가득 채움, 깨끗하고 정돈된 학교 분위기, 연애 시뮬레이션 게임 배경, 1포인트 투시 원근법, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 공포 분위기`
  },
  {
    filename: 'top_school.png',
    label: '옥상',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 옥상, 맑은 하늘 아래 탁 트인 옥상 공간, 콘크리트 바닥과 금속 난간, 난간 근처에 작은 화분 몇 개가 놓여 있음, 구석에 접이식 의자 두 개와 작은 테이블, 옥상 출입문이 한쪽에 보임, 난간 너머로 학교 운동장과 주변 마을 풍경이 넓게 펼쳐짐, 멀리 산과 아파트 단지가 보임, 파란 하늘에 뭉게구름, 바람에 벚꽃잎이 옥상 위로 날아옴, 봄 햇살이 따사롭게 비침, 비밀스럽고 고요한 해방감의 공간, 연애 시뮬레이션 게임 배경, 약간 올려본 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 공포 분위기, 위험한 분위기`
  },
  {
    filename: 'teacher_office.png',
    label: '교무실/학생회실',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 교무실 겸 학생회실, 방과후 석양 시간대, 창문으로 주황빛 노을이 들어와 방 전체를 황금빛으로 물들임, 큰 책상 위에 서류 더미와 클립보드와 태블릿, 책장에 파일 폴더가 가지런히 꽂혀 있음, 한쪽 벽에 학사 일정표와 행사 포스터, 작은 소파와 낮은 테이블, 책상 위 화분 하나, 서랍이 살짝 열린 책상, 정돈되어 있지만 일의 흔적이 느껴지는 공간, 노을이 서류 위에 긴 그림자를 드리움, 피곤하지만 아늑한 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 밤, 공포 분위기`
  },
  {
    filename: 'gym.png',
    label: '체육관',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 실내 체육관, 방과후 오후 시간대, 높은 천장과 아치형 지붕, 나무 마루 바닥에 배구 코트 라인이 선명하게 그려져 있음, 코트 중앙에 배구 네트가 설치되어 있음, 한쪽 벽면에 줄사다리와 농구 골대, 반대쪽 벽면에 긴 나무 벤치, 바닥에 배구공 하나가 놓여 있음, 높은 창문으로 오후 햇살이 비스듬히 들어와 마루 바닥에 길게 빛줄기를 만듦, 공기 중에 먼지가 빛 속에서 반짝임, 활기차고 역동적인 스포츠 공간, 연애 시뮬레이션 게임 배경, 약간 올려본 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 야외 체육관`
  },
  {
    filename: 'library_old.png',
    label: '도서관/별관',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 오래된 도서관 별관, 점심 시간대의 고요한 분위기, 높은 나무 서가가 양쪽으로 빽빽하게 늘어서 있음, 서가 사이로 좁은 통로, 오래된 나무 열람 테이블과 의자, 테이블 위에 스탠드 조명, 높은 아치형 창문으로 부드러운 자연광이 들어옴, 창문 밖으로 오래된 나무가 보임, 바닥에 낡은 나무 마루, 서가 위에 먼지가 살짝 쌓인 오래된 책들, 공기 중 오래된 종이 냄새가 느껴지는 분위기, 학생이 거의 찾지 않는 고요하고 신비로운 공간, 빛과 그림자가 만드는 아늑한 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 현대적 도서관, 밤, 공포 분위기`
  },
  {
    filename: 'store.png',
    label: '매점',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 매점, 점심시간 밝은 분위기, 학교 지하에 위치한 작은 매점, 진열대에 빵과 음료수와 과자가 진열됨, 소보로빵과 딸기우유가 눈에 띄는 위치에 배치, 카운터와 계산대, 매점 앞에 나무 벤치가 나란히 놓여 있음, 형광등 조명이 밝게 비춤, 타일 바닥, 벽에 인기 메뉴 가격표 부착, 자판기가 한쪽에 배치, 활기차고 소박한 학교 일상의 공간, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 편의점, 대형 마트`
  },
  {
    filename: 'nurse_room.png',
    label: '보건실',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 보건실 내부, 오후 시간대의 부드러운 자연광, 하얀 커튼으로 구분된 침대 두 개, 깨끗한 흰색 시트, 작은 나무 책상 위에 구급함과 소독약 병과 밴드 상자, 창가에 작은 로즈마리 화분, 약품 캐비닛과 체중계, 책상 위에 닫힌 노트북, 하얀 커튼 사이로 부드러운 햇살이 스며들어 따뜻한 그림자를 만듦, 소독약 냄새가 느껴질 듯한 깨끗한 공간, 안식처 같은 차분하고 포근한 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
  ...
  // ── 11. 학교 외부 ──
  {
    filename: 'school.png',
    label: '교문 앞',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 교문 앞, 맑은 봄 아침 시간대, 벚꽃 가로수가 양쪽으로 늘어선 등교길, 벚꽃잎이 바람에 흩날림, 정면에 학교 교문과 돌기둥, 교문 너머로 깨끗한 3층 학교 건물이 보임, 넓은 교정과 운동장이 펼쳐짐, 교문 옆 가로등, 파란 하늘에 흰 뭉게구름, 아스팔트 등교 길 양쪽에 봄꽃이 핀 화단, 새 학기의 설렘과 긴장이 공존하는 밝은 봄 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 가을, 겨울, 낙엽`
  },
  {
    filename: 'school_back.png',
    label: '학교 뒷길',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 뒷길, 방과후 석양 시간대, 학교 건물 뒤편의 좁고 한적한 길, 콘크리트 담벼락 한쪽에 담쟁이 덩굴, 발밑에 낙화한 벚꽃잎이 쌓여 있음, 오래된 자전거 거치대, 한쪽에 오래된 음수대, 석양빛이 담벼락에 주황빛 그림자를 드리움, 정문과 달리 사람이 다니지 않는 한적한 분위기, 비밀스럽고 고요한 공간, 약간의 쓸쓸함과 로맨스가 공존하는 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 밤, 공포 분위기, 으스스한, 폐건물`
  },
  {
    filename: 'playground.png',
    label: '운동장',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 운동장, 맑은 봄 낮 시간대, 넓은 흙 운동장에 트랙 라인이 그려져 있음, 한쪽에 축구 골대, 반대쪽에 철봉과 턱걸이대, 운동장 가장자리에 벚꽃 나무가 줄지어 있음, 벚꽃잎이 운동장 위로 흩날림, 뒤편으로 학교 건물 3층이 보임, 파란 하늘에 뭉게구름, 밝고 탁 트인 활기찬 봄 분위기, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
    negative: `${NEG_COMMON}, 어두운 조명, 밤, 실내`
  },
  {
    filename: 'school_basement.png',
    label: '학교 지하',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 지하 통로, 형광등 조명이 비추는 실내, 콘크리트 벽과 타일 바닥, 양쪽에 자판기, 계단 하단에서 바라본 시점, 지하 특유의 서늘한 공기감, 형광등 빛이 바닥에 반사됨, 사람이 적은 한적한 분위기, 약간 미스터리한 느낌이지만 깨끗하게 관리된 공간, 연애 시뮬레이션 게임 배경, 1포인트 투시 원근법, 1024x1024 해상도',
  ...
  },
  {
    ...
    label: '학생회실',
    prompt: '비주얼 노벨 배경 일러스트, 깔끔한 선화, 선명한 디지털 셀 채색, 한국 학교 학생회실 내부, 낮 시간대 밝은 자연광, 큰 직사각형 회의 테이블과 의자 여러 개, 테이블 위에 서류와 클립보드와 노트북, 벽면에 행사 일정표와 포스터, 한쪽에 화이트보드, 작은 책장에 파일 폴더가 정리되어 있음, 창문으로 밝은 햇살이 들어옴, 깔끔하게 정돈된 학생 자치 활동 공간, 연애 시뮬레이션 게임 배경, 정면 시점, 1024x1024 해상도',
